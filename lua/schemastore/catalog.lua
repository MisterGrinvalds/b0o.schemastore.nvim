...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 959,
    [".nodehawkrc"] = 596,
    [".npmpackagejsonlintrc"] = 600,
    [".omletrc"] = 1139,
    [".phrase.yml"] = 675,
    [".phraseapp.yml"] = 676,
    [".pmbot.yml"] = 660,
    [".postcssrc"] = 669,
    [".powerpages-web-template-manifest"] = 671,
    [".pre-commit-config.yml"] = 672,
    [".pre-commit-hooks.yml"] = 673,
    [".putout.json"] = 709,
    [".rehyperc"] = 734,
    [".remarkrc"] = 738,
    [".sprite files"] = 833,
    ...
    AIConfig = 35,
    ["AMX Muse Program Descriptor"] = 1187,
    ["API Builder"] = 995,
    ["AVA Configuration"] = 1058,
    ...
    ["AWS Copilot Manifest"] = 1226,
    ["AWS SAM CLI Samconfig"] = 273,
    Acton = 1276,
    ["Adobe UXP Manifest"] = 1121,
    ["Aerleon Network & Service Definitions"] = 21,
    ["Aerleon Policy"] = 22,
    ["Agent Permission Policy"] = 1266,
    ["AgentCore CLI"] = 1267,
    Aider = 1216,
    Air = 24,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1237,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1236,
    ["Airlock Microgateway"] = 36,
    ["Alacritty Configuration"] = 1030,
    ["All Contributors configuration file"] = 1084,
    ["Ansible Argument Specs"] = 412,
    ["Ansible Collection Galaxy"] = 419,
    ["Ansible Execution Environment"] = 409,
    ["Ansible Inventory"] = 418,
    ["Ansible Meta"] = 410,
    ["Ansible Meta Runtime"] = 411,
    ["Ansible Navigator Configuration"] = 421,
    ["Ansible Playbook"] = 416,
    ["Ansible Requirements"] = 413,
    ["Ansible Rulebook"] = 417,
    ["Ansible Tasks File"] = 415,
    ["Ansible Vars File"] = 414,
    ["Ansible-lint Configuration"] = 420,
    Any = 1149,
    ...
    ["Application list for a WinUtil"] = 1166,
    ArchitectFX = 1171,
    ["Argo CD"] = 55,
    ["Argo Events"] = 56,
    ["Argo Workflows"] = 57,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1235,
    ["Azure IoT Operations connector metadata"] = 1232,
    ...
    ["Azure Pipelines"] = 115,
    ["Azure Static Web Apps CLI configuration file"] = 837,
    ["Azure Static Web Apps configuration file"] = 836,
    BMML = 1254,
    ["BOSH CPI Config"] = 141,
    ...
    ["Bacon config"] = 6,
    ["Barba-CV"] = 84,
    ["Bashly (bashly.yml)"] = 1088,
    ["Bashly Settings (bashly-settings.yml)"] = 1089,
    Bento = 1253,
    ["Better Code Hub"] = 1000,
    ["Better Scripts"] = 164,
    Bigconfig = 134,
    ["Biome Formatter Config"] = 85,
    ["Bitmovin Encoding Template"] = 1180,
    BizTalkServerApplicationSchema = 966,
    Bleep = 165,
    ["Block Protocol Metadata"] = 162,
    ["Bluebricks blueprint config"] = 1259,
    ["Boyka Framework"] = 143,
    ...
    ["Butane Config"] = 1043,
    C4InterFlow = 1195,
    ["CDK Environment Manager, concrete environment configuration"] = 1219,
    ["CDK Environment Manager, concrete environments definition"] = 1218,
    ["CDK Environment Manager, environment definition"] = 1217,
    ["CGS Card Game Specification (cgs.json)"] = 1126,
    ["CICS TS region tagging"] = 1052,
    ["CICS TS resource import"] = 1053,
    ["CICS TS resource model"] = 1054,
    ["CICS TS resource overrides"] = 1055,
    ["CMake Presets"] = 166,
    ["CNC Codes"] = 188,
    ["CRS WAF test file"] = 1156,
    ["CRS WAF test platform overrides file"] = 1157,
    ...
    ["Chamaleon environment"] = 1184,
    ["Chamaleon properties"] = 1185,
    ["Chamaleon template"] = 1183,
    Changepacks = 1246,
    Changesets = 282,
    Changie = 175,
    Charmcraft = 176,
    ...
    ["Clawject config"] = 194,
    ["Cloud Foundry Application Manifest"] = 1138,
    ["Cloud Run Spec v1"] = 1161,
    ...
    Concord = 1155,
    ["Configu .cfgu files"] = 1143,
    ["Configu .configu file"] = 1144,
    Conjure = 187,
    ["Container Structure Test"] = 980,
    Containerlab = 1009,
    ["Contextive Glossary"] = 1211,
    Convex = 186,
    ["Crowdsec collection config"] = 292,
    ["Crowdsec parser config"] = 293,
    ["Crowdsec scenario config"] = 294,
    ["CumulusCI Config"] = 193,
    ["Cursor Agent Environment"] = 1264,
    ["Custom Machinery Machine"] = 1127,
    ["Custom Machinery Recipe"] = 1128,
    ...
    ["DataYoga Job"] = 204,
    ["Datadog Continuous Testing"] = 510,
    ["Datadog Service Definition"] = 511,
    ["Datadog Software Catalog"] = 512,
    ["Datahub Ingestion Recipe"] = 1059,
    ["Debian Upstream Metadata file"] = 211,
    ["Deck config"] = 212,
    ["Declarative Automation Bundles"] = 1105,
    ["DeepMatch deeplinks spec"] = 213,
    ["Dein Config"] = 214,
    ["Deno Config (deno.json)"] = 310,
    ["Dependency cruiser"] = 215,
    ["DeployStack Configuration"] = 216,
    ["Deployah Configuration"] = 1234,
    ["Deployer Recipe"] = 313,
    ["Deta Spacefile"] = 217,
    ...
    ["DonateCaseBetterCasino menu"] = 1188,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 1096,
    ["EAS config"] = 363,
    ["ECA - Editor Code Assistant"] = 345,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1085,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1231,
    ["EasyVCR .NET"] = 365,
    ["Eidolon Resource"] = 1172,
    ["Elgato Stream Deck"] = 347,
    Elm = 1160,
    ["Embrace Config"] = 1071,
    Endurica = 1109,
    ["Enterprise Contract Policy Spec"] = 348,
    ["Envelope Team Definition"] = 1275,
    ["Envilder Map File"] = 349,
    ["Erda Pipeline"] = 1134,
    ["Erda Runtime"] = 1135,
    ["Espanso config.yml"] = 1257,
    ["Espanso match.yml"] = 1256,
    Esquio = 351,
    ["Estuary Flow Catalog"] = 1049,
    ["Ethereum ERC1155"] = 1269,
    ["Ethereum ERC721"] = 1268,
    ...
    ["Evolving Resolutive Process notation"] = 1233,
    ["Expo SDK"] = 362,
    ...
    ["GeoJSON.json latest"] = 1047,
    GherKing = 1051,
    ["GitHub Action"] = 398,
    ["GitHub Actions typing"] = 1168,
    ["GitHub Discussion"] = 399,
    ["GitHub Funding"] = 400,
    ["GitHub Issue Template configuration"] = 401,
    ["GitHub Issue Template forms"] = 402,
    ["GitHub Workflow"] = 403,
    ["GitHub Workflow Template Properties"] = 404,
    ["GitHub automatically generated release notes configuration"] = 405,
    ["GitLab Agent for Kubernetes configuration"] = 1123,
    GitVersion = 395,
    ["Gitea Issue Template configuration"] = 396,
    ["Gitea Issue Template forms"] = 397,
    ["Gitpod Automations"] = 407,
    ["Gitpod Configuration"] = 408,
    ["GlazeWM settings"] = 1125,
    ["Global Privacy Control"] = 394,
    Goblet = 1104,
    ["Golangci-lint Configuration"] = 423,
    ["Golangci-lint Custom Plugins Configuration"] = 424,
    ["Google Chrome Related Website Sets"] = 372,
    ["Google Cloud Workflows"] = 269,
    ["Google Digital Assetlinks"] = 1212,
    Goreleaser = 426,
    ["Goreleaser Pro"] = 427,
    Goss = 428,
    ["Gradle Build Cache Node"] = 998,
    ["Gradle Enterprise"] = 997,
    ["Grafana 5.x Dashboard"] = 429,
    ["GraphQL Code Generator"] = 434,
    ["GraphQL Config"] = 433,
    ["GraphQL Mesh"] = 432,
    ["GroovyLint configuration"] = 435,
    ["Grunt JSHint task"] = 439,
    ["Grunt Watch task"] = 440,
    ["Grunt base task"] = 441,
    ["Grunt clean task"] = 437,
    ["Grunt copy task"] = 436,
    ["Grunt cssmin task"] = 438,
    HEMTT = 962,
    Hadolint = 976,
    Hammerkit = 1008,
    ["Hardware Sentry Configuration"] = 1063,
    ["Hashgraph Online Skill Manifest"] = 2,
    ["HashiCorp Vault"] = 442,
    Hatch = 977,
    Hayson = 444,
    ["Haystack Pipeline"] = 445,
    ["Hazelcast 5 Configuration"] = 446,
    ["Hecate Input Schema"] = 1223,
    ["Helm Chart.lock"] = 235,
    ["Helm Chart.yaml"] = 234,
    ["Helm Unittest Test Suite"] = 236,
    ["Home Assistant Integration Manifest"] = 447,
    ["Homer dashboard configuration"] = 448,
    Hugo = 1039,
    ["Hugo Theme"] = 1038,
    ["Hulak Configuration"] = 455,
    ["Hyperfoil benchmark configuration"] = 454,
    ["IBM Zapp document"] = 456,
    ["IBM zCodeFormatSettings"] = 457,
    ["IMG Catapult PSP"] = 462,
    ["IVMS101 by CODE Protocol"] = 1124,
    Infrahub = 464,
    Istanbul = 1067,
    ["JDownloader2 crawler multi-rules"] = 477,
    ["JDownloader2 crawler single-rules"] = 476,
    ["JFrog Applications Config"] = 478,
    ["JFrog File Spec"] = 479,
    ["JFrog Pipelines YML DSL"] = 1073,
    ["JMeter DSL cli config"] = 480,
    JReleaser = 483,
    ["JSON Document Transform"] = 491,
    ["JSON Feed"] = 492,
    ["JSON Resume"] = 746,
    ["JSON Schema Draft 2020-12"] = 944,
    ["JSON Schema Draft 4"] = 941,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1106,
    ["JSON Schema Draft 7"] = 942,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1107,
    ["JSON Schema Draft 8 (2019-09)"] = 943,
    ["JSON-API"] = 490,
    ["JSON-e templates"] = 1005,
    ["JSON-stat 2.0"] = 937,
    JSONPatch = 494,
    ["JSR Package Config (jsr.json)"] = 484,
    Jarl = 1239,
    Jasmine = 471,
    Jekyll = 472,
    ["Jenkins X Pipelines"] = 473,
    ["Jenkins X Requirements"] = 474,
    Jest = 475,
    Jocker = 481,
    ["Jovo Language Models"] = 482,
    ["Jujutsu (jj) VCS config"] = 1225,
    ["KIMMDY config file"] = 505,
    ["KODE/CI build.yaml"] = 1069,
    ["KSP-AVC"] = 938,
    ["KSP-CKAN"] = 939,
    ["KSP-NetKAN"] = 940,
    KSY = 1136,
    ...
    Kas = 497,
    ["Kestra flow file"] = 506,
    ["Keycloak REST API"] = 1076,
    ["Knative Functions - func.yaml"] = 385,
    Knip = 386,
    ["Knowledge Unit"] = 514,
    ["Kometa (nightly) config file"] = 508,
    ["Kometa config file"] = 507,
    ["Kong DBLess config"] = 1070,
    KrakenD = 509,
    ["Kubri Configuration"] = 517,
    LOOBin = 532,
    ["Lake configuration file"] = 1228,
    ...
    ["Lando (landofile)"] = 111,
    ["LangGraph Platform configuration"] = 1148,
    ["Language configuration"] = 1147,
    Lefthook = 521,
    ["Liferay client-extension.yaml"] = 528,
    ["LinkML Metamodel"] = 530,
    Liquibase = 1014,
    ["Liquibase Flow File"] = 1015,
    ["Lively Properties"] = 531,
    ["Lobe AI Agent"] = 113,
    Loki = 114,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 574,
    ["MS2Rescore Configuration"] = 579,
    ["Madness (madness.yml)"] = 1087,
    ["Mado configuration"] = 538,
    ["Maestro Flow"] = 539,
    ["Mail Servers Configuration"] = 1260,
    ["MapEHR Mapping"] = 540,
    Markdownlint = 1018,
    ["Mason Registry"] = 1021,
    ["MegaLinter Custom Flavor"] = 543,
    ["MegaLinter configuration"] = 542,
    ["MegaLinter descriptor"] = 544,
    Melange = 1114,
    ["Meltano project definition"] = 545,
    ["Mergify Configuration"] = 580,
    ["Metadata for a Bazel module"] = 546,
    ["Metadata for a Cinnamon spice"] = 1164,
    ["Metatype Configuration"] = 547,
    ["MetricsHub Configuration"] = 548,
    ["MetricsHub Connector Configuration"] = 549,
    ["Micro Editor Syntax"] = 1097,
    ["Microsoft Band Web Tile"] = 550,
    ["Microsoft RulesEngine workflow rules"] = 1152,
    ["Microsoft RulesEngine workflow rules list"] = 1153,
    ["Minecraft Custom Main Menu Mod"] = 1115,
    ["Minecraft Data Pack Advancement"] = 552,
    ["Minecraft Data Pack Biome"] = 553,
    ["Minecraft Data Pack Configured Carver"] = 554,
    ["Minecraft Data Pack Damage Type"] = 555,
    ["Minecraft Data Pack Dimension"] = 557,
    ["Minecraft Data Pack Dimension Type"] = 556,
    ["Minecraft Data Pack Item Modifier"] = 558,
    ["Minecraft Data Pack Loot Table"] = 559,
    ["Minecraft Data Pack Metadata"] = 560,
    ["Minecraft Data Pack Predicate"] = 561,
    ["Minecraft Data Pack Recipe"] = 562,
    ["Minecraft Data Pack Tag"] = 563,
    ["Minecraft Data Pack Template Pool"] = 564,
    ["Minecraft Data Pack Trim Material"] = 569,
    ["Minecraft Data Pack Trim Pattern"] = 570,
    ["Minecraft Resource Pack Lang"] = 565,
    ["Minecraft Resource Pack Particle"] = 566,
    ["Minecraft Resource Pack Texture Mcmeta"] = 568,
    ["Minecraft Resourcepack Sounds"] = 567,
    ["MockServer Expectations"] = 576,
    ModuleAssembler = 572,
    ["Monade CLI Stack Configuration"] = 583,
    ["MongoDB Atlas Search Index Definition"] = 1068,
    ["Monika Configuration"] = 1066,
    ["Monoweave Configuration"] = 578,
    ["Motif config"] = 958,
    MultiQC = 1205,
    ["NOX Framework (Service)"] = 599,
    ["Netin Diagnostic System Template"] = 1025,
    ["Netlify config"] = 586,
    ["Network-as-Code Data Model"] = 587,
    ["Next Gen UI Agent A2A Server Configuration"] = 588,
    ["Next Gen UI Agent Configuration"] = 590,
    ["Next Gen UI Agent MCP Server Configuration"] = 589,
    ["Nightwatch.js"] = 592,
    ["Node.js configuration"] = 963,
    ["NueJS configuration file"] = 604,
    ["Nuitka.yaml"] = 1129,
    ["Nullstone config"] = 606,
    ["ONe's changelog entry"] = 625,
    ["ONe's service descriptor"] = 624,
    ["ORT Server repository environment configuration"] = 635,
    ["OSCAL Assessment Plan (AP)"] = 637,
    ["OSCAL Assessment Results (AR)"] = 638,
    ["OSCAL Catalog"] = 639,
    ["OSCAL Component Definition (CDef)"] = 640,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 641,
    ["OSCAL Profile"] = 642,
    ["OSCAL System Security Plan (SSP)"] = 643,
    ["OSS Review Toolkit configuration"] = 644,
    ["OSS Review Toolkit curation"] = 645,
    ["OSS Review Toolkit package configuration"] = 646,
    ["OSS Review Toolkit repository configuration"] = 647,
    ["OSS Review Toolkit resolutions"] = 648,
    ["October CMS columns"] = 610,
    ["October CMS fields"] = 611,
    ["Oh My Posh"] = 613,
    Okteto = 614,
    ["Ona Automations"] = 616,
    Opctl = 961,
    ["Open Data Contract Standard (ODCS)"] = 629,
    ["Open Data Product Standard (ODPS)"] = 630,
    ["Open Know-How"] = 1210,
    OpenDecree = 1273,
    ["OpenDecree Configuration"] = 1274,
    ["OpenRewrite Resource"] = 627,
    OpenSRM = 631,
    OpenStatus = 1221,
    ["OpenTelemetry Declarative Configuration"] = 628,
    ["OpenUtau character yaml"] = 621,
    ["OpenUtau ustx"] = 622,
    ["OpenWeather Current Weather API"] = 1004,
    ["OpenWeather Road Risk API"] = 1003,
    ["Ory Hydra configuration"] = 453,
    ["Ory Keto configuration"] = 513,
    ["Ory Kratos configuration"] = 636,
    ["Ory Oathkeeper configuration"] = 608,
    ["Outblocks App configuration"] = 633,
    ["Outblocks database table"] = 634,
    ["Outblocks project configuration"] = 632,
    PDM = 655,
    POPxf = 666,
    ["POPxf Correlations"] = 667,
    ["PRML manifest"] = 674,
    Packer = 652,
    PactSpec = 653,
    Pantsbuild = 1083,
    ["Paper paper-plugin.yml"] = 654,
    ["Pipeline component"] = 1016,
    ["Platform.sh application"] = 8,
    ["Platform.sh routes"] = 9,
    ["Platform.sh services"] = 10,
    ["Plex Prerolls"] = 664,
    ["PocketMine plugin.yml"] = 661,
    ["Postman collection"] = 670,
    ["Power Pages Configuration"] = 1222,
    ["Preset list for a WinUtil"] = 1167,
    ["ProActions AI-Kit Configuration"] = 682,
    ["ProActions AI-Kit Configuration for Menus"] = 684,
    ["ProActions AI-Kit Configuration for Sections"] = 686,
    ["ProActions AI-Kit Configuration for Services"] = 683,
    ["ProActions AI-Kit Configuration for Steps"] = 687,
    ["ProActions AI-Kit Configuration for Templates"] = 685,
    ["Problem object RFC9457"] = 1112,
    ["Problem package format"] = 688,
    ["Problem package generators"] = 689,
    ["Problem package submissions"] = 690,
    ["Problem package test group metadata"] = 691,
    Pterodactyl = 1062,
    ["Pull Request Labeler"] = 708,
    Pulumi = 716,
    ["PyGTA Config"] = 712,
    PyProject = 717,
    Pylock = 1213,
    Pyright = 718,
    ["Python script metadata"] = 1207,
    ["QType AI DSL"] = 721,
    Qgoda = 720,
    Qodana = 1035,
    ["Qt Creator workspace file"] = 1145,
    ["Quali Torque Blueprint Spec 2"] = 1060,
    ["QueryFirst config file"] = 1079,
    ["Qwen Code Settings"] = 1270,
    ["RKE Cluster Configuration JSON"] = 1013,
    ["RKE Cluster Configuration YAML"] = 1012,
    RadioHound = 711,
    ["Raid Profile"] = 1271,
    ["Raid Repo Configuration"] = 1272,
    Railpack = 723,
    Railway = 722,
    ["Rancher Fleet"] = 713,
    ["Rattler-build"] = 724,
    Ray = 975,
    ["Read the Docs"] = 715,
    ["Red-DiscordBot Cog"] = 731,
    ["Red-DiscordBot Cog Repo"] = 732,
    ["Red-DiscordBot Trivia"] = 733,
    ["Releasaurus Config"] = 5,
    ReleaseKit = 4,
    ["Render Blueprints"] = 1011,
    RenderCV = 750,
    Renovate = 747,
    ["Renovate global configuration"] = 748,
    ["Renovate inherited configuration"] = 749,
    ["Replit config"] = 739,
    Restate = 1200,
    ["Revel Digital Gadget Definition File"] = 1224,
    RoadRunner = 752,
    ["Robust Station Image"] = 1230,
    Rockcraft = 753,
    ["Roo Coder Custom Modes"] = 754,
    Rubocop = 743,
    ["Rudder techniques"] = 1119,
    Ruff = 744,
    ["Rust Project"] = 745,
    ["Rust toolchain"] = 759,
    ["SDMX data message"] = 786,
    ["SDMX metadata message"] = 785,
    ["SDMX structure message"] = 784,
    ["SIL Kit Participant Configuration"] = 796,
    ["SIL Kit Registry Configuration"] = 797,
    ["SPDX 2.3"] = 834,
    SWADL = 850,
    ["Safebox Config"] = 1074,
    ["Sapphire CLI Config"] = 762,
    ["SauceCTL Configuration"] = 1022,
    Scarb = 782,
    ["Schema Catalog"] = 777,
    ["Scoop manifest"] = 783,
    ["Semantic Data Fabric (SDF) file"] = 787,
    ["Semgrep Rule"] = 789,
    ["Serenity Code Generator (Sergen)"] = 790,
    ["Serverless Framework Configuration"] = 1029,
    ["Serverless Workflow"] = 1031,
    ["Settings for a Cinnamon spice"] = 1163,
    ["Settings.paf"] = 792,
    ["Shopware 6 Configuration"] = 1032,
    ["Shopware CLI Extension Store Configuration"] = 1033,
    ["Shopware CLI Project Store Configuration"] = 1034,
    ["Sigma Detection Rule"] = 794,
    ["Sigrid scope configuration file"] = 795,
    ["SkyPilot Task JSON"] = 1120,
    ["Slack app manifest"] = 799,
    Snapcraft = 801,
    Solidarity = 804,
    ["Solution filters"] = 805,
    ["Source Maps v3"] = 806,
    Sourcery = 807,
    ["Spack bootstrap.yaml"] = 808,
    ["Spack cdash.yaml"] = 809,
    ["Spack ci.yaml"] = 810,
    ["Spack compilers.yaml"] = 811,
    ["Spack concretizer.yaml"] = 812,
    ["Spack config.yaml"] = 813,
    ["Spack definitions.yaml"] = 814,
    ["Spack develop.yaml"] = 815,
    ["Spack env_vars.yaml"] = 816,
    ["Spack environment"] = 822,
    ["Spack include.yaml"] = 817,
    ["Spack mirrors.yaml"] = 818,
    ["Spack modules.yaml"] = 819,
    ["Spack packages.yaml"] = 820,
    ["Spack repos.yaml"] = 821,
    ["Spack toolchains.yaml"] = 823,
    ["Spack upstreams.yaml"] = 824,
    ["Spack view.yaml"] = 825,
    ["Speakeasy Generation Config File"] = 829,
    ["Speakeasy Lint Configuration File"] = 826,
    ["Speakeasy Test Generation Configuration File"] = 827,
    ["Speakeasy Workflow File"] = 828,
    SpecIF = 830,
    ["Specmatic Configuration"] = 831,
    ["Sponge Mixin configuration"] = 832,
    StackBlitz = 838,
    ["StackHawk Scanner Configuration"] = 1028,
    Stale = 839,
    Starfish = 840,
    ["Starlake Data Pipeline"] = 1001,
    Starship = 841,
    ["Statamic Blueprint"] = 842,
    ["Stella configuration file"] = 843,
    ["Streamlit configuration file"] = 844,
    ["Stryker Mutator"] = 847,
    ["StyleCop Analyzers Configuration"] = 848,
    ["Stylelint (.stylelintrc)"] = 849,
    ["Stylua Config"] = 1214,
    ["Sublime Syntax"] = 1075,
    ["Subsquid squid manifest"] = 1122,
    ["Swagger API 2.0"] = 851,
    ["Synadia Connect Component"] = 852,
    TSON = 888,
    TSTyche = 889,
    ["TYPO3 Vendor Bundler config"] = 895,
    ["Tab data for a LinUtil"] = 1170,
    ["Tab list for a LinUtil"] = 1169,
    Tach = 853,
    ["Tach Domain"] = 854,
    Talhelper = 856,
    ["Talisman configuration"] = 857,
    Taplo = 1215,
    ["Taskfile config"] = 1006,
    Taurus = 858,
    Tauticord = 859,
    ["Tekton Pipeline"] = 1243,
    ["Tekton PipelineRun"] = 1244,
    ["Tekton Task"] = 1241,
    ["Tekton TaskRun"] = 1242,
    Telefonistka = 1201,
    ["Terrateam config"] = 1227,
    ["TestEnvironment.json"] = 871,
    ["TextMate Grammar"] = 870,
    Threagile = 865,
    ["Tier.run pricing.json"] = 862,
    Tikibase = 863,
    Tombi = 868,
    ["Traefik v2"] = 874,
    ["Traefik v2 File Provider"] = 875,
    ["Traefik v3"] = 876,
    ["Traefik v3 File Provider"] = 877,
    ["Travis CI (.travis.yml)"] = 873,
    Treefmt = 431,
    Trident = 1197,
    ["TrueScript for *.tscript files"] = 880,
    ["Tugboat QA config.yml"] = 1194,
    TunnelHub = 1110,
    Turborepo = 872,
    Tycho = 1159,
    Tye = 1036,
    ["Tyk Gateway - Open Source v5.7+"] = 1206,
    ["UET BuildConfig.json"] = 1080,
    ["UI5 Manifest"] = 901,
    ["UNCORS configuration"] = 905,
    ["UTAM Page Object"] = 904,
    ["Ubuntu Server Autoinstall"] = 899,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1198,
    ["Uniswap Token List"] = 987,
    ["Universal Schedule Format"] = 906,
    ["Unreal Engine Uplugin"] = 1081,
    ["Unreal Engine Uproject"] = 1082,
    ["UpCloud CLI (upctl) configuration"] = 1199,
    ["Updatecli Compose"] = 1044,
    ["Updatecli Policy Manifest"] = 1045,
    ["Updatecli Policy Metadata"] = 1046,
    Uplift = 1078,
    ["Upsun config"] = 7,
    ["User Journey Map"] = 1010,
    V2Ray = 1050,
    ["VSCode Code Snippets"] = 257,
    ["VSIX CLI publishing"] = 924,
    Vector = 908,
    ["Vela Pipeline Configuration"] = 911,
    Vercel = 256,
    ["Version Bumper config"] = 914,
    Vespertide = 1248,
    ["Vespertide Migration"] = 1249,
    ["Vespertide Model"] = 1250,
    ["Viash Component Config"] = 1203,
    ["Viash Package Config"] = 1204,
    Visivo = 1108,
    ["WP-CLI"] = 934,
    Wake = 1196,
    ["Waku Config"] = 1173,
    ["Web App Manifest"] = 930,
    ["Web types"] = 933,
    WebExtensions = 929,
    ["Webman package recipe"] = 1056,
    ["Windows Package Manager Installer Manifest"] = 983,
    ["Windows Package Manager Locale Manifest"] = 984,
    ["Windows Package Manager Singleton Manifest"] = 982,
    Winutil = 985,
    ["WireMock CLI import configuration"] = 1179,
    ["WireMock CLI local service configuration"] = 1178,
    ["WireMock message stub mapping"] = 1177,
    ["WireMock stub mapping"] = 1176,
    ["Woodpecker pipeline config"] = 1024,
    ["Wrangler CLI"] = 935,
    ["XenForo add-on manifest"] = 936,
    ["Xstate Machine"] = 1042,
    ["Yandex Workflow Language"] = 1165,
    ["Yarn Config (.yarnrc.yml)"] = 999,
    ["Yippee-Ki-JSON configuration YML"] = 990,
    ["YouTrack App"] = 1162,
    ["Zarf Package Configuration"] = 1229,
    ["Zerops import file"] = 1151,
    ["Zola Configuration"] = 1240,
    ["aerleon.yml"] = 20,
    ["amplify.yml"] = 13,
    ["angular.json"] = 37,
    apko = 1113,
    ...
    ["behat.yml"] = 144,
    ["bigquery-table"] = 133,
    ["bioimageio resource description"] = 1130,
    ...
    ["chutzpah.json"] = 265,
    cibuildwheel = 181,
    ["clang-format (.clang-format)"] = 1048,
    ["clang-tidy"] = 242,
    clangd = 241,
    clib = 243,
    ...
    ["crowdin.yml"] = 291,
    ["ctfd-setup configuration file"] = 1186,
    ["custom-elements.json"] = 1100,
    ["cypress.json"] = 295,
    ...
    ["gematik health care insurance list"] = 1192,
    ["gematik health care patient list"] = 1189,
    ["gematik health care provider institution list"] = 1191,
    ["gematik health care provider list"] = 1190,
    ["gematik tiger test environment configuration"] = 1193,
    ["git-town.toml"] = 1238,
    ["gitlab-ci"] = 406,
    ["global.json"] = 422,
    ["go-feature-flag Flag Configuration"] = 425,
    ["haxelib.json"] = 443,
    helmfile = 978,
    helmwave = 979,
    ["host-meta.json"] = 450,
    ...
    ["ide.host.json"] = 458,
    ["ifstate.yaml"] = 459,
    ["imageoptimizer.json"] = 460,
    ["importmap.json"] = 463,
    instant_python_config = 465,
    instant_python_custom_project = 466,
    ["ioBroker Configuration"] = 467,
    ["ioBroker JSON UI"] = 468,
    ["ioBroker Package manifest"] = 469,
    ["ixpect.conf.yaml"] = 470,
    ["ize.toml"] = 1077,
    ["jsconfig.json"] = 495,
    ["jscpd Configuration"] = 1061,
    jsdoc = 974,
    ["k3d.yaml"] = 496,
    ["k9s aliases.yaml"] = 498,
    ["k9s cluster-config.yaml"] = 500,
    ["k9s config.yaml"] = 499,
    ["k9s hotkeys.yaml"] = 501,
    ["k9s plugins.yaml"] = 502,
    ["k9s skin.yaml"] = 503,
    ["k9s views.yaml"] = 504,
    ["kontinuous-config.yaml"] = 516,
    ["kontinuous-values.yaml"] = 515,
    ["kustomization.yaml"] = 518,
    ["label-commenter-config.yml"] = 519,
    ["latexindent configuration"] = 112,
    ["launchsettings.json"] = 520,
    lazydocker = 1099,
    lazygit = 1098,
    ["lego.json"] = 522,
    ["lerna.json"] = 523,
    ["lgtm.yml"] = 524,
    ["liblab.config.json"] = 525,
    ["libman.json"] = 526,
    ["license-report-config.json"] = 527,
    ["linkinator.config.json"] = 529,
    ["lint-staged (.lintstagedrc)"] = 952,
    ["local.settings.json"] = 534,
    ["localazy.json"] = 535,
    ["lotus.yaml"] = 533,
    ["lsdlschema.json"] = 536,
    ["macro.json"] = 1065,
    ["markdown-link-check"] = 1019,
    maturin = 1020,
    mboats = 1027,
    memnex = 1277,
    ["micro-settings.json"] = 1092,
    ["mimetypes.json"] = 551,
    ["mirrord config"] = 954,
    mise = 955,
    ["mkdocs.yml"] = 571,
    ...
    ["monospace.yml"] = 577,
    ["moon.yml"] = 1175,
    ["mprocs Configuration file"] = 1146,
    ["mrdocs.yml"] = 573,
    ["mta.yaml"] = 956,
    ["mtad.yaml"] = 957,
    ["mycode.json"] = 584,
    nFPM = 591,
    ["napari plugin manifest"] = 585,
    neoload = 969,
    ["nest-cli"] = 594,
    ["nexus-rpc-gen"] = 1265,
    ["ninjs (News in JSON)"] = 593,
    ["nitro.json"] = 968,
    ["nixd configuration"] = 1118,
    ["nlu.json"] = 595,
    ["nodemon.json"] = 597,
    ["noodl config"] = 1026,
    ["notebook.mod.json"] = 598,
    now = 964,
    ["npm-badges"] = 601,
    ["nswag.json"] = 605,
    ntangle = 607,
    ["nuclei-template.yaml"] = 602,
    ["nuget-project.json"] = 603,
    ["ocelot.json"] = 609,
    ogen = 612,
    ["omnisharp.json"] = 615,
    openHAB = 1251,
    ...
    oxlint = 1262,
    ["package.json"] = 649,
    ["package.manifest"] = 651,
    ["package.yaml"] = 650,
    ["partial-black.json"] = 145,
    ["partial-fastapi.json"] = 146,
    ["partial-pixi.json"] = 659,
    ["partial-scheduled.json"] = 147,
    ["pattern.json"] = 657,
    ["petstore-v1.0"] = 1072,
    pgap_yaml_input_reader = 656,
    pgxgen = 1255,
    pitcms = 1258,
    ["pixi.toml"] = 658,
    ["plagiarize-me.yaml"] = 663,
    ["plagiarize.yaml"] = 662,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1182,
    ["podbard.yaml"] = 665,
    ["portman.json"] = 668,
    ["prefect.toml"] = 677,
    ["prefect.yaml"] = 678,
    ...
    ["prettierrc.json"] = 680,
    ["prisma.yml"] = 681,
    ["project-1.0.0-beta3.json"] = 693,
    ["project-1.0.0-beta4.json"] = 694,
    ["project-1.0.0-beta5.json"] = 695,
    ["project-1.0.0-beta6.json"] = 696,
    ["project-1.0.0-beta8.json"] = 697,
    ["project-1.0.0-rc1.json"] = 698,
    ["project-1.0.0-rc2.json"] = 699,
    ["project.json"] = 692,
    ["project.owasp.yaml"] = 700,
    ["prometheus-alertmanager.json"] = 704,
    ["prometheus.json"] = 701,
    ["prometheus.rules.json"] = 702,
    ["prometheus.rules.test.json"] = 703,
    ["proxies.json"] = 705,
    ["publiccode.yml"] = 706,
    ["pubspec.yaml"] = 707,
    ["pyrseas-0.8.json"] = 710,
    pytest = 719,
    ["quilt.mod.json"] = 1093,
    ["rc3 auth"] = 725,
    ["rc3 collection"] = 726,
    ...
    ["release drafter"] = 970,
    ["release-hub.json"] = 3,
    ["release-please-config.json"] = 735,
    ["release-please-manifest.json"] = 736,
    ["release-plz.toml"] = 737,
    ["renv.lock"] = 751,
    ["reposets Configuration"] = 740,
    ["reposets Credentials"] = 741,
    ["revola.json"] = 1,
    ["rivet.json"] = 1117,
    ["rivet.yaml (legacy)"] = 1116,
    rumdl = 756,
    runny = 755,
    rustfmt = 757,
    ryl = 758,
    ...
    samt = 760,
    samtrc = 761,
    ["sarif-1.0.0.json"] = 763,
    ["sarif-2.0.0.json"] = 764,
    ["sarif-2.1.0"] = 774,
    ["sarif-2.1.0-rtm.2"] = 765,
    ["sarif-2.1.0-rtm.3"] = 767,
    ["sarif-2.1.0-rtm.4"] = 769,
    ["sarif-2.1.0-rtm.5"] = 771,
    ["sarif-2.1.0-rtm.6"] = 772,
    ["sarif-external-property-file-2.1.0"] = 775,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 766,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 768,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 770,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 773,
    ["scalingo.json configuration"] = 776,
    ["schema.org - Action"] = 778,
    ["schema.org - ContactPoint"] = 779,
    ["schema.org - Place"] = 780,
    ["schema.org - Thing"] = 781,
    ["secrethub.yml"] = 1095,
    ["semantic-release"] = 788,
    ["servicehub.config.json"] = 947,
    ["servicehub.service.json"] = 946,
    ["settings.job"] = 791,
    ["sfdx-hardis configuration"] = 793,
    ["shard.yml"] = 1133,
    ["size-limit configuration"] = 798,
    ["skaffold.yaml"] = 1017,
    ["skyuxconfig.json"] = 800,
    ["snowflake-config"] = 802,
    ["snowflake-connections"] = 803,
    ["spicepod.yaml"] = 1154,
    ["sqlc configuration"] = 835,
    ["stripe-app-local.json"] = 846,
    ["stripe-app.json"] = 845,
    swcrc = 1002,
    ["task.json"] = 855,
    taskcat = 965,
    ["template.json"] = 860,
    ["templatsources.json"] = 861,
    ["text2confl config"] = 1263,
    ["theme.json"] = 864,
    ["tizen_workspace.json"] = 866,
    tldr = 867,
    ["tm_devices configuration file"] = 1220,
    tmuxinator = 950,
    tox = 869,
    ["transcend.yml"] = 878,
    ["tree-sitter grammar.json"] = 430,
    ["trime.yaml"] = 879,
    ["trunk.yaml"] = 881,
    ["ts-force-config.json"] = 886,
    ["tsconfig.json"] = 882,
    ["tsd.json"] = 883,
    ["tsdoc.json"] = 884,
    ["tsdrc.json"] = 885,
    ...
    ["vega-lite.json"] = 910,
    ["vega.json"] = 909,
    ["venvironment.yaml"] = 912,
    ["venvplus.yaml"] = 913,
    version = 1202,
    ["version.json"] = 915,
    ["vhwdebugger-binding.yaml"] = 917,
    ["vim-addon-info"] = 918,
    ["vs-2017.3.host.json"] = 920,
    ["vs-nesting.json"] = 921,
    ["vsls.json"] = 919,
    ["vss-extension.json"] = 925,
    vtcfg = 1208,
    ["vtesttree.yaml"] = 926,
    ["vtestunit.yaml"] = 927,
    ["warp-keysets.json"] = 1101,
    ["warp-themes.json"] = 1102,
    ["warp-workflows.json"] = 1103,
    ["webhint.io"] = 1057,
    ["webjobpublishsettings.json"] = 932,
    ["webjobs-list.json"] = 931,
    ["well-known-fursona"] = 1141,
    ["xs-app.json"] = 960,
    ["xunit.runner.json"] = 945,
    yamlfmt = 988,
    yamllint = 989,
    ["zerops.yml"] = 1150,
    zizmor = 1245,
