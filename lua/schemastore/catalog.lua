...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 957,
    [".nodehawkrc"] = 594,
    [".npmpackagejsonlintrc"] = 598,
    [".omletrc"] = 1137,
    [".phrase.yml"] = 673,
    [".phraseapp.yml"] = 674,
    [".pmbot.yml"] = 658,
    [".postcssrc"] = 667,
    [".powerpages-web-template-manifest"] = 669,
    [".pre-commit-config.yml"] = 670,
    [".pre-commit-hooks.yml"] = 671,
    [".putout.json"] = 707,
    [".rehyperc"] = 732,
    [".remarkrc"] = 736,
    [".sprite files"] = 831,
    ...
    AIConfig = 35,
    ["AMX Muse Program Descriptor"] = 1185,
    ["API Builder"] = 993,
    ["AVA Configuration"] = 1056,
    ["AWS AppConfig Feature Flags-v1"] = 69,
    ["AWS CDK cdk.json"] = 268,
    ["AWS CloudFormation"] = 269,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 270,
    ["AWS Copilot Manifest"] = 1224,
    ["AWS SAM CLI Samconfig"] = 271,
    Acton = 1274,
    ["Adobe UXP Manifest"] = 1119,
    ["Aerleon Network & Service Definitions"] = 21,
    ["Aerleon Policy"] = 22,
    ["Agent Permission Policy"] = 1264,
    ["AgentCore CLI"] = 1265,
    Aider = 1214,
    Air = 24,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1235,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1234,
    ["Airlock Microgateway"] = 36,
    ["Alacritty Configuration"] = 1028,
    ["All Contributors configuration file"] = 1082,
    ["Ansible Argument Specs"] = 410,
    ["Ansible Collection Galaxy"] = 417,
    ["Ansible Execution Environment"] = 407,
    ["Ansible Inventory"] = 416,
    ["Ansible Meta"] = 408,
    ["Ansible Meta Runtime"] = 409,
    ["Ansible Navigator Configuration"] = 419,
    ["Ansible Playbook"] = 414,
    ["Ansible Requirements"] = 411,
    ["Ansible Rulebook"] = 415,
    ["Ansible Tasks File"] = 413,
    ["Ansible Vars File"] = 412,
    ["Ansible-lint Configuration"] = 418,
    Any = 1147,
    ...
    ["Application list for a WinUtil"] = 1164,
    ArchitectFX = 1169,
    ["Argo CD"] = 55,
    ["Argo Events"] = 56,
    ["Argo Workflows"] = 57,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1233,
    ["Azure IoT Operations connector metadata"] = 1230,
    ...
    ["Azure Pipelines"] = 115,
    ["Azure Static Web Apps CLI configuration file"] = 835,
    ["Azure Static Web Apps configuration file"] = 834,
    BMML = 1252,
    ["BOSH CPI Config"] = 141,
    ...
    ["Bacon config"] = 6,
    ["Barba-CV"] = 84,
    ["Bashly (bashly.yml)"] = 1086,
    ["Bashly Settings (bashly-settings.yml)"] = 1087,
    Bento = 1251,
    ["Better Code Hub"] = 998,
    ["Better Scripts"] = 163,
    Bigconfig = 134,
    ["Biome Formatter Config"] = 85,
    ["Bitmovin Encoding Template"] = 1178,
    BizTalkServerApplicationSchema = 964,
    Bleep = 164,
    ["Block Protocol Metadata"] = 161,
    ["Bluebricks blueprint config"] = 1257,
    ["Boyka Framework"] = 143,
    ["Bpod Finite-State Machine"] = 87,
    Briefcase = 970,
    ["Build Info"] = 152,
    Buildkite = 154,
    ["Bukkit plugin.yml"] = 153,
    ["BungeeCord plugin.yml"] = 159,
    ["Butane Config"] = 1041,
    C4InterFlow = 1193,
    ["CDK Environment Manager, concrete environment configuration"] = 1217,
    ["CDK Environment Manager, concrete environments definition"] = 1216,
    ["CDK Environment Manager, environment definition"] = 1215,
    ["CGS Card Game Specification (cgs.json)"] = 1124,
    ["CICS TS region tagging"] = 1050,
    ["CICS TS resource import"] = 1051,
    ["CICS TS resource model"] = 1052,
    ["CICS TS resource overrides"] = 1053,
    ["CMake Presets"] = 165,
    ["CNC Codes"] = 187,
    ["CRS WAF test file"] = 1154,
    ["CRS WAF test platform overrides file"] = 1155,
    ["CSS Comb (.csscomb.json)"] = 296,
    ["CSS Lint (.csslintrc)"] = 297,
    ["CSpell (cspell.json)"] = 295,
    ["CVE Record Format"] = 199,
    CWL = 1130,
    ["Cache Warmup config"] = 166,
    ["Calqulus pipeline"] = 167,
    ["Camel YAML DSL"] = 168,
    ["Cannon TOML"] = 169,
    Carafe = 170,
    ["Cargo Make"] = 172,
    ["Cargo Manifest"] = 171,
    ["Catalog Info Backstage"] = 173,
    ["Chamaleon environment"] = 1182,
    ["Chamaleon properties"] = 1183,
    ["Chamaleon template"] = 1181,
    Changepacks = 1244,
    Changesets = 280,
    Changie = 174,
    Charmcraft = 175,
    Cheatsheets = 1038,
    ["ChordPro Configuration"] = 176,
    ["Chrome Extension"] = 261,
    ["Chromia Model"] = 177,
    ["Chromia Seeder Module Config"] = 179,
    ["Chromia Seeder Root Config"] = 178,
    ["Cinnamon Spice info.json"] = 95,
    ["CircleCI config.yml"] = 236,
    ["Citation File Format"] = 282,
    ["Citrus test case"] = 181,
    CityJSON = 182,
    ["Claude Code Keybindings"] = 194,
    ["Claude Code Plugin Manifest"] = 195,
    ["Claude Code Plugin Marketplace"] = 196,
    ["Claude Code Settings"] = 197,
    ["Clawject config"] = 193,
    ["Cloud Foundry Application Manifest"] = 1136,
    ["Cloud Run Spec v1"] = 1159,
    ...
    ["CloudEvents specification"] = 183,
    ["Code Climate"] = 237,
    CodeCV = 99,
    CodeRabbit = 98,
    ["CodeShip Pro services configuration files"] = 250,
    ["CodeShip Pro steps configuration files"] = 251,
    ["Codecov configuration files"] = 249,
    Codex = 245,
    CodifyCLI = 100,
    Codux = 247,
    ["Cog config file"] = 188,
    ["Commandbox Box.json"] = 189,
    ["Commandbox Server.json"] = 190,
    ["Common Catalog Data"] = 259,
    ["Common Package Specification"] = 191,
    Concord = 1153,
    ["Configu .cfgu files"] = 1141,
    ["Configu .configu file"] = 1142,
    Conjure = 186,
    ["Container Structure Test"] = 978,
    Containerlab = 1007,
    ["Contextive Glossary"] = 1209,
    Convex = 185,
    ["Crowdsec collection config"] = 290,
    ["Crowdsec parser config"] = 291,
    ["Crowdsec scenario config"] = 292,
    ["CumulusCI Config"] = 192,
    ["Cursor Agent Environment"] = 1262,
    ["Custom Machinery Machine"] = 1125,
    ["Custom Machinery Recipe"] = 1126,
    ["Cycle Stack File"] = 200,
    CycloneDX = 201,
    ["DWP Exchange - catalogue entry"] = 341,
    ["DWP Exchange - gateway"] = 339,
    ["DWP Exchange - meta"] = 340,
    ["Dart Build Config (dart-build.json)"] = 298,
    ["Dart Test Config (dart-test.json)"] = 299,
    ["DashLord Configuration"] = 300,
    ["Data Contract Specification"] = 301,
    ["Data Product Specification"] = 302,
    ["DataYoga Connections"] = 202,
    ["DataYoga Job"] = 203,
    ["Datadog Continuous Testing"] = 508,
    ["Datadog Service Definition"] = 509,
    ["Datadog Software Catalog"] = 510,
    ["Datahub Ingestion Recipe"] = 1057,
    ["Debian Upstream Metadata file"] = 210,
    ["Deck config"] = 211,
    ["Declarative Automation Bundles"] = 1103,
    ["DeepMatch deeplinks spec"] = 212,
    ["Dein Config"] = 213,
    ["Deno Config (deno.json)"] = 308,
    ["Dependency cruiser"] = 214,
    ["DeployStack Configuration"] = 215,
    ["Deployah Configuration"] = 1232,
    ["Deployer Recipe"] = 311,
    ["Deta Spacefile"] = 216,
    ["Detekt Config (detekt.yml)"] = 312,
    ["Devbox Config"] = 217,
    ["Devbox Plugin"] = 218,
    Devfile = 338,
    Devup = 1245,
    DipDup = 1156,
    ["Discord Webhook"] = 313,
    ["DocFx Config (docfx.json)"] = 318,
    ["Docker Desktop extension metadata"] = 315,
    ["Docs MCP Manifest"] = 319,
    Dofigen = 320,
    ["Dolittle Artifacts"] = 321,
    ["Dolittle Bounded Context Configuration"] = 322,
    ["Dolittle Event Horizons Configuration"] = 323,
    ["Dolittle Resources Configuration"] = 324,
    ["Dolittle Server Configuration"] = 325,
    ["Dolittle Tenant Map Configuration"] = 327,
    ["Dolittle Tenants Configuration"] = 326,
    ["Dolittle Topology"] = 328,
    ["DonateCaseBetterCasino menu"] = 1186,
    ["Drupal Breakpoints"] = 219,
    ["Drupal Config"] = 231,
    ["Drupal Info"] = 220,
    ["Drupal Layouts"] = 221,
    ["Drupal Libraries"] = 222,
    ["Drupal Links Action"] = 223,
    ["Drupal Links Contextual"] = 224,
    ["Drupal Links Menu"] = 225,
    ["Drupal Links Task"] = 226,
    ["Drupal Migration"] = 227,
    ["Drupal Permissions"] = 228,
    ["Drupal Recipe"] = 229,
    ["Drupal Routing"] = 230,
    ["Drupal Services"] = 232,
    ["Drush site aliases"] = 334,
    ["Dynamic Bash Aliases (.aliases)"] = 1094,
    ["EAS config"] = 361,
    ["ECA - Editor Code Assistant"] = 343,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1083,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1229,
    ["EasyVCR .NET"] = 363,
    ["Eidolon Resource"] = 1170,
    ["Elgato Stream Deck"] = 345,
    Elm = 1158,
    ["Embrace Config"] = 1069,
    Endurica = 1107,
    ["Enterprise Contract Policy Spec"] = 346,
    ["Envelope Team Definition"] = 1273,
    ["Envilder Map File"] = 347,
    ["Erda Pipeline"] = 1132,
    ["Erda Runtime"] = 1133,
    ["Espanso config.yml"] = 1255,
    ["Espanso match.yml"] = 1254,
    Esquio = 349,
    ["Estuary Flow Catalog"] = 1047,
    ["Ethereum ERC1155"] = 1267,
    ["Ethereum ERC721"] = 1266,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 354,
    ["EveryVoice TTS Toolkit Data Configuration"] = 355,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 359,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 358,
    ["EveryVoice TTS Toolkit Text Configuration"] = 356,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 357,
    ["Evolving Resolutive Process notation"] = 1231,
    ["Expo SDK"] = 360,
    ["Expoot app config"] = 362,
    ["F-Droid Data metadata"] = 367,
    ["FasterCI Configuration"] = 116,
    ["Fence configuration"] = 117,
    FiQuS = 371,
    Firebase = 369,
    ["Flatpak Builder Manifest"] = 372,
    ["FlexGet Config"] = 373,
    ["Flow.json Configurations"] = 1129,
    ["Fossa configuration file"] = 380,
    ["Fossa's fossa-deps file"] = 381,
    ["Foundry VTT - Base package Manifest"] = 375,
    ["Foundry VTT - Module Manifest"] = 376,
    ["Foundry VTT - System Data Template"] = 379,
    ["Foundry VTT - System Manifest"] = 377,
    ["Foundry VTT - World Manifest"] = 378,
    ["Foxx Manifest"] = 118,
    ["Freifunk.de Community API"] = 121,
    ["Frogbot Config"] = 122,
    ["G2P Mapping Configuration"] = 387,
    ["GCP Blueprint Metadata"] = 390,
    Gaspar = 388,
    ["GatewayCore API Gateway"] = 389,
    ["Gemini CLI settings"] = 391,
    ["GeoJSON.json latest"] = 1045,
    GherKing = 1049,
    ["GitHub Action"] = 396,
    ["GitHub Actions typing"] = 1166,
    ["GitHub Discussion"] = 397,
    ["GitHub Funding"] = 398,
    ["GitHub Issue Template configuration"] = 399,
    ["GitHub Issue Template forms"] = 400,
    ["GitHub Workflow"] = 401,
    ["GitHub Workflow Template Properties"] = 402,
    ["GitHub automatically generated release notes configuration"] = 403,
    ["GitLab Agent for Kubernetes configuration"] = 1121,
    GitVersion = 393,
    ["Gitea Issue Template configuration"] = 394,
    ["Gitea Issue Template forms"] = 395,
    ["Gitpod Automations"] = 405,
    ["Gitpod Configuration"] = 406,
    ["GlazeWM settings"] = 1123,
    ["Global Privacy Control"] = 392,
    Goblet = 1102,
    ["Golangci-lint Configuration"] = 421,
    ["Golangci-lint Custom Plugins Configuration"] = 422,
    ["Google Chrome Related Website Sets"] = 370,
    ["Google Cloud Workflows"] = 267,
    ["Google Digital Assetlinks"] = 1210,
    Goreleaser = 424,
    ["Goreleaser Pro"] = 425,
    Goss = 426,
    ["Gradle Build Cache Node"] = 996,
    ["Gradle Enterprise"] = 995,
    ["Grafana 5.x Dashboard"] = 427,
    ["GraphQL Code Generator"] = 432,
    ["GraphQL Config"] = 431,
    ["GraphQL Mesh"] = 430,
    ["GroovyLint configuration"] = 433,
    ["Grunt JSHint task"] = 437,
    ["Grunt Watch task"] = 438,
    ["Grunt base task"] = 439,
    ["Grunt clean task"] = 435,
    ["Grunt copy task"] = 434,
    ["Grunt cssmin task"] = 436,
    HEMTT = 960,
    Hadolint = 974,
    Hammerkit = 1006,
    ["Hardware Sentry Configuration"] = 1061,
    ["Hashgraph Online Skill Manifest"] = 2,
    ["HashiCorp Vault"] = 440,
    Hatch = 975,
    Hayson = 442,
    ["Haystack Pipeline"] = 443,
    ["Hazelcast 5 Configuration"] = 444,
    ["Hecate Input Schema"] = 1221,
    ["Helm Chart.lock"] = 234,
    ["Helm Chart.yaml"] = 233,
    ["Helm Unittest Test Suite"] = 235,
    ["Home Assistant Integration Manifest"] = 445,
    ["Homer dashboard configuration"] = 446,
    Hugo = 1037,
    ["Hugo Theme"] = 1036,
    ["Hulak Configuration"] = 453,
    ["Hyperfoil benchmark configuration"] = 452,
    ["IBM Zapp document"] = 454,
    ["IBM zCodeFormatSettings"] = 455,
    ["IMG Catapult PSP"] = 460,
    ["IVMS101 by CODE Protocol"] = 1122,
    Infrahub = 462,
    Istanbul = 1065,
    ["JDownloader2 crawler multi-rules"] = 475,
    ["JDownloader2 crawler single-rules"] = 474,
    ["JFrog Applications Config"] = 476,
    ["JFrog File Spec"] = 477,
    ["JFrog Pipelines YML DSL"] = 1071,
    ["JMeter DSL cli config"] = 478,
    JReleaser = 481,
    ["JSON Document Transform"] = 489,
    ["JSON Feed"] = 490,
    ["JSON Resume"] = 744,
    ["JSON Schema Draft 2020-12"] = 942,
    ["JSON Schema Draft 4"] = 939,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1104,
    ["JSON Schema Draft 7"] = 940,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1105,
    ["JSON Schema Draft 8 (2019-09)"] = 941,
    ["JSON-API"] = 488,
    ["JSON-e templates"] = 1003,
    ["JSON-stat 2.0"] = 935,
    JSONPatch = 492,
    ["JSR Package Config (jsr.json)"] = 482,
    Jarl = 1237,
    Jasmine = 469,
    Jekyll = 470,
    ["Jenkins X Pipelines"] = 471,
    ["Jenkins X Requirements"] = 472,
    Jest = 473,
    Jocker = 479,
    ["Jovo Language Models"] = 480,
    ["Jujutsu (jj) VCS config"] = 1223,
    ["KIMMDY config file"] = 503,
    ["KODE/CI build.yaml"] = 1067,
    ["KSP-AVC"] = 936,
    ["KSP-CKAN"] = 937,
    ["KSP-NetKAN"] = 938,
    KSY = 1134,
    KSail = 385,
    ["KYA Manifest"] = 1135,
    ["Karakum configuration file"] = 382,
    Kas = 495,
    ["Kestra flow file"] = 504,
    ["Keycloak REST API"] = 1074,
    ["Knative Functions - func.yaml"] = 383,
    Knip = 384,
    ["Knowledge Unit"] = 512,
    ["Kometa (nightly) config file"] = 506,
    ["Kometa config file"] = 505,
    ["Kong DBLess config"] = 1068,
    KrakenD = 507,
    ["Kubri Configuration"] = 515,
    LOOBin = 530,
    ["Lake configuration file"] = 1226,
    ["Landing Zone Accelerator on AWS - Accounts Config"] = 272,
    ["Landing Zone Accelerator on AWS - Customizations Config"] = 273,
    ["Landing Zone Accelerator on AWS - Global Config"] = 274,
    ["Landing Zone Accelerator on AWS - IAM Config"] = 275,
    ["Landing Zone Accelerator on AWS - Network Config"] = 276,
    ["Landing Zone Accelerator on AWS - Organization Config"] = 277,
    ["Landing Zone Accelerator on AWS - Replacements Config"] = 278,
    ["Landing Zone Accelerator on AWS - Security Config"] = 279,
    ["Lando (landofile)"] = 111,
    ["LangGraph Platform configuration"] = 1146,
    ["Language configuration"] = 1145,
    Lefthook = 519,
    ["Liferay client-extension.yaml"] = 526,
    ["LinkML Metamodel"] = 528,
    Liquibase = 1012,
    ["Liquibase Flow File"] = 1013,
    ["Lively Properties"] = 529,
    ["Lobe AI Agent"] = 113,
    Loki = 114,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 572,
    ["MS2Rescore Configuration"] = 577,
    ["Madness (madness.yml)"] = 1085,
    ["Mado configuration"] = 536,
    ["Maestro Flow"] = 537,
    ["Mail Servers Configuration"] = 1258,
    ["MapEHR Mapping"] = 538,
    Markdownlint = 1016,
    ["Mason Registry"] = 1019,
    ["MegaLinter Custom Flavor"] = 541,
    ["MegaLinter configuration"] = 540,
    ["MegaLinter descriptor"] = 542,
    Melange = 1112,
    ["Meltano project definition"] = 543,
    ["Mergify Configuration"] = 578,
    ["Metadata for a Bazel module"] = 544,
    ["Metadata for a Cinnamon spice"] = 1162,
    ["Metatype Configuration"] = 545,
    ["MetricsHub Configuration"] = 546,
    ["MetricsHub Connector Configuration"] = 547,
    ["Micro Editor Syntax"] = 1095,
    ["Microsoft Band Web Tile"] = 548,
    ["Microsoft RulesEngine workflow rules"] = 1150,
    ["Microsoft RulesEngine workflow rules list"] = 1151,
    ["Minecraft Custom Main Menu Mod"] = 1113,
    ["Minecraft Data Pack Advancement"] = 550,
    ["Minecraft Data Pack Biome"] = 551,
    ["Minecraft Data Pack Configured Carver"] = 552,
    ["Minecraft Data Pack Damage Type"] = 553,
    ["Minecraft Data Pack Dimension"] = 555,
    ["Minecraft Data Pack Dimension Type"] = 554,
    ["Minecraft Data Pack Item Modifier"] = 556,
    ["Minecraft Data Pack Loot Table"] = 557,
    ["Minecraft Data Pack Metadata"] = 558,
    ["Minecraft Data Pack Predicate"] = 559,
    ["Minecraft Data Pack Recipe"] = 560,
    ["Minecraft Data Pack Tag"] = 561,
    ["Minecraft Data Pack Template Pool"] = 562,
    ["Minecraft Data Pack Trim Material"] = 567,
    ["Minecraft Data Pack Trim Pattern"] = 568,
    ["Minecraft Resource Pack Lang"] = 563,
    ["Minecraft Resource Pack Particle"] = 564,
    ["Minecraft Resource Pack Texture Mcmeta"] = 566,
    ["Minecraft Resourcepack Sounds"] = 565,
    ["MockServer Expectations"] = 574,
    ModuleAssembler = 570,
    ["Monade CLI Stack Configuration"] = 581,
    ["MongoDB Atlas Search Index Definition"] = 1066,
    ["Monika Configuration"] = 1064,
    ["Monoweave Configuration"] = 576,
    ["Motif config"] = 956,
    MultiQC = 1203,
    ["NOX Framework (Service)"] = 597,
    ["Netin Diagnostic System Template"] = 1023,
    ["Netlify config"] = 584,
    ["Network-as-Code Data Model"] = 585,
    ["Next Gen UI Agent A2A Server Configuration"] = 586,
    ["Next Gen UI Agent Configuration"] = 588,
    ["Next Gen UI Agent MCP Server Configuration"] = 587,
    ["Nightwatch.js"] = 590,
    ["Node.js configuration"] = 961,
    ["NueJS configuration file"] = 602,
    ["Nuitka.yaml"] = 1127,
    ["Nullstone config"] = 604,
    ["ONe's changelog entry"] = 623,
    ["ONe's service descriptor"] = 622,
    ["ORT Server repository environment configuration"] = 633,
    ["OSCAL Assessment Plan (AP)"] = 635,
    ["OSCAL Assessment Results (AR)"] = 636,
    ["OSCAL Catalog"] = 637,
    ["OSCAL Component Definition (CDef)"] = 638,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 639,
    ["OSCAL Profile"] = 640,
    ["OSCAL System Security Plan (SSP)"] = 641,
    ["OSS Review Toolkit configuration"] = 642,
    ["OSS Review Toolkit curation"] = 643,
    ["OSS Review Toolkit package configuration"] = 644,
    ["OSS Review Toolkit repository configuration"] = 645,
    ["OSS Review Toolkit resolutions"] = 646,
    ["October CMS columns"] = 608,
    ["October CMS fields"] = 609,
    ["Oh My Posh"] = 611,
    Okteto = 612,
    ["Ona Automations"] = 614,
    Opctl = 959,
    ["Open Data Contract Standard (ODCS)"] = 627,
    ["Open Data Product Standard (ODPS)"] = 628,
    ["Open Know-How"] = 1208,
    OpenDecree = 1271,
    ["OpenDecree Configuration"] = 1272,
    ["OpenRewrite Resource"] = 625,
    OpenSRM = 629,
    OpenStatus = 1219,
    ["OpenTelemetry Declarative Configuration"] = 626,
    ["OpenUtau character yaml"] = 619,
    ["OpenUtau ustx"] = 620,
    ["OpenWeather Current Weather API"] = 1002,
    ["OpenWeather Road Risk API"] = 1001,
    ["Ory Hydra configuration"] = 451,
    ["Ory Keto configuration"] = 511,
    ["Ory Kratos configuration"] = 634,
    ["Ory Oathkeeper configuration"] = 606,
    ["Outblocks App configuration"] = 631,
    ["Outblocks database table"] = 632,
    ["Outblocks project configuration"] = 630,
    PDM = 653,
    POPxf = 664,
    ["POPxf Correlations"] = 665,
    ["PRML manifest"] = 672,
    Packer = 650,
    PactSpec = 651,
    Pantsbuild = 1081,
    ["Paper paper-plugin.yml"] = 652,
    ["Pipeline component"] = 1014,
    ["Platform.sh application"] = 8,
    ["Platform.sh routes"] = 9,
    ["Platform.sh services"] = 10,
    ["Plex Prerolls"] = 662,
    ["PocketMine plugin.yml"] = 659,
    ["Postman collection"] = 668,
    ["Power Pages Configuration"] = 1220,
    ["Preset list for a WinUtil"] = 1165,
    ["ProActions AI-Kit Configuration"] = 680,
    ["ProActions AI-Kit Configuration for Menus"] = 682,
    ["ProActions AI-Kit Configuration for Sections"] = 684,
    ["ProActions AI-Kit Configuration for Services"] = 681,
    ["ProActions AI-Kit Configuration for Steps"] = 685,
    ["ProActions AI-Kit Configuration for Templates"] = 683,
    ["Problem object RFC9457"] = 1110,
    ["Problem package format"] = 686,
    ["Problem package generators"] = 687,
    ["Problem package submissions"] = 688,
    ["Problem package test group metadata"] = 689,
    Pterodactyl = 1060,
    ["Pull Request Labeler"] = 706,
    Pulumi = 714,
    ["PyGTA Config"] = 710,
    PyProject = 715,
    Pylock = 1211,
    Pyright = 716,
    ["Python script metadata"] = 1205,
    ["QType AI DSL"] = 719,
    Qgoda = 718,
    Qodana = 1033,
    ["Qt Creator workspace file"] = 1143,
    ["Quali Torque Blueprint Spec 2"] = 1058,
    ["QueryFirst config file"] = 1077,
    ["Qwen Code Settings"] = 1268,
    ["RKE Cluster Configuration JSON"] = 1011,
    ["RKE Cluster Configuration YAML"] = 1010,
    RadioHound = 709,
    ["Raid Profile"] = 1269,
    ["Raid Repo Configuration"] = 1270,
    Railpack = 721,
    Railway = 720,
    ["Rancher Fleet"] = 711,
    ["Rattler-build"] = 722,
    Ray = 973,
    ["Read the Docs"] = 713,
    ["Red-DiscordBot Cog"] = 729,
    ["Red-DiscordBot Cog Repo"] = 730,
    ["Red-DiscordBot Trivia"] = 731,
    ["Releasaurus Config"] = 5,
    ReleaseKit = 4,
    ["Render Blueprints"] = 1009,
    RenderCV = 748,
    Renovate = 745,
    ["Renovate global configuration"] = 746,
    ["Renovate inherited configuration"] = 747,
    ["Replit config"] = 737,
    Restate = 1198,
    ["Revel Digital Gadget Definition File"] = 1222,
    RoadRunner = 750,
    ["Robust Station Image"] = 1228,
    Rockcraft = 751,
    ["Roo Coder Custom Modes"] = 752,
    Rubocop = 741,
    ["Rudder techniques"] = 1117,
    Ruff = 742,
    ["Rust Project"] = 743,
    ["Rust toolchain"] = 757,
    ["SDMX data message"] = 784,
    ["SDMX metadata message"] = 783,
    ["SDMX structure message"] = 782,
    ["SIL Kit Participant Configuration"] = 794,
    ["SIL Kit Registry Configuration"] = 795,
    ["SPDX 2.3"] = 832,
    SWADL = 848,
    ["Safebox Config"] = 1072,
    ["Sapphire CLI Config"] = 760,
    ["SauceCTL Configuration"] = 1020,
    Scarb = 780,
    ["Schema Catalog"] = 775,
    ["Scoop manifest"] = 781,
    ["Semantic Data Fabric (SDF) file"] = 785,
    ["Semgrep Rule"] = 787,
    ["Serenity Code Generator (Sergen)"] = 788,
    ["Serverless Framework Configuration"] = 1027,
    ["Serverless Workflow"] = 1029,
    ["Settings for a Cinnamon spice"] = 1161,
    ["Settings.paf"] = 790,
    ["Shopware 6 Configuration"] = 1030,
    ["Shopware CLI Extension Store Configuration"] = 1031,
    ["Shopware CLI Project Store Configuration"] = 1032,
    ["Sigma Detection Rule"] = 792,
    ["Sigrid scope configuration file"] = 793,
    ["SkyPilot Task JSON"] = 1118,
    ["Slack app manifest"] = 797,
    Snapcraft = 799,
    Solidarity = 802,
    ["Solution filters"] = 803,
    ["Source Maps v3"] = 804,
    Sourcery = 805,
    ["Spack bootstrap.yaml"] = 806,
    ["Spack cdash.yaml"] = 807,
    ["Spack ci.yaml"] = 808,
    ["Spack compilers.yaml"] = 809,
    ["Spack concretizer.yaml"] = 810,
    ["Spack config.yaml"] = 811,
    ["Spack definitions.yaml"] = 812,
    ["Spack develop.yaml"] = 813,
    ["Spack env_vars.yaml"] = 814,
    ["Spack environment"] = 820,
    ["Spack include.yaml"] = 815,
    ["Spack mirrors.yaml"] = 816,
    ["Spack modules.yaml"] = 817,
    ["Spack packages.yaml"] = 818,
    ["Spack repos.yaml"] = 819,
    ["Spack toolchains.yaml"] = 821,
    ["Spack upstreams.yaml"] = 822,
    ["Spack view.yaml"] = 823,
    ["Speakeasy Generation Config File"] = 827,
    ["Speakeasy Lint Configuration File"] = 824,
    ["Speakeasy Test Generation Configuration File"] = 825,
    ["Speakeasy Workflow File"] = 826,
    SpecIF = 828,
    ["Specmatic Configuration"] = 829,
    ["Sponge Mixin configuration"] = 830,
    StackBlitz = 836,
    ["StackHawk Scanner Configuration"] = 1026,
    Stale = 837,
    Starfish = 838,
    ["Starlake Data Pipeline"] = 999,
    Starship = 839,
    ["Statamic Blueprint"] = 840,
    ["Stella configuration file"] = 841,
    ["Streamlit configuration file"] = 842,
    ["Stryker Mutator"] = 845,
    ["StyleCop Analyzers Configuration"] = 846,
    ["Stylelint (.stylelintrc)"] = 847,
    ["Stylua Config"] = 1212,
    ["Sublime Syntax"] = 1073,
    ["Subsquid squid manifest"] = 1120,
    ["Swagger API 2.0"] = 849,
    ["Synadia Connect Component"] = 850,
    TSON = 886,
    TSTyche = 887,
    ["TYPO3 Vendor Bundler config"] = 893,
    ["Tab data for a LinUtil"] = 1168,
    ["Tab list for a LinUtil"] = 1167,
    Tach = 851,
    ["Tach Domain"] = 852,
    Talhelper = 854,
    ["Talisman configuration"] = 855,
    Taplo = 1213,
    ["Taskfile config"] = 1004,
    Taurus = 856,
    Tauticord = 857,
    ["Tekton Pipeline"] = 1241,
    ["Tekton PipelineRun"] = 1242,
    ["Tekton Task"] = 1239,
    ["Tekton TaskRun"] = 1240,
    Telefonistka = 1199,
    ["Terrateam config"] = 1225,
    ["TestEnvironment.json"] = 869,
    ["TextMate Grammar"] = 868,
    Threagile = 863,
    ["Tier.run pricing.json"] = 860,
    Tikibase = 861,
    Tombi = 866,
    ["Traefik v2"] = 872,
    ["Traefik v2 File Provider"] = 873,
    ["Traefik v3"] = 874,
    ["Traefik v3 File Provider"] = 875,
    ["Travis CI (.travis.yml)"] = 871,
    Treefmt = 429,
    Trident = 1195,
    ["TrueScript for *.tscript files"] = 878,
    ["Tugboat QA config.yml"] = 1192,
    TunnelHub = 1108,
    Turborepo = 870,
    Tycho = 1157,
    Tye = 1034,
    ["Tyk Gateway - Open Source v5.7+"] = 1204,
    ["UET BuildConfig.json"] = 1078,
    ["UI5 Manifest"] = 899,
    ["UNCORS configuration"] = 903,
    ["UTAM Page Object"] = 902,
    ["Ubuntu Server Autoinstall"] = 897,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1196,
    ["Uniswap Token List"] = 985,
    ["Universal Schedule Format"] = 904,
    ["Unreal Engine Uplugin"] = 1079,
    ["Unreal Engine Uproject"] = 1080,
    ["UpCloud CLI (upctl) configuration"] = 1197,
    ["Updatecli Compose"] = 1042,
    ["Updatecli Policy Manifest"] = 1043,
    ["Updatecli Policy Metadata"] = 1044,
    Uplift = 1076,
    ["Upsun config"] = 7,
    ["User Journey Map"] = 1008,
    V2Ray = 1048,
    ["VSCode Code Snippets"] = 255,
    ["VSIX CLI publishing"] = 922,
    Vector = 906,
    ["Vela Pipeline Configuration"] = 909,
    Vercel = 254,
    ["Version Bumper config"] = 912,
    Vespertide = 1246,
    ["Vespertide Migration"] = 1247,
    ["Vespertide Model"] = 1248,
    ["Viash Component Config"] = 1201,
    ["Viash Package Config"] = 1202,
    Visivo = 1106,
    ["WP-CLI"] = 932,
    Wake = 1194,
    ["Waku Config"] = 1171,
    ["Web App Manifest"] = 928,
    ["Web types"] = 931,
    WebExtensions = 927,
    ["Webman package recipe"] = 1054,
    ["Windows Package Manager Installer Manifest"] = 981,
    ["Windows Package Manager Locale Manifest"] = 982,
    ["Windows Package Manager Singleton Manifest"] = 980,
    Winutil = 983,
    ["WireMock CLI import configuration"] = 1177,
    ["WireMock CLI local service configuration"] = 1176,
    ["WireMock message stub mapping"] = 1175,
    ["WireMock stub mapping"] = 1174,
    ["Woodpecker pipeline config"] = 1022,
    ["Wrangler CLI"] = 933,
    ["XenForo add-on manifest"] = 934,
    ["Xstate Machine"] = 1040,
    ["Yandex Workflow Language"] = 1163,
    ["Yarn Config (.yarnrc.yml)"] = 997,
    ["Yippee-Ki-JSON configuration YML"] = 988,
    ["YouTrack App"] = 1160,
    ["Zarf Package Configuration"] = 1227,
    ["Zerops.io config"] = 1148,
    ["Zerops.io import"] = 1149,
    ["Zola Configuration"] = 1238,
    ["aerleon.yml"] = 20,
    ["amplify.yml"] = 13,
    ["angular.json"] = 37,
    apko = 1111,
    ...
    ["behat.yml"] = 144,
    ["bigquery-table"] = 133,
    ["bioimageio resource description"] = 1128,
    ...
    ["bozr.suite.json"] = 147,
    bpkg = 1089,
    ["browser.i18n.json"] = 148,
    ["browsh configuration"] = 149,
    bucklescript = 150,
    ["buf.gen.yaml"] = 89,
    ["buf.lock"] = 90,
    ["buf.plugin.yaml"] = 91,
    ...
    ["build-changelog"] = 151,
    ["bun.lock"] = 156,
    ["bundleconfig.json"] = 157,
    ["bunfig.toml"] = 158,
    ["cargo-mutants-config.yaml"] = 94,
    ["ccmod.json"] = 1172,
    changelogging = 1140,
    ["chisel-slices.json"] = 281,
    ["chrome-extension-locales-messages.json"] = 262,
    ["chutzpah.json"] = 263,
    cibuildwheel = 180,
    ["clang-format (.clang-format)"] = 1046,
    ["clang-tidy"] = 241,
    clangd = 240,
    clib = 242,
    ["cloud-init: cloud-config userdata"] = 244,
    ["cloud-sdk-pipeline-configuration"] = 265,
    ["cloudbuild.json"] = 266,
    cloudify = 243,
    cmakefmt = 198,
    ["cmdx.yaml"] = 97,
    ...
    ["coffeelint.json"] = 283,
    ["commands.json"] = 258,
    ["commitlint (.commitlintrc)"] = 984,
    ["committed.toml"] = 284,
    ["compile_commands.json"] = 257,
    ["compilerconfig.json"] = 256,
    ["completely.yml"] = 1084,
    ["component-detection-manifest.json"] = 287,
    ["component.json"] = 286,
    ["composer.json"] = 285,
    ["conda-forge"] = 184,
    ["config.yaml"] = 712,
    ["contentmanifest.json"] = 264,
    ["contribute.json"] = 288,
    ["cosmos.config.json"] = 260,
    ["crowdin.yml"] = 289,
    ["ctfd-setup configuration file"] = 1184,
    ["custom-elements.json"] = 1098,
    ["cypress.json"] = 293,
    ["datalogic-scan2deploy-android"] = 303,
    ["datalogic-scan2deploy-ce"] = 304,
    ["dbt Dependencies"] = 205,
    ["dbt Packages"] = 207,
    ["dbt Project"] = 206,
    ["dbt Selectors"] = 208,
    ["dbt YAML files"] = 209,
    ...
    ["ddev-global"] = 305,
    ["ddev-project"] = 306,
    ["debugsettings.json"] = 307,
    ["dependabot-v2.json"] = 310,
    ["dependabot.json"] = 309,
    ["deployed-cli"] = 1039,
    ["devcontainer.json"] = 248,
    devinit = 990,
    ["devspace.yaml"] = 1062,
    djlint = 991,
    ["docker bake"] = 316,
    ["docker sequencer"] = 317,
    ["docker-compose.yml"] = 989,
    ["dockerd.json"] = 314,
    ["dotnet Release Index manifest"] = 329,
    ["dotnet-tools.json"] = 330,
    ["dotnetcli.host.json"] = 331,
    ["dprint.json"] = 332,
    ["drone.json"] = 333,
    ["dss-2.0.0.json"] = 335,
    ["dstack configuration"] = 336,
    ["dtool dataset metadata"] = 1179,
    ["dvc.yaml"] = 337,
    ["ecosystem.json"] = 342,
    eksctl = 344,
    ["electron-builder configuration file"] = 352,
    ["epr-manifest.json"] = 351,
    ["estampo.toml"] = 350,
    ["evcc.yaml"] = 353,
    ["ezd task runner"] = 364,
    ["fabric.mod.json"] = 366,
    ["first-timers-bot"] = 374,
    ["flagd flag configuration"] = 119,
    ["fly.io Configuration"] = 120,
    fulibWorkflows = 1021,
    ["function.json"] = 386,
    ["gRPC API Gateway & OpenAPI Config"] = 15,
    ["gematik health care insurance list"] = 1190,
    ["gematik health care patient list"] = 1187,
    ["gematik health care provider institution list"] = 1189,
    ["gematik health care provider list"] = 1188,
    ["gematik tiger test environment configuration"] = 1191,
    ["git-town.toml"] = 1236,
    ["gitlab-ci"] = 404,
    ["global.json"] = 420,
    ["go-feature-flag Flag Configuration"] = 423,
    ["haxelib.json"] = 441,
    helmfile = 976,
    helmwave = 977,
    ["host-meta.json"] = 448,
    ...
    ["ide.host.json"] = 456,
    ["ifstate.yaml"] = 457,
    ["imageoptimizer.json"] = 458,
    ["importmap.json"] = 461,
    instant_python_config = 463,
    instant_python_custom_project = 464,
    ["ioBroker Configuration"] = 465,
    ["ioBroker JSON UI"] = 466,
    ["ioBroker Package manifest"] = 467,
    ["ixpect.conf.yaml"] = 468,
    ["ize.toml"] = 1075,
    ["jsconfig.json"] = 493,
    ["jscpd Configuration"] = 1059,
    jsdoc = 972,
    ["k3d.yaml"] = 494,
    ["k9s aliases.yaml"] = 496,
    ["k9s cluster-config.yaml"] = 498,
    ["k9s config.yaml"] = 497,
    ["k9s hotkeys.yaml"] = 499,
    ["k9s plugins.yaml"] = 500,
    ["k9s skin.yaml"] = 501,
    ["k9s views.yaml"] = 502,
    ["kontinuous-config.yaml"] = 514,
    ["kontinuous-values.yaml"] = 513,
    ["kustomization.yaml"] = 516,
    ["label-commenter-config.yml"] = 517,
    ["latexindent configuration"] = 112,
    ["launchsettings.json"] = 518,
    lazydocker = 1097,
    lazygit = 1096,
    ["lego.json"] = 520,
    ["lerna.json"] = 521,
    ["lgtm.yml"] = 522,
    ["liblab.config.json"] = 523,
    ["libman.json"] = 524,
    ["license-report-config.json"] = 525,
    ["linkinator.config.json"] = 527,
    ["lint-staged (.lintstagedrc)"] = 950,
    ["local.settings.json"] = 532,
    ["localazy.json"] = 533,
    ["lotus.yaml"] = 531,
    ["lsdlschema.json"] = 534,
    ["macro.json"] = 1063,
    ["markdown-link-check"] = 1017,
    maturin = 1018,
    mboats = 1025,
    memnex = 1275,
    ["micro-settings.json"] = 1090,
    ["mimetypes.json"] = 549,
    ["mirrord config"] = 952,
    mise = 953,
    ["mkdocs.yml"] = 569,
    ...
    ["monospace.yml"] = 575,
    ["moon.yml"] = 1173,
    ["mprocs Configuration file"] = 1144,
    ["mrdocs.yml"] = 571,
    ["mta.yaml"] = 954,
    ["mtad.yaml"] = 955,
    ["mycode.json"] = 582,
    nFPM = 589,
    ["napari plugin manifest"] = 583,
    neoload = 967,
    ["nest-cli"] = 592,
    ["nexus-rpc-gen"] = 1263,
    ["ninjs (News in JSON)"] = 591,
    ["nitro.json"] = 966,
    ["nixd configuration"] = 1116,
    ["nlu.json"] = 593,
    ["nodemon.json"] = 595,
    ["noodl config"] = 1024,
    ["notebook.mod.json"] = 596,
    now = 962,
    ["npm-badges"] = 599,
    ["nswag.json"] = 603,
    ntangle = 605,
    ["nuclei-template.yaml"] = 600,
    ["nuget-project.json"] = 601,
    ["ocelot.json"] = 607,
    ogen = 610,
    ["omnisharp.json"] = 613,
    openHAB = 1249,
    ...
    oxlint = 1260,
    ["package.json"] = 647,
    ["package.manifest"] = 649,
    ["package.yaml"] = 648,
    ["partial-black.json"] = 145,
    ["partial-fastapi.json"] = 146,
    ["partial-pixi.json"] = 657,
    ["pattern.json"] = 655,
    ["petstore-v1.0"] = 1070,
    pgap_yaml_input_reader = 654,
    pgxgen = 1253,
    pitcms = 1256,
    ["pixi.toml"] = 656,
    ["plagiarize-me.yaml"] = 661,
    ["plagiarize.yaml"] = 660,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1180,
    ["podbard.yaml"] = 663,
    ["portman.json"] = 666,
    ["prefect.toml"] = 675,
    ["prefect.yaml"] = 676,
    ...
    ["prettierrc.json"] = 678,
    ["prisma.yml"] = 679,
    ["project-1.0.0-beta3.json"] = 691,
    ["project-1.0.0-beta4.json"] = 692,
    ["project-1.0.0-beta5.json"] = 693,
    ["project-1.0.0-beta6.json"] = 694,
    ["project-1.0.0-beta8.json"] = 695,
    ["project-1.0.0-rc1.json"] = 696,
    ["project-1.0.0-rc2.json"] = 697,
    ["project.json"] = 690,
    ["project.owasp.yaml"] = 698,
    ["prometheus-alertmanager.json"] = 702,
    ["prometheus.json"] = 699,
    ["prometheus.rules.json"] = 700,
    ["prometheus.rules.test.json"] = 701,
    ["proxies.json"] = 703,
    ["publiccode.yml"] = 704,
    ["pubspec.yaml"] = 705,
    ["pyrseas-0.8.json"] = 708,
    pytest = 717,
    ["quilt.mod.json"] = 1091,
    ["rc3 auth"] = 723,
    ["rc3 collection"] = 724,
    ...
    ["release drafter"] = 968,
    ["release-hub.json"] = 3,
    ["release-please-config.json"] = 733,
    ["release-please-manifest.json"] = 734,
    ["release-plz.toml"] = 735,
    ["renv.lock"] = 749,
    ["reposets Configuration"] = 738,
    ["reposets Credentials"] = 739,
    ["revola.json"] = 1,
    ["rivet.json"] = 1115,
    ["rivet.yaml (legacy)"] = 1114,
    rumdl = 754,
    runny = 753,
    rustfmt = 755,
    ryl = 756,
    ...
    samt = 758,
    samtrc = 759,
    ["sarif-1.0.0.json"] = 761,
    ["sarif-2.0.0.json"] = 762,
    ["sarif-2.1.0"] = 772,
    ["sarif-2.1.0-rtm.2"] = 763,
    ["sarif-2.1.0-rtm.3"] = 765,
    ["sarif-2.1.0-rtm.4"] = 767,
    ["sarif-2.1.0-rtm.5"] = 769,
    ["sarif-2.1.0-rtm.6"] = 770,
    ["sarif-external-property-file-2.1.0"] = 773,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 764,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 766,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 768,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 771,
    ["scalingo.json configuration"] = 774,
    ["schema.org - Action"] = 776,
    ["schema.org - ContactPoint"] = 777,
    ["schema.org - Place"] = 778,
    ["schema.org - Thing"] = 779,
    ["secrethub.yml"] = 1093,
    ["semantic-release"] = 786,
    ["servicehub.config.json"] = 945,
    ["servicehub.service.json"] = 944,
    ["settings.job"] = 789,
    ["sfdx-hardis configuration"] = 791,
    ["shard.yml"] = 1131,
    ["size-limit configuration"] = 796,
    ["skaffold.yaml"] = 1015,
    ["skyuxconfig.json"] = 798,
    ["snowflake-config"] = 800,
    ["snowflake-connections"] = 801,
    ["spicepod.yaml"] = 1152,
    ["sqlc configuration"] = 833,
    ["stripe-app-local.json"] = 844,
    ["stripe-app.json"] = 843,
    swcrc = 1000,
    ["task.json"] = 853,
    taskcat = 963,
    ["template.json"] = 858,
    ["templatsources.json"] = 859,
    ["text2confl config"] = 1261,
    ["theme.json"] = 862,
    ["tizen_workspace.json"] = 864,
    tldr = 865,
    ["tm_devices configuration file"] = 1218,
    tmuxinator = 948,
    tox = 867,
    ["transcend.yml"] = 876,
    ["tree-sitter grammar.json"] = 428,
    ["trime.yaml"] = 877,
    ["trunk.yaml"] = 879,
    ["ts-force-config.json"] = 884,
    ["tsconfig.json"] = 880,
    ["tsd.json"] = 881,
    ["tsdoc.json"] = 882,
    ["tsdrc.json"] = 883,
    ...
    v8r = 926,
    vcluster = 1138,
    ["vcpkg configuration file"] = 253,
    ["vcpkg manifest file"] = 252,
    ["vega-lite.json"] = 908,
    ["vega.json"] = 907,
    ["venvironment.yaml"] = 910,
    ["venvplus.yaml"] = 911,
    version = 1200,
    ["version.json"] = 913,
    ["vhwdebugger-binding.yaml"] = 915,
    ["vim-addon-info"] = 916,
    ["vs-2017.3.host.json"] = 918,
    ["vs-nesting.json"] = 919,
    ["vsls.json"] = 917,
    ["vss-extension.json"] = 923,
    vtcfg = 1206,
    ["vtesttree.yaml"] = 924,
    ["vtestunit.yaml"] = 925,
    ["warp-keysets.json"] = 1099,
    ["warp-themes.json"] = 1100,
    ["warp-workflows.json"] = 1101,
    ["webhint.io"] = 1055,
    ["webjobpublishsettings.json"] = 930,
    ["webjobs-list.json"] = 929,
    ["well-known-fursona"] = 1139,
    ["xs-app.json"] = 958,
    ["xunit.runner.json"] = 943,
    yamlfmt = 986,
    yamllint = 987,
    zizmor = 1243,
    zuul = 969,
