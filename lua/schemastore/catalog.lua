...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 960,
    [".nodehawkrc"] = 597,
    [".npmpackagejsonlintrc"] = 601,
    [".omletrc"] = 1140,
    [".phrase.yml"] = 676,
    [".phraseapp.yml"] = 677,
    [".pmbot.yml"] = 661,
    [".postcssrc"] = 670,
    [".powerpages-web-template-manifest"] = 672,
    [".pre-commit-config.yml"] = 673,
    [".pre-commit-hooks.yml"] = 674,
    [".putout.json"] = 710,
    [".rehyperc"] = 735,
    [".remarkrc"] = 739,
    [".sprite files"] = 834,
    ...
    AIConfig = 35,
    ["AMX Muse Program Descriptor"] = 1188,
    ["API Builder"] = 996,
    ["AVA Configuration"] = 1059,
    ["AWS AppConfig Feature Flags-v1"] = 69,
    ["AWS CDK cdk.json"] = 270,
    ["AWS CloudFormation"] = 271,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 272,
    ["AWS Copilot Manifest"] = 1227,
    ["AWS SAM CLI Samconfig"] = 273,
    Acton = 1277,
    ["Adobe UXP Manifest"] = 1122,
    ["Aerleon Network & Service Definitions"] = 21,
    ["Aerleon Policy"] = 22,
    ["Agent Permission Policy"] = 1267,
    ["AgentCore CLI"] = 1268,
    Aider = 1217,
    Air = 24,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1238,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1237,
    ["Airlock Microgateway"] = 36,
    ["Alacritty Configuration"] = 1031,
    ["All Contributors configuration file"] = 1085,
    ["Ansible Argument Specs"] = 413,
    ["Ansible Collection Galaxy"] = 420,
    ["Ansible Execution Environment"] = 410,
    ["Ansible Inventory"] = 419,
    ["Ansible Meta"] = 411,
    ["Ansible Meta Runtime"] = 412,
    ["Ansible Navigator Configuration"] = 422,
    ["Ansible Playbook"] = 417,
    ["Ansible Requirements"] = 414,
    ["Ansible Rulebook"] = 418,
    ["Ansible Tasks File"] = 416,
    ["Ansible Vars File"] = 415,
    ["Ansible-lint Configuration"] = 421,
    Any = 1150,
    ...
    ["Application list for a WinUtil"] = 1167,
    ArchitectFX = 1172,
    ["Argo CD"] = 55,
    ["Argo Events"] = 56,
    ["Argo Workflows"] = 57,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1236,
    ["Azure IoT Operations connector metadata"] = 1233,
    ...
    ["Azure Pipelines"] = 115,
    ["Azure Static Web Apps CLI configuration file"] = 838,
    ["Azure Static Web Apps configuration file"] = 837,
    BMML = 1255,
    ["BOSH CPI Config"] = 141,
    ...
    ["Bacon config"] = 6,
    ["Barba-CV"] = 84,
    ["Bashly (bashly.yml)"] = 1089,
    ["Bashly Settings (bashly-settings.yml)"] = 1090,
    Bento = 1254,
    ["Better Code Hub"] = 1001,
    ["Better Scripts"] = 164,
    Bigconfig = 134,
    ["Biome Formatter Config"] = 85,
    ["Bitmovin Encoding Template"] = 1181,
    BizTalkServerApplicationSchema = 967,
    Bleep = 165,
    ["Block Protocol Metadata"] = 162,
    ["Bluebricks blueprint config"] = 1260,
    ["Boyka Framework"] = 143,
    ...
    ["Butane Config"] = 1044,
    C4InterFlow = 1196,
    ["CDK Environment Manager, concrete environment configuration"] = 1220,
    ["CDK Environment Manager, concrete environments definition"] = 1219,
    ["CDK Environment Manager, environment definition"] = 1218,
    ["CGS Card Game Specification (cgs.json)"] = 1127,
    ["CICS TS region tagging"] = 1053,
    ["CICS TS resource import"] = 1054,
    ["CICS TS resource model"] = 1055,
    ["CICS TS resource overrides"] = 1056,
    ["CMake Presets"] = 166,
    ["CNC Codes"] = 188,
    ["CRS WAF test file"] = 1157,
    ["CRS WAF test platform overrides file"] = 1158,
    ["CSS Comb (.csscomb.json)"] = 298,
    ["CSS Lint (.csslintrc)"] = 299,
    ["CSpell (cspell.json)"] = 297,
    ...
    ["Chamaleon environment"] = 1185,
    ["Chamaleon properties"] = 1186,
    ["Chamaleon template"] = 1184,
    Changepacks = 1247,
    Changesets = 282,
    Changie = 175,
    Charmcraft = 176,
    ...
    ["Clawject config"] = 194,
    ["Cloud Foundry Application Manifest"] = 1139,
    ["Cloud Run Spec v1"] = 1162,
    ...
    CodeCV = 99,
    CodeRabbit = 98,
    ["CodeShip Pro services configuration files"] = 252,
    ["CodeShip Pro steps configuration files"] = 253,
    ["Codecov configuration files"] = 251,
    Codex = 246,
    ["Codex Hooks"] = 247,
    CodifyCLI = 100,
    Codux = 249,
    ...
    ["Common Catalog Data"] = 261,
    ["Common Package Specification"] = 192,
    Concord = 1156,
    ["Configu .cfgu files"] = 1144,
    ["Configu .configu file"] = 1145,
    Conjure = 187,
    ["Container Structure Test"] = 981,
    Containerlab = 1010,
    ["Contextive Glossary"] = 1212,
    Convex = 186,
    ["Crowdsec collection config"] = 292,
    ["Crowdsec parser config"] = 293,
    ["Crowdsec scenario config"] = 294,
    ["CumulusCI Config"] = 193,
    ["Cursor Agent Environment"] = 1265,
    ["Custom Machinery Machine"] = 1128,
    ["Custom Machinery Recipe"] = 1129,
    ["Cycle Stack File"] = 201,
    CycloneDX = 202,
    ["DWP Exchange - catalogue entry"] = 343,
    ["DWP Exchange - gateway"] = 341,
    ["DWP Exchange - meta"] = 342,
    ["Dart Build Config (dart-build.json)"] = 300,
    ["Dart Test Config (dart-test.json)"] = 301,
    ["DashLord Configuration"] = 302,
    ["Data Contract Specification"] = 303,
    ["Data Product Specification"] = 304,
    ["DataYoga Connections"] = 203,
    ["DataYoga Job"] = 204,
    ["Datadog Continuous Testing"] = 511,
    ["Datadog Service Definition"] = 512,
    ["Datadog Software Catalog"] = 513,
    ["Datahub Ingestion Recipe"] = 1060,
    ["Debian Upstream Metadata file"] = 211,
    ["Deck config"] = 212,
    ["Declarative Automation Bundles"] = 1106,
    ["DeepMatch deeplinks spec"] = 213,
    ["Dein Config"] = 214,
    ["Deno Config (deno.json)"] = 310,
    ["Dependency cruiser"] = 215,
    ["DeployStack Configuration"] = 216,
    ["Deployah Configuration"] = 1235,
    ["Deployer Recipe"] = 313,
    ["Deta Spacefile"] = 217,
    ["Detekt Config (detekt.yml)"] = 314,
    ["Devbox Config"] = 218,
    ["Devbox Plugin"] = 219,
    Devfile = 340,
    Devup = 1248,
    DipDup = 1159,
    ["Discord Webhook"] = 315,
    ["DocFx Config (docfx.json)"] = 320,
    ["Docker Desktop extension metadata"] = 317,
    ["Docs MCP Manifest"] = 321,
    Dofigen = 322,
    ["Dolittle Artifacts"] = 323,
    ["Dolittle Bounded Context Configuration"] = 324,
    ["Dolittle Event Horizons Configuration"] = 325,
    ["Dolittle Resources Configuration"] = 326,
    ["Dolittle Server Configuration"] = 327,
    ["Dolittle Tenant Map Configuration"] = 329,
    ["Dolittle Tenants Configuration"] = 328,
    ["Dolittle Topology"] = 330,
    ["DonateCaseBetterCasino menu"] = 1189,
    ...
    ["Drupal Routing"] = 231,
    ["Drupal Services"] = 233,
    ["Drush site aliases"] = 336,
    ["Dynamic Bash Aliases (.aliases)"] = 1097,
    ["EAS config"] = 363,
    ["ECA - Editor Code Assistant"] = 345,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1086,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1232,
    ["EasyVCR .NET"] = 365,
    ["Eidolon Resource"] = 1173,
    ["Elgato Stream Deck"] = 347,
    Elm = 1161,
    ["Embrace Config"] = 1072,
    Endurica = 1110,
    ["Enterprise Contract Policy Spec"] = 348,
    ["Envelope Team Definition"] = 1276,
    ["Envilder Map File"] = 349,
    ["Erda Pipeline"] = 1135,
    ["Erda Runtime"] = 1136,
    ["Espanso config.yml"] = 1258,
    ["Espanso match.yml"] = 1257,
    Esquio = 351,
    ["Estuary Flow Catalog"] = 1050,
    ["Ethereum ERC1155"] = 1270,
    ["Ethereum ERC721"] = 1269,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 356,
    ["EveryVoice TTS Toolkit Data Configuration"] = 357,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 361,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 360,
    ["EveryVoice TTS Toolkit Text Configuration"] = 358,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 359,
    ["Evolving Resolutive Process notation"] = 1234,
    ["Expo SDK"] = 362,
    ["Expoot app config"] = 364,
    ["F-Droid Data metadata"] = 369,
    ["FasterCI Configuration"] = 116,
    ["Fence configuration"] = 117,
    FiQuS = 373,
    Firebase = 371,
    ["Flatpak Builder Manifest"] = 374,
    ["FlexGet Config"] = 375,
    ["Flow.json Configurations"] = 1132,
    ["Fossa configuration file"] = 382,
    ["Fossa's fossa-deps file"] = 383,
    ["Foundry VTT - Base package Manifest"] = 377,
    ["Foundry VTT - Module Manifest"] = 378,
    ["Foundry VTT - System Data Template"] = 381,
    ["Foundry VTT - System Manifest"] = 379,
    ["Foundry VTT - World Manifest"] = 380,
    ["Foxx Manifest"] = 118,
    ["Freifunk.de Community API"] = 121,
    ["Frogbot Config"] = 122,
    ["G2P Mapping Configuration"] = 389,
    ["GCP Blueprint Metadata"] = 392,
    Gaspar = 390,
    ["GatewayCore API Gateway"] = 391,
    ["Gemini CLI settings"] = 393,
    ["GeoJSON.json latest"] = 1048,
    GherKing = 1052,
    ["GitHub Action"] = 398,
    ["GitHub Actions typing"] = 1169,
    ["GitHub Discussion"] = 399,
    ["GitHub Funding"] = 400,
    ["GitHub Issue Template configuration"] = 401,
    ["GitHub Issue Template forms"] = 402,
    ["GitHub Pages Jekyll"] = 403,
    ["GitHub Workflow"] = 404,
    ["GitHub Workflow Template Properties"] = 405,
    ["GitHub automatically generated release notes configuration"] = 406,
    ["GitLab Agent for Kubernetes configuration"] = 1124,
    GitVersion = 395,
    ["Gitea Issue Template configuration"] = 396,
    ["Gitea Issue Template forms"] = 397,
    ["Gitpod Automations"] = 408,
    ["Gitpod Configuration"] = 409,
    ["GlazeWM settings"] = 1126,
    ["Global Privacy Control"] = 394,
    Goblet = 1105,
    ["Golangci-lint Configuration"] = 424,
    ["Golangci-lint Custom Plugins Configuration"] = 425,
    ["Google Chrome Related Website Sets"] = 372,
    ["Google Cloud Workflows"] = 269,
    ["Google Digital Assetlinks"] = 1213,
    Goreleaser = 427,
    ["Goreleaser Pro"] = 428,
    Goss = 429,
    ["Gradle Build Cache Node"] = 999,
    ["Gradle Enterprise"] = 998,
    ["Grafana 5.x Dashboard"] = 430,
    ["GraphQL Code Generator"] = 435,
    ["GraphQL Config"] = 434,
    ["GraphQL Mesh"] = 433,
    ["GroovyLint configuration"] = 436,
    ["Grunt JSHint task"] = 440,
    ["Grunt Watch task"] = 441,
    ["Grunt base task"] = 442,
    ["Grunt clean task"] = 438,
    ["Grunt copy task"] = 437,
    ["Grunt cssmin task"] = 439,
    HEMTT = 963,
    Hadolint = 977,
    Hammerkit = 1009,
    ["Hardware Sentry Configuration"] = 1064,
    ["Hashgraph Online Skill Manifest"] = 2,
    ["HashiCorp Vault"] = 443,
    Hatch = 978,
    Hayson = 445,
    ["Haystack Pipeline"] = 446,
    ["Hazelcast 5 Configuration"] = 447,
    ["Hecate Input Schema"] = 1224,
    ["Helm Chart.lock"] = 235,
    ["Helm Chart.yaml"] = 234,
    ["Helm Unittest Test Suite"] = 236,
    ["Home Assistant Integration Manifest"] = 448,
    ["Homer dashboard configuration"] = 449,
    Hugo = 1040,
    ["Hugo Theme"] = 1039,
    ["Hulak Configuration"] = 456,
    ["Hyperfoil benchmark configuration"] = 455,
    ["IBM Zapp document"] = 457,
    ["IBM zCodeFormatSettings"] = 458,
    ["IMG Catapult PSP"] = 463,
    ["IVMS101 by CODE Protocol"] = 1125,
    Infrahub = 465,
    Istanbul = 1068,
    ["JDownloader2 crawler multi-rules"] = 478,
    ["JDownloader2 crawler single-rules"] = 477,
    ["JFrog Applications Config"] = 479,
    ["JFrog File Spec"] = 480,
    ["JFrog Pipelines YML DSL"] = 1074,
    ["JMeter DSL cli config"] = 481,
    JReleaser = 484,
    ["JSON Document Transform"] = 492,
    ["JSON Feed"] = 493,
    ["JSON Resume"] = 747,
    ["JSON Schema Draft 2020-12"] = 945,
    ["JSON Schema Draft 4"] = 942,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1107,
    ["JSON Schema Draft 7"] = 943,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1108,
    ["JSON Schema Draft 8 (2019-09)"] = 944,
    ["JSON-API"] = 491,
    ["JSON-e templates"] = 1006,
    ["JSON-stat 2.0"] = 938,
    JSONPatch = 495,
    ["JSR Package Config (jsr.json)"] = 485,
    Jarl = 1240,
    Jasmine = 472,
    Jekyll = 473,
    ["Jenkins X Pipelines"] = 474,
    ["Jenkins X Requirements"] = 475,
    Jest = 476,
    Jocker = 482,
    ["Jovo Language Models"] = 483,
    ["Jujutsu (jj) VCS config"] = 1226,
    ["KIMMDY config file"] = 506,
    ["KODE/CI build.yaml"] = 1070,
    ["KSP-AVC"] = 939,
    ["KSP-CKAN"] = 940,
    ["KSP-NetKAN"] = 941,
    KSY = 1137,
    KSail = 387,
    ["KYA Manifest"] = 1138,
    ["Karakum configuration file"] = 384,
    Kas = 498,
    ["Kestra flow file"] = 507,
    ["Keycloak REST API"] = 1077,
    ["Knative Functions - func.yaml"] = 385,
    Knip = 386,
    ["Knowledge Unit"] = 515,
    ["Kometa (nightly) config file"] = 509,
    ["Kometa config file"] = 508,
    ["Kong DBLess config"] = 1071,
    KrakenD = 510,
    ["Kubri Configuration"] = 518,
    LOOBin = 533,
    ["Lake configuration file"] = 1229,
    ["Landing Zone Accelerator on AWS - Accounts Config"] = 274,
    ["Landing Zone Accelerator on AWS - Customizations Config"] = 275,
    ["Landing Zone Accelerator on AWS - Global Config"] = 276,
    ["Landing Zone Accelerator on AWS - IAM Config"] = 277,
    ["Landing Zone Accelerator on AWS - Network Config"] = 278,
    ["Landing Zone Accelerator on AWS - Organization Config"] = 279,
    ["Landing Zone Accelerator on AWS - Replacements Config"] = 280,
    ["Landing Zone Accelerator on AWS - Security Config"] = 281,
    ["Lando (landofile)"] = 111,
    ["LangGraph Platform configuration"] = 1149,
    ["Language configuration"] = 1148,
    Lefthook = 522,
    ["Liferay client-extension.yaml"] = 529,
    ["LinkML Metamodel"] = 531,
    Liquibase = 1015,
    ["Liquibase Flow File"] = 1016,
    ["Lively Properties"] = 532,
    ["Lobe AI Agent"] = 113,
    Loki = 114,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 575,
    ["MS2Rescore Configuration"] = 580,
    ["Madness (madness.yml)"] = 1088,
    ["Mado configuration"] = 539,
    ["Maestro Flow"] = 540,
    ["Mail Servers Configuration"] = 1261,
    ["MapEHR Mapping"] = 541,
    Markdownlint = 1019,
    ["Mason Registry"] = 1022,
    ["MegaLinter Custom Flavor"] = 544,
    ["MegaLinter configuration"] = 543,
    ["MegaLinter descriptor"] = 545,
    Melange = 1115,
    ["Meltano project definition"] = 546,
    ["Mergify Configuration"] = 581,
    ["Metadata for a Bazel module"] = 547,
    ["Metadata for a Cinnamon spice"] = 1165,
    ["Metatype Configuration"] = 548,
    ["MetricsHub Configuration"] = 549,
    ["MetricsHub Connector Configuration"] = 550,
    ["Micro Editor Syntax"] = 1098,
    ["Microsoft Band Web Tile"] = 551,
    ["Microsoft RulesEngine workflow rules"] = 1153,
    ["Microsoft RulesEngine workflow rules list"] = 1154,
    ["Minecraft Custom Main Menu Mod"] = 1116,
    ["Minecraft Data Pack Advancement"] = 553,
    ["Minecraft Data Pack Biome"] = 554,
    ["Minecraft Data Pack Configured Carver"] = 555,
    ["Minecraft Data Pack Damage Type"] = 556,
    ["Minecraft Data Pack Dimension"] = 558,
    ["Minecraft Data Pack Dimension Type"] = 557,
    ["Minecraft Data Pack Item Modifier"] = 559,
    ["Minecraft Data Pack Loot Table"] = 560,
    ["Minecraft Data Pack Metadata"] = 561,
    ["Minecraft Data Pack Predicate"] = 562,
    ["Minecraft Data Pack Recipe"] = 563,
    ["Minecraft Data Pack Tag"] = 564,
    ["Minecraft Data Pack Template Pool"] = 565,
    ["Minecraft Data Pack Trim Material"] = 570,
    ["Minecraft Data Pack Trim Pattern"] = 571,
    ["Minecraft Resource Pack Lang"] = 566,
    ["Minecraft Resource Pack Particle"] = 567,
    ["Minecraft Resource Pack Texture Mcmeta"] = 569,
    ["Minecraft Resourcepack Sounds"] = 568,
    ["MockServer Expectations"] = 577,
    ModuleAssembler = 573,
    ["Monade CLI Stack Configuration"] = 584,
    ["MongoDB Atlas Search Index Definition"] = 1069,
    ["Monika Configuration"] = 1067,
    ["Monoweave Configuration"] = 579,
    ["Motif config"] = 959,
    MultiQC = 1206,
    ["NOX Framework (Service)"] = 600,
    ["Netin Diagnostic System Template"] = 1026,
    ["Netlify config"] = 587,
    ["Network-as-Code Data Model"] = 588,
    ["Next Gen UI Agent A2A Server Configuration"] = 589,
    ["Next Gen UI Agent Configuration"] = 591,
    ["Next Gen UI Agent MCP Server Configuration"] = 590,
    ["Nightwatch.js"] = 593,
    ["Node.js configuration"] = 964,
    ["NueJS configuration file"] = 605,
    ["Nuitka.yaml"] = 1130,
    ["Nullstone config"] = 607,
    ["ONe's changelog entry"] = 626,
    ["ONe's service descriptor"] = 625,
    ["ORT Server repository environment configuration"] = 636,
    ["OSCAL Assessment Plan (AP)"] = 638,
    ["OSCAL Assessment Results (AR)"] = 639,
    ["OSCAL Catalog"] = 640,
    ["OSCAL Component Definition (CDef)"] = 641,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 642,
    ["OSCAL Profile"] = 643,
    ["OSCAL System Security Plan (SSP)"] = 644,
    ["OSS Review Toolkit configuration"] = 645,
    ["OSS Review Toolkit curation"] = 646,
    ["OSS Review Toolkit package configuration"] = 647,
    ["OSS Review Toolkit repository configuration"] = 648,
    ["OSS Review Toolkit resolutions"] = 649,
    ["October CMS columns"] = 611,
    ["October CMS fields"] = 612,
    ["Oh My Posh"] = 614,
    Okteto = 615,
    ["Ona Automations"] = 617,
    Opctl = 962,
    ["Open Data Contract Standard (ODCS)"] = 630,
    ["Open Data Product Standard (ODPS)"] = 631,
    ["Open Know-How"] = 1211,
    OpenDecree = 1274,
    ["OpenDecree Configuration"] = 1275,
    ["OpenRewrite Resource"] = 628,
    OpenSRM = 632,
    OpenStatus = 1222,
    ["OpenTelemetry Declarative Configuration"] = 629,
    ["OpenUtau character yaml"] = 622,
    ["OpenUtau ustx"] = 623,
    ["OpenWeather Current Weather API"] = 1005,
    ["OpenWeather Road Risk API"] = 1004,
    ["Ory Hydra configuration"] = 454,
    ["Ory Keto configuration"] = 514,
    ["Ory Kratos configuration"] = 637,
    ["Ory Oathkeeper configuration"] = 609,
    ["Outblocks App configuration"] = 634,
    ["Outblocks database table"] = 635,
    ["Outblocks project configuration"] = 633,
    PDM = 656,
    POPxf = 667,
    ["POPxf Correlations"] = 668,
    ["PRML manifest"] = 675,
    Packer = 653,
    PactSpec = 654,
    Pantsbuild = 1084,
    ["Paper paper-plugin.yml"] = 655,
    ["Pipeline component"] = 1017,
    ["Platform.sh application"] = 8,
    ["Platform.sh routes"] = 9,
    ["Platform.sh services"] = 10,
    ["Plex Prerolls"] = 665,
    ["PocketMine plugin.yml"] = 662,
    ["Postman collection"] = 671,
    ["Power Pages Configuration"] = 1223,
    ["Preset list for a WinUtil"] = 1168,
    ["ProActions AI-Kit Configuration"] = 683,
    ["ProActions AI-Kit Configuration for Menus"] = 685,
    ["ProActions AI-Kit Configuration for Sections"] = 687,
    ["ProActions AI-Kit Configuration for Services"] = 684,
    ["ProActions AI-Kit Configuration for Steps"] = 688,
    ["ProActions AI-Kit Configuration for Templates"] = 686,
    ["Problem object RFC9457"] = 1113,
    ["Problem package format"] = 689,
    ["Problem package generators"] = 690,
    ["Problem package submissions"] = 691,
    ["Problem package test group metadata"] = 692,
    Pterodactyl = 1063,
    ["Pull Request Labeler"] = 709,
    Pulumi = 717,
    ["PyGTA Config"] = 713,
    PyProject = 718,
    Pylock = 1214,
    Pyright = 719,
    ["Python script metadata"] = 1208,
    ["QType AI DSL"] = 722,
    Qgoda = 721,
    Qodana = 1036,
    ["Qt Creator workspace file"] = 1146,
    ["Quali Torque Blueprint Spec 2"] = 1061,
    ["QueryFirst config file"] = 1080,
    ["Qwen Code Settings"] = 1271,
    ["RKE Cluster Configuration JSON"] = 1014,
    ["RKE Cluster Configuration YAML"] = 1013,
    RadioHound = 712,
    ["Raid Profile"] = 1272,
    ["Raid Repo Configuration"] = 1273,
    Railpack = 724,
    Railway = 723,
    ["Rancher Fleet"] = 714,
    ["Rattler-build"] = 725,
    Ray = 976,
    ["Read the Docs"] = 716,
    ["Red-DiscordBot Cog"] = 732,
    ["Red-DiscordBot Cog Repo"] = 733,
    ["Red-DiscordBot Trivia"] = 734,
    ["Releasaurus Config"] = 5,
    ReleaseKit = 4,
    ["Render Blueprints"] = 1012,
    RenderCV = 751,
    Renovate = 748,
    ["Renovate global configuration"] = 749,
    ["Renovate inherited configuration"] = 750,
    ["Replit config"] = 740,
    Restate = 1201,
    ["Revel Digital Gadget Definition File"] = 1225,
    RoadRunner = 753,
    ["Robust Station Image"] = 1231,
    Rockcraft = 754,
    ["Roo Coder Custom Modes"] = 755,
    Rubocop = 744,
    ["Rudder techniques"] = 1120,
    Ruff = 745,
    ["Rust Project"] = 746,
    ["Rust toolchain"] = 760,
    ["SDMX data message"] = 787,
    ["SDMX metadata message"] = 786,
    ["SDMX structure message"] = 785,
    ["SIL Kit Participant Configuration"] = 797,
    ["SIL Kit Registry Configuration"] = 798,
    ["SPDX 2.3"] = 835,
    SWADL = 851,
    ["Safebox Config"] = 1075,
    ["Sapphire CLI Config"] = 763,
    ["SauceCTL Configuration"] = 1023,
    Scarb = 783,
    ["Schema Catalog"] = 778,
    ["Scoop manifest"] = 784,
    ["Semantic Data Fabric (SDF) file"] = 788,
    ["Semgrep Rule"] = 790,
    ["Serenity Code Generator (Sergen)"] = 791,
    ["Serverless Framework Configuration"] = 1030,
    ["Serverless Workflow"] = 1032,
    ["Settings for a Cinnamon spice"] = 1164,
    ["Settings.paf"] = 793,
    ["Shopware 6 Configuration"] = 1033,
    ["Shopware CLI Extension Store Configuration"] = 1034,
    ["Shopware CLI Project Store Configuration"] = 1035,
    ["Sigma Detection Rule"] = 795,
    ["Sigrid scope configuration file"] = 796,
    ["SkyPilot Task JSON"] = 1121,
    ["Slack app manifest"] = 800,
    Snapcraft = 802,
    Solidarity = 805,
    ["Solution filters"] = 806,
    ["Source Maps v3"] = 807,
    Sourcery = 808,
    ["Spack bootstrap.yaml"] = 809,
    ["Spack cdash.yaml"] = 810,
    ["Spack ci.yaml"] = 811,
    ["Spack compilers.yaml"] = 812,
    ["Spack concretizer.yaml"] = 813,
    ["Spack config.yaml"] = 814,
    ["Spack definitions.yaml"] = 815,
    ["Spack develop.yaml"] = 816,
    ["Spack env_vars.yaml"] = 817,
    ["Spack environment"] = 823,
    ["Spack include.yaml"] = 818,
    ["Spack mirrors.yaml"] = 819,
    ["Spack modules.yaml"] = 820,
    ["Spack packages.yaml"] = 821,
    ["Spack repos.yaml"] = 822,
    ["Spack toolchains.yaml"] = 824,
    ["Spack upstreams.yaml"] = 825,
    ["Spack view.yaml"] = 826,
    ["Speakeasy Generation Config File"] = 830,
    ["Speakeasy Lint Configuration File"] = 827,
    ["Speakeasy Test Generation Configuration File"] = 828,
    ["Speakeasy Workflow File"] = 829,
    SpecIF = 831,
    ["Specmatic Configuration"] = 832,
    ["Sponge Mixin configuration"] = 833,
    StackBlitz = 839,
    ["StackHawk Scanner Configuration"] = 1029,
    Stale = 840,
    Starfish = 841,
    ["Starlake Data Pipeline"] = 1002,
    Starship = 842,
    ["Statamic Blueprint"] = 843,
    ["Stella configuration file"] = 844,
    ["Streamlit configuration file"] = 845,
    ["Stryker Mutator"] = 848,
    ["StyleCop Analyzers Configuration"] = 849,
    ["Stylelint (.stylelintrc)"] = 850,
    ["Stylua Config"] = 1215,
    ["Sublime Syntax"] = 1076,
    ["Subsquid squid manifest"] = 1123,
    ["Swagger API 2.0"] = 852,
    ["Synadia Connect Component"] = 853,
    TSON = 889,
    TSTyche = 890,
    ["TYPO3 Vendor Bundler config"] = 896,
    ["Tab data for a LinUtil"] = 1171,
    ["Tab list for a LinUtil"] = 1170,
    Tach = 854,
    ["Tach Domain"] = 855,
    Talhelper = 857,
    ["Talisman configuration"] = 858,
    Taplo = 1216,
    ["Taskfile config"] = 1007,
    Taurus = 859,
    Tauticord = 860,
    ["Tekton Pipeline"] = 1244,
    ["Tekton PipelineRun"] = 1245,
    ["Tekton Task"] = 1242,
    ["Tekton TaskRun"] = 1243,
    Telefonistka = 1202,
    ["Terrateam config"] = 1228,
    ["TestEnvironment.json"] = 872,
    ["TextMate Grammar"] = 871,
    Threagile = 866,
    ["Tier.run pricing.json"] = 863,
    Tikibase = 864,
    Tombi = 869,
    ["Traefik v2"] = 875,
    ["Traefik v2 File Provider"] = 876,
    ["Traefik v3"] = 877,
    ["Traefik v3 File Provider"] = 878,
    ["Travis CI (.travis.yml)"] = 874,
    Treefmt = 432,
    Trident = 1198,
    ["TrueScript for *.tscript files"] = 881,
    ["Tugboat QA config.yml"] = 1195,
    TunnelHub = 1111,
    Turborepo = 873,
    Tycho = 1160,
    Tye = 1037,
    ["Tyk Gateway - Open Source v5.7+"] = 1207,
    ["UET BuildConfig.json"] = 1081,
    ["UI5 Manifest"] = 902,
    ["UNCORS configuration"] = 906,
    ["UTAM Page Object"] = 905,
    ["Ubuntu Server Autoinstall"] = 900,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1199,
    ["Uniswap Token List"] = 988,
    ["Universal Schedule Format"] = 907,
    ["Unreal Engine Uplugin"] = 1082,
    ["Unreal Engine Uproject"] = 1083,
    ["UpCloud CLI (upctl) configuration"] = 1200,
    ["Updatecli Compose"] = 1045,
    ["Updatecli Policy Manifest"] = 1046,
    ["Updatecli Policy Metadata"] = 1047,
    Uplift = 1079,
    ["Upsun config"] = 7,
    ["User Journey Map"] = 1011,
    V2Ray = 1051,
    ["VSCode Code Snippets"] = 257,
    ["VSIX CLI publishing"] = 925,
    Vector = 909,
    ["Vela Pipeline Configuration"] = 912,
    Vercel = 256,
    ["Version Bumper config"] = 915,
    Vespertide = 1249,
    ["Vespertide Migration"] = 1250,
    ["Vespertide Model"] = 1251,
    ["Viash Component Config"] = 1204,
    ["Viash Package Config"] = 1205,
    Visivo = 1109,
    ["WP-CLI"] = 935,
    Wake = 1197,
    ["Waku Config"] = 1174,
    ["Web App Manifest"] = 931,
    ["Web types"] = 934,
    WebExtensions = 930,
    ["Webman package recipe"] = 1057,
    ["Windows Package Manager Installer Manifest"] = 984,
    ["Windows Package Manager Locale Manifest"] = 985,
    ["Windows Package Manager Singleton Manifest"] = 983,
    Winutil = 986,
    ["WireMock CLI import configuration"] = 1180,
    ["WireMock CLI local service configuration"] = 1179,
    ["WireMock message stub mapping"] = 1178,
    ["WireMock stub mapping"] = 1177,
    ["Woodpecker pipeline config"] = 1025,
    ["Wrangler CLI"] = 936,
    ["XenForo add-on manifest"] = 937,
    ["Xstate Machine"] = 1043,
    ["Yandex Workflow Language"] = 1166,
    ["Yarn Config (.yarnrc.yml)"] = 1000,
    ["Yippee-Ki-JSON configuration YML"] = 991,
    ["YouTrack App"] = 1163,
    ["Zarf Package Configuration"] = 1230,
    ["Zerops import file"] = 1152,
    ["Zola Configuration"] = 1241,
    ["aerleon.yml"] = 20,
    ["amplify.yml"] = 13,
    ["angular.json"] = 37,
    apko = 1114,
    ...
    ["behat.yml"] = 144,
    ["bigquery-table"] = 133,
    ["bioimageio resource description"] = 1131,
    ...
    ["ccmod.json"] = 1175,
    changelogging = 1143,
    ["chisel-slices.json"] = 283,
    ["chrome-extension-locales-messages.json"] = 264,
    ["chutzpah.json"] = 265,
    cibuildwheel = 181,
    ["clang-format (.clang-format)"] = 1049,
    ["clang-tidy"] = 242,
    clangd = 241,
    clib = 243,
    ["cloud-init: cloud-config userdata"] = 245,
    ["cloud-sdk-pipeline-configuration"] = 267,
    ["cloudbuild.json"] = 268,
    cloudify = 244,
    cmakefmt = 199,
    ["cmdx.yaml"] = 97,
    ...
    ["coffeelint.json"] = 285,
    ["commands.json"] = 260,
    ["commitlint (.commitlintrc)"] = 987,
    ["committed.toml"] = 286,
    ["compile_commands.json"] = 259,
    ["compilerconfig.json"] = 258,
    ["completely.yml"] = 1087,
    ["component-detection-manifest.json"] = 289,
    ["component.json"] = 288,
    ["composer.json"] = 287,
    ["conda-forge"] = 185,
    ["config.yaml"] = 715,
    ["contentmanifest.json"] = 266,
    ["contribute.json"] = 290,
    ["cosmos.config.json"] = 262,
    ["crowdin.yml"] = 291,
    ["ctfd-setup configuration file"] = 1187,
    ["custom-elements.json"] = 1101,
    ["cypress.json"] = 295,
    ...
    ["ddev-global"] = 307,
    ["ddev-project"] = 308,
    ["debugsettings.json"] = 309,
    ["dependabot-v2.json"] = 312,
    ["dependabot.json"] = 311,
    ["deployed-cli"] = 1042,
    ["devcontainer.json"] = 250,
    devinit = 993,
    ["devspace.yaml"] = 1065,
    djlint = 994,
    ["docker bake"] = 318,
    ["docker sequencer"] = 319,
    ["docker-compose.yml"] = 992,
    ["dockerd.json"] = 316,
    ["dotnet Release Index manifest"] = 331,
    ["dotnet-tools.json"] = 332,
    ["dotnetcli.host.json"] = 333,
    ["dprint.json"] = 334,
    ["drone.json"] = 335,
    ["dss-2.0.0.json"] = 337,
    ["dstack configuration"] = 338,
    ["dtool dataset metadata"] = 1182,
    ["dvc.yaml"] = 339,
    ["ecosystem.json"] = 344,
    eksctl = 346,
    ["electron-builder configuration file"] = 354,
    ["epr-manifest.json"] = 353,
    ["estampo.toml"] = 352,
    ["evcc.yaml"] = 355,
    ["ezd task runner"] = 366,
    ["fabric.mod.json"] = 368,
    ["first-timers-bot"] = 376,
    ["flagd flag configuration"] = 119,
    ["fly.io Configuration"] = 120,
    fulibWorkflows = 1024,
    ["function.json"] = 388,
    ["gRPC API Gateway & OpenAPI Config"] = 15,
    ["gematik health care insurance list"] = 1193,
    ["gematik health care patient list"] = 1190,
    ["gematik health care provider institution list"] = 1192,
    ["gematik health care provider list"] = 1191,
    ["gematik tiger test environment configuration"] = 1194,
    ["git-town.toml"] = 1239,
    ["gitlab-ci"] = 407,
    ["global.json"] = 423,
    ["go-feature-flag Flag Configuration"] = 426,
    ["haxelib.json"] = 444,
    helmfile = 979,
    helmwave = 980,
    ["host-meta.json"] = 451,
    ...
    ["ide.host.json"] = 459,
    ["ifstate.yaml"] = 460,
    ["imageoptimizer.json"] = 461,
    ["importmap.json"] = 464,
    instant_python_config = 466,
    instant_python_custom_project = 467,
    ["ioBroker Configuration"] = 468,
    ["ioBroker JSON UI"] = 469,
    ["ioBroker Package manifest"] = 470,
    ["ixpect.conf.yaml"] = 471,
    ["ize.toml"] = 1078,
    ["jsconfig.json"] = 496,
    ["jscpd Configuration"] = 1062,
    jsdoc = 975,
    ["k3d.yaml"] = 497,
    ["k9s aliases.yaml"] = 499,
    ["k9s cluster-config.yaml"] = 501,
    ["k9s config.yaml"] = 500,
    ["k9s hotkeys.yaml"] = 502,
    ["k9s plugins.yaml"] = 503,
    ["k9s skin.yaml"] = 504,
    ["k9s views.yaml"] = 505,
    ["kontinuous-config.yaml"] = 517,
    ["kontinuous-values.yaml"] = 516,
    ["kustomization.yaml"] = 519,
    ["label-commenter-config.yml"] = 520,
    ["latexindent configuration"] = 112,
    ["launchsettings.json"] = 521,
    lazydocker = 1100,
    lazygit = 1099,
    ["lego.json"] = 523,
    ["lerna.json"] = 524,
    ["lgtm.yml"] = 525,
    ["liblab.config.json"] = 526,
    ["libman.json"] = 527,
    ["license-report-config.json"] = 528,
    ["linkinator.config.json"] = 530,
    ["lint-staged (.lintstagedrc)"] = 953,
    ["local.settings.json"] = 535,
    ["localazy.json"] = 536,
    ["lotus.yaml"] = 534,
    ["lsdlschema.json"] = 537,
    ["macro.json"] = 1066,
    ["markdown-link-check"] = 1020,
    maturin = 1021,
    mboats = 1028,
    memnex = 1278,
    ["micro-settings.json"] = 1093,
    ["mimetypes.json"] = 552,
    ["mirrord config"] = 955,
    mise = 956,
    ["mkdocs.yml"] = 572,
    ...
    ["monospace.yml"] = 578,
    ["moon.yml"] = 1176,
    ["mprocs Configuration file"] = 1147,
    ["mrdocs.yml"] = 574,
    ["mta.yaml"] = 957,
    ["mtad.yaml"] = 958,
    ["mycode.json"] = 585,
    nFPM = 592,
    ["napari plugin manifest"] = 586,
    neoload = 970,
    ["nest-cli"] = 595,
    ["nexus-rpc-gen"] = 1266,
    ["ninjs (News in JSON)"] = 594,
    ["nitro.json"] = 969,
    ["nixd configuration"] = 1119,
    ["nlu.json"] = 596,
    ["nodemon.json"] = 598,
    ["noodl config"] = 1027,
    ["notebook.mod.json"] = 599,
    now = 965,
    ["npm-badges"] = 602,
    ["nswag.json"] = 606,
    ntangle = 608,
    ["nuclei-template.yaml"] = 603,
    ["nuget-project.json"] = 604,
    ["ocelot.json"] = 610,
    ogen = 613,
    ["omnisharp.json"] = 616,
    openHAB = 1252,
    ...
    oxlint = 1263,
    ["package.json"] = 650,
    ["package.manifest"] = 652,
    ["package.yaml"] = 651,
    ["partial-black.json"] = 145,
    ["partial-fastapi.json"] = 146,
    ["partial-pixi.json"] = 660,
    ["partial-scheduled.json"] = 147,
    ["pattern.json"] = 658,
    ["petstore-v1.0"] = 1073,
    pgap_yaml_input_reader = 657,
    pgxgen = 1256,
    pitcms = 1259,
    ["pixi.toml"] = 659,
    ["plagiarize-me.yaml"] = 664,
    ["plagiarize.yaml"] = 663,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1183,
    ["podbard.yaml"] = 666,
    ["portman.json"] = 669,
    ["prefect.toml"] = 678,
    ["prefect.yaml"] = 679,
    ...
    ["prettierrc.json"] = 681,
    ["prisma.yml"] = 682,
    ["project-1.0.0-beta3.json"] = 694,
    ["project-1.0.0-beta4.json"] = 695,
    ["project-1.0.0-beta5.json"] = 696,
    ["project-1.0.0-beta6.json"] = 697,
    ["project-1.0.0-beta8.json"] = 698,
    ["project-1.0.0-rc1.json"] = 699,
    ["project-1.0.0-rc2.json"] = 700,
    ["project.json"] = 693,
    ["project.owasp.yaml"] = 701,
    ["prometheus-alertmanager.json"] = 705,
    ["prometheus.json"] = 702,
    ["prometheus.rules.json"] = 703,
    ["prometheus.rules.test.json"] = 704,
    ["proxies.json"] = 706,
    ["publiccode.yml"] = 707,
    ["pubspec.yaml"] = 708,
    ["pyrseas-0.8.json"] = 711,
    pytest = 720,
    ["quilt.mod.json"] = 1094,
    ["rc3 auth"] = 726,
    ["rc3 collection"] = 727,
    ...
    ["release drafter"] = 971,
    ["release-hub.json"] = 3,
    ["release-please-config.json"] = 736,
    ["release-please-manifest.json"] = 737,
    ["release-plz.toml"] = 738,
    ["renv.lock"] = 752,
    ["reposets Configuration"] = 741,
    ["reposets Credentials"] = 742,
    ["revola.json"] = 1,
    ["rivet.json"] = 1118,
    ["rivet.yaml (legacy)"] = 1117,
    rumdl = 757,
    runny = 756,
    rustfmt = 758,
    ryl = 759,
    ...
    samt = 761,
    samtrc = 762,
    ["sarif-1.0.0.json"] = 764,
    ["sarif-2.0.0.json"] = 765,
    ["sarif-2.1.0"] = 775,
    ["sarif-2.1.0-rtm.2"] = 766,
    ["sarif-2.1.0-rtm.3"] = 768,
    ["sarif-2.1.0-rtm.4"] = 770,
    ["sarif-2.1.0-rtm.5"] = 772,
    ["sarif-2.1.0-rtm.6"] = 773,
    ["sarif-external-property-file-2.1.0"] = 776,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 767,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 769,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 771,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 774,
    ["scalingo.json configuration"] = 777,
    ["schema.org - Action"] = 779,
    ["schema.org - ContactPoint"] = 780,
    ["schema.org - Place"] = 781,
    ["schema.org - Thing"] = 782,
    ["secrethub.yml"] = 1096,
    ["semantic-release"] = 789,
    ["servicehub.config.json"] = 948,
    ["servicehub.service.json"] = 947,
    ["settings.job"] = 792,
    ["sfdx-hardis configuration"] = 794,
    ["shard.yml"] = 1134,
    ["size-limit configuration"] = 799,
    ["skaffold.yaml"] = 1018,
    ["skyuxconfig.json"] = 801,
    ["snowflake-config"] = 803,
    ["snowflake-connections"] = 804,
    ["spicepod.yaml"] = 1155,
    ["sqlc configuration"] = 836,
    ["stripe-app-local.json"] = 847,
    ["stripe-app.json"] = 846,
    swcrc = 1003,
    ["task.json"] = 856,
    taskcat = 966,
    ["template.json"] = 861,
    ["templatsources.json"] = 862,
    ["text2confl config"] = 1264,
    ["theme.json"] = 865,
    ["tizen_workspace.json"] = 867,
    tldr = 868,
    ["tm_devices configuration file"] = 1221,
    tmuxinator = 951,
    tox = 870,
    ["transcend.yml"] = 879,
    ["tree-sitter grammar.json"] = 431,
    ["trime.yaml"] = 880,
    ["trunk.yaml"] = 882,
    ["ts-force-config.json"] = 887,
    ["tsconfig.json"] = 883,
    ["tsd.json"] = 884,
    ["tsdoc.json"] = 885,
    ["tsdrc.json"] = 886,
    ...
    v8r = 929,
    vcluster = 1141,
    ["vcpkg configuration file"] = 255,
    ["vcpkg manifest file"] = 254,
    ["vega-lite.json"] = 911,
    ["vega.json"] = 910,
    ["venvironment.yaml"] = 913,
    ["venvplus.yaml"] = 914,
    version = 1203,
    ["version.json"] = 916,
    ["vhwdebugger-binding.yaml"] = 918,
    ["vim-addon-info"] = 919,
    ["vs-2017.3.host.json"] = 921,
    ["vs-nesting.json"] = 922,
    ["vsls.json"] = 920,
    ["vss-extension.json"] = 926,
    vtcfg = 1209,
    ["vtesttree.yaml"] = 927,
    ["vtestunit.yaml"] = 928,
    ["warp-keysets.json"] = 1102,
    ["warp-themes.json"] = 1103,
    ["warp-workflows.json"] = 1104,
    ["webhint.io"] = 1058,
    ["webjobpublishsettings.json"] = 933,
    ["webjobs-list.json"] = 932,
    ["well-known-fursona"] = 1142,
    ["xs-app.json"] = 961,
    ["xunit.runner.json"] = 946,
    yamlfmt = 989,
    yamllint = 990,
    ["zerops.yml"] = 1151,
    zizmor = 1246,
