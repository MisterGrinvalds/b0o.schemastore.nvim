...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 958,
    [".nodehawkrc"] = 595,
    [".npmpackagejsonlintrc"] = 599,
    [".omletrc"] = 1138,
    [".phrase.yml"] = 674,
    [".phraseapp.yml"] = 675,
    [".pmbot.yml"] = 659,
    [".postcssrc"] = 668,
    [".powerpages-web-template-manifest"] = 670,
    [".pre-commit-config.yml"] = 671,
    [".pre-commit-hooks.yml"] = 672,
    [".putout.json"] = 708,
    [".rehyperc"] = 733,
    [".remarkrc"] = 737,
    [".sprite files"] = 832,
    ...
    [".vsconfig"] = 921,
    [".vsext"] = 922,
    ["1Password SSH Agent Config"] = 11,
    ["@factorial/drupal-breakpoints-css"] = 18,
    ["A micro editor config"] = 540,
    ABCClinicalDemandForecast = 27,
    ABCInventoryModuleData = 26,
    ABCSupplyPlan = 28,
    ["ACP Attempts"] = 29,
    ["ACP Cache File"] = 30,
    ["ACP Configuration File"] = 31,
    ["ACP Primer"] = 32,
    ["ACP Sync"] = 33,
    ["ACP Variables File"] = 34,
    AIConfig = 35,
    ["AMX Muse Program Descriptor"] = 1186,
    ["API Builder"] = 994,
    ["AVA Configuration"] = 1057,
    ["AWS AppConfig Feature Flags-v1"] = 69,
    ["AWS CDK cdk.json"] = 269,
    ["AWS CloudFormation"] = 270,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 271,
    ["AWS Copilot Manifest"] = 1225,
    ["AWS SAM CLI Samconfig"] = 272,
    Acton = 1275,
    ["Adobe UXP Manifest"] = 1120,
    ["Aerleon Network & Service Definitions"] = 21,
    ["Aerleon Policy"] = 22,
    ["Agent Permission Policy"] = 1265,
    ["AgentCore CLI"] = 1266,
    Aider = 1215,
    Air = 24,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1236,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1235,
    ["Airlock Microgateway"] = 36,
    ["Alacritty Configuration"] = 1029,
    ["All Contributors configuration file"] = 1083,
    ["Ansible Argument Specs"] = 411,
    ["Ansible Collection Galaxy"] = 418,
    ["Ansible Execution Environment"] = 408,
    ["Ansible Inventory"] = 417,
    ["Ansible Meta"] = 409,
    ["Ansible Meta Runtime"] = 410,
    ["Ansible Navigator Configuration"] = 420,
    ["Ansible Playbook"] = 415,
    ["Ansible Requirements"] = 412,
    ["Ansible Rulebook"] = 416,
    ["Ansible Tasks File"] = 414,
    ["Ansible Vars File"] = 413,
    ["Ansible-lint Configuration"] = 419,
    Any = 1148,
    ["AnyWork Automation Configuration"] = 17,
    ["Apollo Router"] = 995,
    ["App config Spotify Backstage"] = 40,
    ["Applicant Profile Protocol"] = 14,
    ["Application Accelerator"] = 12,
    ["Application list for a WinUtil"] = 1165,
    ArchitectFX = 1170,
    ["Argo CD"] = 55,
    ["Argo Events"] = 56,
    ["Argo Workflows"] = 57,
    AssemblyScript = 60,
    AsyncAPI = 63,
    ["AsyncAPI Tool File"] = 64,
    ["Atmos Manifests"] = 65,
    ["Aurora Agile Meta-Framework"] = 66,
    AutoAPICase = 1093,
    ["Avro Avsc"] = 67,
    ["Awesome Repositories"] = 68,
    ["Azure Container App template for defining an immutable revision"] = 71,
    ["Azure DevOps extension manifest"] = 74,
    ["Azure Device Update for IoT Hub import manifest"] = 72,
    ["Azure Device Update for IoT Hub update manifest"] = 73,
    ["Azure IoT Edge deployment"] = 77,
    ["Azure IoT Edge deployment template"] = 78,
    ["Azure IoT EdgeAgent deployment"] = 75,
    ["Azure IoT EdgeHub deployment"] = 76,
    ["Azure IoT Operations Wasm Graph Config"] = 1234,
    ["Azure IoT Operations connector metadata"] = 1231,
    ["Azure Landing Zones Library archetype definition"] = 82,
    ["Azure Landing Zones Library archetype override"] = 83,
    ["Azure Landing Zones Library architecture definition"] = 81,
    ["Azure Landing Zones Library metadata"] = 79,
    ["Azure Landing Zones Library policy default values"] = 80,
    ["Azure Pipelines"] = 115,
    ["Azure Static Web Apps CLI configuration file"] = 836,
    ["Azure Static Web Apps configuration file"] = 835,
    BMML = 1253,
    ["BOSH CPI Config"] = 141,
    ["BOSH Deploy Config"] = 142,
    ["BX CI"] = 163,
    ["Bacon config"] = 6,
    ["Barba-CV"] = 84,
    ["Bashly (bashly.yml)"] = 1087,
    ["Bashly Settings (bashly-settings.yml)"] = 1088,
    Bento = 1252,
    ["Better Code Hub"] = 999,
    ["Better Scripts"] = 164,
    Bigconfig = 134,
    ["Biome Formatter Config"] = 85,
    ["Bitmovin Encoding Template"] = 1179,
    BizTalkServerApplicationSchema = 965,
    Bleep = 165,
    ["Block Protocol Metadata"] = 162,
    ["Bluebricks blueprint config"] = 1258,
    ["Boyka Framework"] = 143,
    ["Bpod Finite-State Machine"] = 87,
    Briefcase = 971,
    ["Build Info"] = 153,
    Buildkite = 155,
    ["Bukkit plugin.yml"] = 154,
    ["BungeeCord plugin.yml"] = 160,
    ["Butane Config"] = 1042,
    C4InterFlow = 1194,
    ["CDK Environment Manager, concrete environment configuration"] = 1218,
    ["CDK Environment Manager, concrete environments definition"] = 1217,
    ["CDK Environment Manager, environment definition"] = 1216,
    ["CGS Card Game Specification (cgs.json)"] = 1125,
    ["CICS TS region tagging"] = 1051,
    ["CICS TS resource import"] = 1052,
    ["CICS TS resource model"] = 1053,
    ["CICS TS resource overrides"] = 1054,
    ["CMake Presets"] = 166,
    ["CNC Codes"] = 188,
    ["CRS WAF test file"] = 1155,
    ["CRS WAF test platform overrides file"] = 1156,
    ["CSS Comb (.csscomb.json)"] = 297,
    ["CSS Lint (.csslintrc)"] = 298,
    ["CSpell (cspell.json)"] = 296,
    ["CVE Record Format"] = 200,
    CWL = 1131,
    ["Cache Warmup config"] = 167,
    ["Calqulus pipeline"] = 168,
    ["Camel YAML DSL"] = 169,
    ["Cannon TOML"] = 170,
    Carafe = 171,
    ["Cargo Make"] = 173,
    ["Cargo Manifest"] = 172,
    ["Catalog Info Backstage"] = 174,
    ["Chamaleon environment"] = 1183,
    ["Chamaleon properties"] = 1184,
    ["Chamaleon template"] = 1182,
    Changepacks = 1245,
    Changesets = 281,
    Changie = 175,
    Charmcraft = 176,
    Cheatsheets = 1039,
    ["ChordPro Configuration"] = 177,
    ["Chrome Extension"] = 262,
    ["Chromia Model"] = 178,
    ["Chromia Seeder Module Config"] = 180,
    ["Chromia Seeder Root Config"] = 179,
    ["Cinnamon Spice info.json"] = 95,
    ["CircleCI config.yml"] = 237,
    ["Citation File Format"] = 283,
    ["Citrus test case"] = 182,
    CityJSON = 183,
    ["Claude Code Keybindings"] = 195,
    ["Claude Code Plugin Manifest"] = 196,
    ["Claude Code Plugin Marketplace"] = 197,
    ["Claude Code Settings"] = 198,
    ["Clawject config"] = 194,
    ["Cloud Foundry Application Manifest"] = 1137,
    ["Cloud Run Spec v1"] = 1160,
    ["Cloud.gov Workshop Configuration"] = 96,
    ["CloudCannon Configuration"] = 101,
    ["CloudCannon Configuration (Collection Structures)"] = 110,
    ["CloudCannon Configuration (Collections)"] = 109,
    ["CloudCannon Configuration (Editables)"] = 108,
    ["CloudCannon Configuration (Inputs)"] = 103,
    ["CloudCannon Configuration (Snippets Definitions)"] = 107,
    ["CloudCannon Configuration (Snippets Imports)"] = 106,
    ["CloudCannon Configuration (Snippets)"] = 105,
    ["CloudCannon Configuration (Structure Value)"] = 104,
    ["CloudCannon Configuration (Structures)"] = 102,
    ["CloudEvents specification"] = 184,
    ["Code Climate"] = 238,
    CodeCV = 99,
    CodeRabbit = 98,
    ["CodeShip Pro services configuration files"] = 251,
    ["CodeShip Pro steps configuration files"] = 252,
    ["Codecov configuration files"] = 250,
    Codex = 246,
    CodifyCLI = 100,
    Codux = 248,
    ["Cog config file"] = 189,
    ["Commandbox Box.json"] = 190,
    ["Commandbox Server.json"] = 191,
    ["Common Catalog Data"] = 260,
    ["Common Package Specification"] = 192,
    Concord = 1154,
    ["Configu .cfgu files"] = 1142,
    ["Configu .configu file"] = 1143,
    Conjure = 187,
    ["Container Structure Test"] = 979,
    Containerlab = 1008,
    ["Contextive Glossary"] = 1210,
    Convex = 186,
    ["Crowdsec collection config"] = 291,
    ["Crowdsec parser config"] = 292,
    ["Crowdsec scenario config"] = 293,
    ["CumulusCI Config"] = 193,
    ["Cursor Agent Environment"] = 1263,
    ["Custom Machinery Machine"] = 1126,
    ["Custom Machinery Recipe"] = 1127,
    ["Cycle Stack File"] = 201,
    CycloneDX = 202,
    ["DWP Exchange - catalogue entry"] = 342,
    ["DWP Exchange - gateway"] = 340,
    ["DWP Exchange - meta"] = 341,
    ["Dart Build Config (dart-build.json)"] = 299,
    ["Dart Test Config (dart-test.json)"] = 300,
    ["DashLord Configuration"] = 301,
    ["Data Contract Specification"] = 302,
    ["Data Product Specification"] = 303,
    ["DataYoga Connections"] = 203,
    ["DataYoga Job"] = 204,
    ["Datadog Continuous Testing"] = 509,
    ["Datadog Service Definition"] = 510,
    ["Datadog Software Catalog"] = 511,
    ["Datahub Ingestion Recipe"] = 1058,
    ["Debian Upstream Metadata file"] = 211,
    ["Deck config"] = 212,
    ["Declarative Automation Bundles"] = 1104,
    ["DeepMatch deeplinks spec"] = 213,
    ["Dein Config"] = 214,
    ["Deno Config (deno.json)"] = 309,
    ["Dependency cruiser"] = 215,
    ["DeployStack Configuration"] = 216,
    ["Deployah Configuration"] = 1233,
    ["Deployer Recipe"] = 312,
    ["Deta Spacefile"] = 217,
    ["Detekt Config (detekt.yml)"] = 313,
    ["Devbox Config"] = 218,
    ["Devbox Plugin"] = 219,
    Devfile = 339,
    Devup = 1246,
    DipDup = 1157,
    ["Discord Webhook"] = 314,
    ["DocFx Config (docfx.json)"] = 319,
    ["Docker Desktop extension metadata"] = 316,
    ["Docs MCP Manifest"] = 320,
    Dofigen = 321,
    ["Dolittle Artifacts"] = 322,
    ["Dolittle Bounded Context Configuration"] = 323,
    ["Dolittle Event Horizons Configuration"] = 324,
    ["Dolittle Resources Configuration"] = 325,
    ["Dolittle Server Configuration"] = 326,
    ["Dolittle Tenant Map Configuration"] = 328,
    ["Dolittle Tenants Configuration"] = 327,
    ["Dolittle Topology"] = 329,
    ["DonateCaseBetterCasino menu"] = 1187,
    ["Drupal Breakpoints"] = 220,
    ["Drupal Config"] = 232,
    ["Drupal Info"] = 221,
    ["Drupal Layouts"] = 222,
    ["Drupal Libraries"] = 223,
    ["Drupal Links Action"] = 224,
    ["Drupal Links Contextual"] = 225,
    ["Drupal Links Menu"] = 226,
    ["Drupal Links Task"] = 227,
    ["Drupal Migration"] = 228,
    ["Drupal Permissions"] = 229,
    ["Drupal Recipe"] = 230,
    ["Drupal Routing"] = 231,
    ["Drupal Services"] = 233,
    ["Drush site aliases"] = 335,
    ["Dynamic Bash Aliases (.aliases)"] = 1095,
    ["EAS config"] = 362,
    ["ECA - Editor Code Assistant"] = 344,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1084,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1230,
    ["EasyVCR .NET"] = 364,
    ["Eidolon Resource"] = 1171,
    ["Elgato Stream Deck"] = 346,
    Elm = 1159,
    ["Embrace Config"] = 1070,
    Endurica = 1108,
    ["Enterprise Contract Policy Spec"] = 347,
    ["Envelope Team Definition"] = 1274,
    ["Envilder Map File"] = 348,
    ["Erda Pipeline"] = 1133,
    ["Erda Runtime"] = 1134,
    ["Espanso config.yml"] = 1256,
    ["Espanso match.yml"] = 1255,
    Esquio = 350,
    ["Estuary Flow Catalog"] = 1048,
    ["Ethereum ERC1155"] = 1268,
    ["Ethereum ERC721"] = 1267,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 355,
    ["EveryVoice TTS Toolkit Data Configuration"] = 356,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 360,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 359,
    ["EveryVoice TTS Toolkit Text Configuration"] = 357,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 358,
    ["Evolving Resolutive Process notation"] = 1232,
    ["Expo SDK"] = 361,
    ["Expoot app config"] = 363,
    ["F-Droid Data metadata"] = 368,
    ["FasterCI Configuration"] = 116,
    ["Fence configuration"] = 117,
    FiQuS = 372,
    Firebase = 370,
    ["Flatpak Builder Manifest"] = 373,
    ["FlexGet Config"] = 374,
    ["Flow.json Configurations"] = 1130,
    ["Fossa configuration file"] = 381,
    ["Fossa's fossa-deps file"] = 382,
    ["Foundry VTT - Base package Manifest"] = 376,
    ["Foundry VTT - Module Manifest"] = 377,
    ["Foundry VTT - System Data Template"] = 380,
    ["Foundry VTT - System Manifest"] = 378,
    ["Foundry VTT - World Manifest"] = 379,
    ["Foxx Manifest"] = 118,
    ["Freifunk.de Community API"] = 121,
    ["Frogbot Config"] = 122,
    ["G2P Mapping Configuration"] = 388,
    ["GCP Blueprint Metadata"] = 391,
    Gaspar = 389,
    ["GatewayCore API Gateway"] = 390,
    ["Gemini CLI settings"] = 392,
    ["GeoJSON.json latest"] = 1046,
    GherKing = 1050,
    ["GitHub Action"] = 397,
    ["GitHub Actions typing"] = 1167,
    ["GitHub Discussion"] = 398,
    ["GitHub Funding"] = 399,
    ["GitHub Issue Template configuration"] = 400,
    ["GitHub Issue Template forms"] = 401,
    ["GitHub Workflow"] = 402,
    ["GitHub Workflow Template Properties"] = 403,
    ["GitHub automatically generated release notes configuration"] = 404,
    ["GitLab Agent for Kubernetes configuration"] = 1122,
    GitVersion = 394,
    ["Gitea Issue Template configuration"] = 395,
    ["Gitea Issue Template forms"] = 396,
    ["Gitpod Automations"] = 406,
    ["Gitpod Configuration"] = 407,
    ["GlazeWM settings"] = 1124,
    ["Global Privacy Control"] = 393,
    Goblet = 1103,
    ["Golangci-lint Configuration"] = 422,
    ["Golangci-lint Custom Plugins Configuration"] = 423,
    ["Google Chrome Related Website Sets"] = 371,
    ["Google Cloud Workflows"] = 268,
    ["Google Digital Assetlinks"] = 1211,
    Goreleaser = 425,
    ["Goreleaser Pro"] = 426,
    Goss = 427,
    ["Gradle Build Cache Node"] = 997,
    ["Gradle Enterprise"] = 996,
    ["Grafana 5.x Dashboard"] = 428,
    ["GraphQL Code Generator"] = 433,
    ["GraphQL Config"] = 432,
    ["GraphQL Mesh"] = 431,
    ["GroovyLint configuration"] = 434,
    ["Grunt JSHint task"] = 438,
    ["Grunt Watch task"] = 439,
    ["Grunt base task"] = 440,
    ["Grunt clean task"] = 436,
    ["Grunt copy task"] = 435,
    ["Grunt cssmin task"] = 437,
    HEMTT = 961,
    Hadolint = 975,
    Hammerkit = 1007,
    ["Hardware Sentry Configuration"] = 1062,
    ["Hashgraph Online Skill Manifest"] = 2,
    ["HashiCorp Vault"] = 441,
    Hatch = 976,
    Hayson = 443,
    ["Haystack Pipeline"] = 444,
    ["Hazelcast 5 Configuration"] = 445,
    ["Hecate Input Schema"] = 1222,
    ["Helm Chart.lock"] = 235,
    ["Helm Chart.yaml"] = 234,
    ["Helm Unittest Test Suite"] = 236,
    ["Home Assistant Integration Manifest"] = 446,
    ["Homer dashboard configuration"] = 447,
    Hugo = 1038,
    ["Hugo Theme"] = 1037,
    ["Hulak Configuration"] = 454,
    ["Hyperfoil benchmark configuration"] = 453,
    ["IBM Zapp document"] = 455,
    ["IBM zCodeFormatSettings"] = 456,
    ["IMG Catapult PSP"] = 461,
    ["IVMS101 by CODE Protocol"] = 1123,
    Infrahub = 463,
    Istanbul = 1066,
    ["JDownloader2 crawler multi-rules"] = 476,
    ["JDownloader2 crawler single-rules"] = 475,
    ["JFrog Applications Config"] = 477,
    ["JFrog File Spec"] = 478,
    ["JFrog Pipelines YML DSL"] = 1072,
    ["JMeter DSL cli config"] = 479,
    JReleaser = 482,
    ["JSON Document Transform"] = 490,
    ["JSON Feed"] = 491,
    ["JSON Resume"] = 745,
    ["JSON Schema Draft 2020-12"] = 943,
    ["JSON Schema Draft 4"] = 940,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1105,
    ["JSON Schema Draft 7"] = 941,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1106,
    ["JSON Schema Draft 8 (2019-09)"] = 942,
    ["JSON-API"] = 489,
    ["JSON-e templates"] = 1004,
    ["JSON-stat 2.0"] = 936,
    JSONPatch = 493,
    ["JSR Package Config (jsr.json)"] = 483,
    Jarl = 1238,
    Jasmine = 470,
    Jekyll = 471,
    ["Jenkins X Pipelines"] = 472,
    ["Jenkins X Requirements"] = 473,
    Jest = 474,
    Jocker = 480,
    ["Jovo Language Models"] = 481,
    ["Jujutsu (jj) VCS config"] = 1224,
    ["KIMMDY config file"] = 504,
    ["KODE/CI build.yaml"] = 1068,
    ["KSP-AVC"] = 937,
    ["KSP-CKAN"] = 938,
    ["KSP-NetKAN"] = 939,
    KSY = 1135,
    KSail = 386,
    ["KYA Manifest"] = 1136,
    ["Karakum configuration file"] = 383,
    Kas = 496,
    ["Kestra flow file"] = 505,
    ["Keycloak REST API"] = 1075,
    ["Knative Functions - func.yaml"] = 384,
    Knip = 385,
    ["Knowledge Unit"] = 513,
    ["Kometa (nightly) config file"] = 507,
    ["Kometa config file"] = 506,
    ["Kong DBLess config"] = 1069,
    KrakenD = 508,
    ["Kubri Configuration"] = 516,
    LOOBin = 531,
    ["Lake configuration file"] = 1227,
    ["Landing Zone Accelerator on AWS - Accounts Config"] = 273,
    ["Landing Zone Accelerator on AWS - Customizations Config"] = 274,
    ["Landing Zone Accelerator on AWS - Global Config"] = 275,
    ["Landing Zone Accelerator on AWS - IAM Config"] = 276,
    ["Landing Zone Accelerator on AWS - Network Config"] = 277,
    ["Landing Zone Accelerator on AWS - Organization Config"] = 278,
    ["Landing Zone Accelerator on AWS - Replacements Config"] = 279,
    ["Landing Zone Accelerator on AWS - Security Config"] = 280,
    ["Lando (landofile)"] = 111,
    ["LangGraph Platform configuration"] = 1147,
    ["Language configuration"] = 1146,
    Lefthook = 520,
    ["Liferay client-extension.yaml"] = 527,
    ["LinkML Metamodel"] = 529,
    Liquibase = 1013,
    ["Liquibase Flow File"] = 1014,
    ["Lively Properties"] = 530,
    ["Lobe AI Agent"] = 113,
    Loki = 114,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 573,
    ["MS2Rescore Configuration"] = 578,
    ["Madness (madness.yml)"] = 1086,
    ["Mado configuration"] = 537,
    ["Maestro Flow"] = 538,
    ["Mail Servers Configuration"] = 1259,
    ["MapEHR Mapping"] = 539,
    Markdownlint = 1017,
    ["Mason Registry"] = 1020,
    ["MegaLinter Custom Flavor"] = 542,
    ["MegaLinter configuration"] = 541,
    ["MegaLinter descriptor"] = 543,
    Melange = 1113,
    ["Meltano project definition"] = 544,
    ["Mergify Configuration"] = 579,
    ["Metadata for a Bazel module"] = 545,
    ["Metadata for a Cinnamon spice"] = 1163,
    ["Metatype Configuration"] = 546,
    ["MetricsHub Configuration"] = 547,
    ["MetricsHub Connector Configuration"] = 548,
    ["Micro Editor Syntax"] = 1096,
    ["Microsoft Band Web Tile"] = 549,
    ["Microsoft RulesEngine workflow rules"] = 1151,
    ["Microsoft RulesEngine workflow rules list"] = 1152,
    ["Minecraft Custom Main Menu Mod"] = 1114,
    ["Minecraft Data Pack Advancement"] = 551,
    ["Minecraft Data Pack Biome"] = 552,
    ["Minecraft Data Pack Configured Carver"] = 553,
    ["Minecraft Data Pack Damage Type"] = 554,
    ["Minecraft Data Pack Dimension"] = 556,
    ["Minecraft Data Pack Dimension Type"] = 555,
    ["Minecraft Data Pack Item Modifier"] = 557,
    ["Minecraft Data Pack Loot Table"] = 558,
    ["Minecraft Data Pack Metadata"] = 559,
    ["Minecraft Data Pack Predicate"] = 560,
    ["Minecraft Data Pack Recipe"] = 561,
    ["Minecraft Data Pack Tag"] = 562,
    ["Minecraft Data Pack Template Pool"] = 563,
    ["Minecraft Data Pack Trim Material"] = 568,
    ["Minecraft Data Pack Trim Pattern"] = 569,
    ["Minecraft Resource Pack Lang"] = 564,
    ["Minecraft Resource Pack Particle"] = 565,
    ["Minecraft Resource Pack Texture Mcmeta"] = 567,
    ["Minecraft Resourcepack Sounds"] = 566,
    ["MockServer Expectations"] = 575,
    ModuleAssembler = 571,
    ["Monade CLI Stack Configuration"] = 582,
    ["MongoDB Atlas Search Index Definition"] = 1067,
    ["Monika Configuration"] = 1065,
    ["Monoweave Configuration"] = 577,
    ["Motif config"] = 957,
    MultiQC = 1204,
    ["NOX Framework (Service)"] = 598,
    ["Netin Diagnostic System Template"] = 1024,
    ["Netlify config"] = 585,
    ["Network-as-Code Data Model"] = 586,
    ["Next Gen UI Agent A2A Server Configuration"] = 587,
    ["Next Gen UI Agent Configuration"] = 589,
    ["Next Gen UI Agent MCP Server Configuration"] = 588,
    ["Nightwatch.js"] = 591,
    ["Node.js configuration"] = 962,
    ["NueJS configuration file"] = 603,
    ["Nuitka.yaml"] = 1128,
    ["Nullstone config"] = 605,
    ["ONe's changelog entry"] = 624,
    ["ONe's service descriptor"] = 623,
    ["ORT Server repository environment configuration"] = 634,
    ["OSCAL Assessment Plan (AP)"] = 636,
    ["OSCAL Assessment Results (AR)"] = 637,
    ["OSCAL Catalog"] = 638,
    ["OSCAL Component Definition (CDef)"] = 639,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 640,
    ["OSCAL Profile"] = 641,
    ["OSCAL System Security Plan (SSP)"] = 642,
    ["OSS Review Toolkit configuration"] = 643,
    ["OSS Review Toolkit curation"] = 644,
    ["OSS Review Toolkit package configuration"] = 645,
    ["OSS Review Toolkit repository configuration"] = 646,
    ["OSS Review Toolkit resolutions"] = 647,
    ["October CMS columns"] = 609,
    ["October CMS fields"] = 610,
    ["Oh My Posh"] = 612,
    Okteto = 613,
    ["Ona Automations"] = 615,
    Opctl = 960,
    ["Open Data Contract Standard (ODCS)"] = 628,
    ["Open Data Product Standard (ODPS)"] = 629,
    ["Open Know-How"] = 1209,
    OpenDecree = 1272,
    ["OpenDecree Configuration"] = 1273,
    ["OpenRewrite Resource"] = 626,
    OpenSRM = 630,
    OpenStatus = 1220,
    ["OpenTelemetry Declarative Configuration"] = 627,
    ["OpenUtau character yaml"] = 620,
    ["OpenUtau ustx"] = 621,
    ["OpenWeather Current Weather API"] = 1003,
    ["OpenWeather Road Risk API"] = 1002,
    ["Ory Hydra configuration"] = 452,
    ["Ory Keto configuration"] = 512,
    ["Ory Kratos configuration"] = 635,
    ["Ory Oathkeeper configuration"] = 607,
    ["Outblocks App configuration"] = 632,
    ["Outblocks database table"] = 633,
    ["Outblocks project configuration"] = 631,
    PDM = 654,
    POPxf = 665,
    ["POPxf Correlations"] = 666,
    ["PRML manifest"] = 673,
    Packer = 651,
    PactSpec = 652,
    Pantsbuild = 1082,
    ["Paper paper-plugin.yml"] = 653,
    ["Pipeline component"] = 1015,
    ["Platform.sh application"] = 8,
    ["Platform.sh routes"] = 9,
    ["Platform.sh services"] = 10,
    ["Plex Prerolls"] = 663,
    ["PocketMine plugin.yml"] = 660,
    ["Postman collection"] = 669,
    ["Power Pages Configuration"] = 1221,
    ["Preset list for a WinUtil"] = 1166,
    ["ProActions AI-Kit Configuration"] = 681,
    ["ProActions AI-Kit Configuration for Menus"] = 683,
    ["ProActions AI-Kit Configuration for Sections"] = 685,
    ["ProActions AI-Kit Configuration for Services"] = 682,
    ["ProActions AI-Kit Configuration for Steps"] = 686,
    ["ProActions AI-Kit Configuration for Templates"] = 684,
    ["Problem object RFC9457"] = 1111,
    ["Problem package format"] = 687,
    ["Problem package generators"] = 688,
    ["Problem package submissions"] = 689,
    ["Problem package test group metadata"] = 690,
    Pterodactyl = 1061,
    ["Pull Request Labeler"] = 707,
    Pulumi = 715,
    ["PyGTA Config"] = 711,
    PyProject = 716,
    Pylock = 1212,
    Pyright = 717,
    ["Python script metadata"] = 1206,
    ["QType AI DSL"] = 720,
    Qgoda = 719,
    Qodana = 1034,
    ["Qt Creator workspace file"] = 1144,
    ["Quali Torque Blueprint Spec 2"] = 1059,
    ["QueryFirst config file"] = 1078,
    ["Qwen Code Settings"] = 1269,
    ["RKE Cluster Configuration JSON"] = 1012,
    ["RKE Cluster Configuration YAML"] = 1011,
    RadioHound = 710,
    ["Raid Profile"] = 1270,
    ["Raid Repo Configuration"] = 1271,
    Railpack = 722,
    Railway = 721,
    ["Rancher Fleet"] = 712,
    ["Rattler-build"] = 723,
    Ray = 974,
    ["Read the Docs"] = 714,
    ["Red-DiscordBot Cog"] = 730,
    ["Red-DiscordBot Cog Repo"] = 731,
    ["Red-DiscordBot Trivia"] = 732,
    ["Releasaurus Config"] = 5,
    ReleaseKit = 4,
    ["Render Blueprints"] = 1010,
    RenderCV = 749,
    Renovate = 746,
    ["Renovate global configuration"] = 747,
    ["Renovate inherited configuration"] = 748,
    ["Replit config"] = 738,
    Restate = 1199,
    ["Revel Digital Gadget Definition File"] = 1223,
    RoadRunner = 751,
    ["Robust Station Image"] = 1229,
    Rockcraft = 752,
    ["Roo Coder Custom Modes"] = 753,
    Rubocop = 742,
    ["Rudder techniques"] = 1118,
    Ruff = 743,
    ["Rust Project"] = 744,
    ["Rust toolchain"] = 758,
    ["SDMX data message"] = 785,
    ["SDMX metadata message"] = 784,
    ["SDMX structure message"] = 783,
    ["SIL Kit Participant Configuration"] = 795,
    ["SIL Kit Registry Configuration"] = 796,
    ["SPDX 2.3"] = 833,
    SWADL = 849,
    ["Safebox Config"] = 1073,
    ["Sapphire CLI Config"] = 761,
    ["SauceCTL Configuration"] = 1021,
    Scarb = 781,
    ["Schema Catalog"] = 776,
    ["Scoop manifest"] = 782,
    ["Semantic Data Fabric (SDF) file"] = 786,
    ["Semgrep Rule"] = 788,
    ["Serenity Code Generator (Sergen)"] = 789,
    ["Serverless Framework Configuration"] = 1028,
    ["Serverless Workflow"] = 1030,
    ["Settings for a Cinnamon spice"] = 1162,
    ["Settings.paf"] = 791,
    ["Shopware 6 Configuration"] = 1031,
    ["Shopware CLI Extension Store Configuration"] = 1032,
    ["Shopware CLI Project Store Configuration"] = 1033,
    ["Sigma Detection Rule"] = 793,
    ["Sigrid scope configuration file"] = 794,
    ["SkyPilot Task JSON"] = 1119,
    ["Slack app manifest"] = 798,
    Snapcraft = 800,
    Solidarity = 803,
    ["Solution filters"] = 804,
    ["Source Maps v3"] = 805,
    Sourcery = 806,
    ["Spack bootstrap.yaml"] = 807,
    ["Spack cdash.yaml"] = 808,
    ["Spack ci.yaml"] = 809,
    ["Spack compilers.yaml"] = 810,
    ["Spack concretizer.yaml"] = 811,
    ["Spack config.yaml"] = 812,
    ["Spack definitions.yaml"] = 813,
    ["Spack develop.yaml"] = 814,
    ["Spack env_vars.yaml"] = 815,
    ["Spack environment"] = 821,
    ["Spack include.yaml"] = 816,
    ["Spack mirrors.yaml"] = 817,
    ["Spack modules.yaml"] = 818,
    ["Spack packages.yaml"] = 819,
    ["Spack repos.yaml"] = 820,
    ["Spack toolchains.yaml"] = 822,
    ["Spack upstreams.yaml"] = 823,
    ["Spack view.yaml"] = 824,
    ["Speakeasy Generation Config File"] = 828,
    ["Speakeasy Lint Configuration File"] = 825,
    ["Speakeasy Test Generation Configuration File"] = 826,
    ["Speakeasy Workflow File"] = 827,
    SpecIF = 829,
    ["Specmatic Configuration"] = 830,
    ["Sponge Mixin configuration"] = 831,
    StackBlitz = 837,
    ["StackHawk Scanner Configuration"] = 1027,
    Stale = 838,
    Starfish = 839,
    ["Starlake Data Pipeline"] = 1000,
    Starship = 840,
    ["Statamic Blueprint"] = 841,
    ["Stella configuration file"] = 842,
    ["Streamlit configuration file"] = 843,
    ["Stryker Mutator"] = 846,
    ["StyleCop Analyzers Configuration"] = 847,
    ["Stylelint (.stylelintrc)"] = 848,
    ["Stylua Config"] = 1213,
    ["Sublime Syntax"] = 1074,
    ["Subsquid squid manifest"] = 1121,
    ["Swagger API 2.0"] = 850,
    ["Synadia Connect Component"] = 851,
    TSON = 887,
    TSTyche = 888,
    ["TYPO3 Vendor Bundler config"] = 894,
    ["Tab data for a LinUtil"] = 1169,
    ["Tab list for a LinUtil"] = 1168,
    Tach = 852,
    ["Tach Domain"] = 853,
    Talhelper = 855,
    ["Talisman configuration"] = 856,
    Taplo = 1214,
    ["Taskfile config"] = 1005,
    Taurus = 857,
    Tauticord = 858,
    ["Tekton Pipeline"] = 1242,
    ["Tekton PipelineRun"] = 1243,
    ["Tekton Task"] = 1240,
    ["Tekton TaskRun"] = 1241,
    Telefonistka = 1200,
    ["Terrateam config"] = 1226,
    ["TestEnvironment.json"] = 870,
    ["TextMate Grammar"] = 869,
    Threagile = 864,
    ["Tier.run pricing.json"] = 861,
    Tikibase = 862,
    Tombi = 867,
    ["Traefik v2"] = 873,
    ["Traefik v2 File Provider"] = 874,
    ["Traefik v3"] = 875,
    ["Traefik v3 File Provider"] = 876,
    ["Travis CI (.travis.yml)"] = 872,
    Treefmt = 430,
    Trident = 1196,
    ["TrueScript for *.tscript files"] = 879,
    ["Tugboat QA config.yml"] = 1193,
    TunnelHub = 1109,
    Turborepo = 871,
    Tycho = 1158,
    Tye = 1035,
    ["Tyk Gateway - Open Source v5.7+"] = 1205,
    ["UET BuildConfig.json"] = 1079,
    ["UI5 Manifest"] = 900,
    ["UNCORS configuration"] = 904,
    ["UTAM Page Object"] = 903,
    ["Ubuntu Server Autoinstall"] = 898,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1197,
    ["Uniswap Token List"] = 986,
    ["Universal Schedule Format"] = 905,
    ["Unreal Engine Uplugin"] = 1080,
    ["Unreal Engine Uproject"] = 1081,
    ["UpCloud CLI (upctl) configuration"] = 1198,
    ["Updatecli Compose"] = 1043,
    ["Updatecli Policy Manifest"] = 1044,
    ["Updatecli Policy Metadata"] = 1045,
    Uplift = 1077,
    ["Upsun config"] = 7,
    ["User Journey Map"] = 1009,
    V2Ray = 1049,
    ["VSCode Code Snippets"] = 256,
    ["VSIX CLI publishing"] = 923,
    Vector = 907,
    ["Vela Pipeline Configuration"] = 910,
    Vercel = 255,
    ["Version Bumper config"] = 913,
    Vespertide = 1247,
    ["Vespertide Migration"] = 1248,
    ["Vespertide Model"] = 1249,
    ["Viash Component Config"] = 1202,
    ["Viash Package Config"] = 1203,
    Visivo = 1107,
    ["WP-CLI"] = 933,
    Wake = 1195,
    ["Waku Config"] = 1172,
    ["Web App Manifest"] = 929,
    ["Web types"] = 932,
    WebExtensions = 928,
    ["Webman package recipe"] = 1055,
    ["Windows Package Manager Installer Manifest"] = 982,
    ["Windows Package Manager Locale Manifest"] = 983,
    ["Windows Package Manager Singleton Manifest"] = 981,
    Winutil = 984,
    ["WireMock CLI import configuration"] = 1178,
    ["WireMock CLI local service configuration"] = 1177,
    ["WireMock message stub mapping"] = 1176,
    ["WireMock stub mapping"] = 1175,
    ["Woodpecker pipeline config"] = 1023,
    ["Wrangler CLI"] = 934,
    ["XenForo add-on manifest"] = 935,
    ["Xstate Machine"] = 1041,
    ["Yandex Workflow Language"] = 1164,
    ["Yarn Config (.yarnrc.yml)"] = 998,
    ["Yippee-Ki-JSON configuration YML"] = 989,
    ["YouTrack App"] = 1161,
    ["Zarf Package Configuration"] = 1228,
    ["Zerops import file"] = 1150,
    ["Zola Configuration"] = 1239,
    ["aerleon.yml"] = 20,
    ["amplify.yml"] = 13,
    ["angular.json"] = 37,
    apko = 1112,
    ["app-definition.yaml"] = 41,
    ["apple-app-site-association"] = 39,
    ["appsettings.StormPetrel.json"] = 46,
    ["appsettings.json"] = 44,
    ["appsscript.json"] = 43,
    ["appveyor.yml"] = 45,
    ["aqua-generate-registry.yaml"] = 48,
    ["aqua-policy.yaml"] = 49,
    ["aqua.yaml"] = 47,
    ["arazzo.json"] = 51,
    ["arb.json"] = 52,
    ["arc.json"] = 54,
    ["architect.yml"] = 53,
    ["artifacthub-repo.yml"] = 58,
    ["asm-lsp"] = 59,
    ["ast-grep rules"] = 62,
    ["ast-grep sgconfig.yml"] = 61,
    ["azure.yaml"] = 70,
    ["babelrc.json"] = 124,
    ["bamboo-spec"] = 128,
    basedpyright = 126,
    ["bashly-strings.yml"] = 1089,
    ["batect.yml"] = 127,
    ["beef-database-codegen"] = 129,
    ["beef-database-v5-codegen"] = 131,
    ["beef-entity-codegen"] = 130,
    ["beef-entity-v5-codegen"] = 132,
    ["behat.yml"] = 144,
    ["bigquery-table"] = 133,
    ["bioimageio resource description"] = 1129,
    ["bitbucket-pipelines"] = 135,
    bitrise = 136,
    ["bitrise-step"] = 137,
    ["block.json"] = 161,
    ["bottom configuration"] = 86,
    ["bower.json"] = 139,
    ["bozr.suite.json"] = 148,
    bpkg = 1090,
    ["browser.i18n.json"] = 149,
    ["browsh configuration"] = 150,
    bucklescript = 151,
    ["buf.gen.yaml"] = 89,
    ["buf.lock"] = 90,
    ["buf.plugin.yaml"] = 91,
    ...
    ["build-changelog"] = 152,
    ["bun.lock"] = 157,
    ["bundleconfig.json"] = 158,
    ["bunfig.toml"] = 159,
    ["cargo-mutants-config.yaml"] = 94,
    ["ccmod.json"] = 1173,
    changelogging = 1141,
    ["chisel-slices.json"] = 282,
    ["chrome-extension-locales-messages.json"] = 263,
    ["chutzpah.json"] = 264,
    cibuildwheel = 181,
    ["clang-format (.clang-format)"] = 1047,
    ["clang-tidy"] = 242,
    clangd = 241,
    clib = 243,
    ["cloud-init: cloud-config userdata"] = 245,
    ["cloud-sdk-pipeline-configuration"] = 266,
    ["cloudbuild.json"] = 267,
    cloudify = 244,
    cmakefmt = 199,
    ["cmdx.yaml"] = 97,
    ...
    ["coffeelint.json"] = 284,
    ["commands.json"] = 259,
    ["commitlint (.commitlintrc)"] = 985,
    ["committed.toml"] = 285,
    ["compile_commands.json"] = 258,
    ["compilerconfig.json"] = 257,
    ["completely.yml"] = 1085,
    ["component-detection-manifest.json"] = 288,
    ["component.json"] = 287,
    ["composer.json"] = 286,
    ["conda-forge"] = 185,
    ["config.yaml"] = 713,
    ["contentmanifest.json"] = 265,
    ["contribute.json"] = 289,
    ["cosmos.config.json"] = 261,
    ["crowdin.yml"] = 290,
    ["ctfd-setup configuration file"] = 1185,
    ["custom-elements.json"] = 1099,
    ["cypress.json"] = 294,
    ["datalogic-scan2deploy-android"] = 304,
    ["datalogic-scan2deploy-ce"] = 305,
    ...
    ["ddev-global"] = 306,
    ["ddev-project"] = 307,
    ["debugsettings.json"] = 308,
    ["dependabot-v2.json"] = 311,
    ["dependabot.json"] = 310,
    ["deployed-cli"] = 1040,
    ["devcontainer.json"] = 249,
    devinit = 991,
    ["devspace.yaml"] = 1063,
    djlint = 992,
    ["docker bake"] = 317,
    ["docker sequencer"] = 318,
    ["docker-compose.yml"] = 990,
    ["dockerd.json"] = 315,
    ["dotnet Release Index manifest"] = 330,
    ["dotnet-tools.json"] = 331,
    ["dotnetcli.host.json"] = 332,
    ["dprint.json"] = 333,
    ["drone.json"] = 334,
    ["dss-2.0.0.json"] = 336,
    ["dstack configuration"] = 337,
    ["dtool dataset metadata"] = 1180,
    ["dvc.yaml"] = 338,
    ["ecosystem.json"] = 343,
    eksctl = 345,
    ["electron-builder configuration file"] = 353,
    ["epr-manifest.json"] = 352,
    ["estampo.toml"] = 351,
    ["evcc.yaml"] = 354,
    ["ezd task runner"] = 365,
    ["fabric.mod.json"] = 367,
    ["first-timers-bot"] = 375,
    ["flagd flag configuration"] = 119,
    ["fly.io Configuration"] = 120,
    fulibWorkflows = 1022,
    ["function.json"] = 387,
    ["gRPC API Gateway & OpenAPI Config"] = 15,
    ["gematik health care insurance list"] = 1191,
    ["gematik health care patient list"] = 1188,
    ["gematik health care provider institution list"] = 1190,
    ["gematik health care provider list"] = 1189,
    ["gematik tiger test environment configuration"] = 1192,
    ["git-town.toml"] = 1237,
    ["gitlab-ci"] = 405,
    ["global.json"] = 421,
    ["go-feature-flag Flag Configuration"] = 424,
    ["haxelib.json"] = 442,
    helmfile = 977,
    helmwave = 978,
    ["host-meta.json"] = 449,
    ...
    ["ide.host.json"] = 457,
    ["ifstate.yaml"] = 458,
    ["imageoptimizer.json"] = 459,
    ["importmap.json"] = 462,
    instant_python_config = 464,
    instant_python_custom_project = 465,
    ["ioBroker Configuration"] = 466,
    ["ioBroker JSON UI"] = 467,
    ["ioBroker Package manifest"] = 468,
    ["ixpect.conf.yaml"] = 469,
    ["ize.toml"] = 1076,
    ["jsconfig.json"] = 494,
    ["jscpd Configuration"] = 1060,
    jsdoc = 973,
    ["k3d.yaml"] = 495,
    ["k9s aliases.yaml"] = 497,
    ["k9s cluster-config.yaml"] = 499,
    ["k9s config.yaml"] = 498,
    ["k9s hotkeys.yaml"] = 500,
    ["k9s plugins.yaml"] = 501,
    ["k9s skin.yaml"] = 502,
    ["k9s views.yaml"] = 503,
    ["kontinuous-config.yaml"] = 515,
    ["kontinuous-values.yaml"] = 514,
    ["kustomization.yaml"] = 517,
    ["label-commenter-config.yml"] = 518,
    ["latexindent configuration"] = 112,
    ["launchsettings.json"] = 519,
    lazydocker = 1098,
    lazygit = 1097,
    ["lego.json"] = 521,
    ["lerna.json"] = 522,
    ["lgtm.yml"] = 523,
    ["liblab.config.json"] = 524,
    ["libman.json"] = 525,
    ["license-report-config.json"] = 526,
    ["linkinator.config.json"] = 528,
    ["lint-staged (.lintstagedrc)"] = 951,
    ["local.settings.json"] = 533,
    ["localazy.json"] = 534,
    ["lotus.yaml"] = 532,
    ["lsdlschema.json"] = 535,
    ["macro.json"] = 1064,
    ["markdown-link-check"] = 1018,
    maturin = 1019,
    mboats = 1026,
    memnex = 1276,
    ["micro-settings.json"] = 1091,
    ["mimetypes.json"] = 550,
    ["mirrord config"] = 953,
    mise = 954,
    ["mkdocs.yml"] = 570,
    ...
    ["monospace.yml"] = 576,
    ["moon.yml"] = 1174,
    ["mprocs Configuration file"] = 1145,
    ["mrdocs.yml"] = 572,
    ["mta.yaml"] = 955,
    ["mtad.yaml"] = 956,
    ["mycode.json"] = 583,
    nFPM = 590,
    ["napari plugin manifest"] = 584,
    neoload = 968,
    ["nest-cli"] = 593,
    ["nexus-rpc-gen"] = 1264,
    ["ninjs (News in JSON)"] = 592,
    ["nitro.json"] = 967,
    ["nixd configuration"] = 1117,
    ["nlu.json"] = 594,
    ["nodemon.json"] = 596,
    ["noodl config"] = 1025,
    ["notebook.mod.json"] = 597,
    now = 963,
    ["npm-badges"] = 600,
    ["nswag.json"] = 604,
    ntangle = 606,
    ["nuclei-template.yaml"] = 601,
    ["nuget-project.json"] = 602,
    ["ocelot.json"] = 608,
    ogen = 611,
    ["omnisharp.json"] = 614,
    openHAB = 1250,
    ...
    oxlint = 1261,
    ["package.json"] = 648,
    ["package.manifest"] = 650,
    ["package.yaml"] = 649,
    ["partial-black.json"] = 145,
    ["partial-fastapi.json"] = 146,
    ["partial-pixi.json"] = 658,
    ["partial-scheduled.json"] = 147,
    ["pattern.json"] = 656,
    ["petstore-v1.0"] = 1071,
    pgap_yaml_input_reader = 655,
    pgxgen = 1254,
    pitcms = 1257,
    ["pixi.toml"] = 657,
    ["plagiarize-me.yaml"] = 662,
    ["plagiarize.yaml"] = 661,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1181,
    ["podbard.yaml"] = 664,
    ["portman.json"] = 667,
    ["prefect.toml"] = 676,
    ["prefect.yaml"] = 677,
    ...
    ["prettierrc.json"] = 679,
    ["prisma.yml"] = 680,
    ["project-1.0.0-beta3.json"] = 692,
    ["project-1.0.0-beta4.json"] = 693,
    ["project-1.0.0-beta5.json"] = 694,
    ["project-1.0.0-beta6.json"] = 695,
    ["project-1.0.0-beta8.json"] = 696,
    ["project-1.0.0-rc1.json"] = 697,
    ["project-1.0.0-rc2.json"] = 698,
    ["project.json"] = 691,
    ["project.owasp.yaml"] = 699,
    ["prometheus-alertmanager.json"] = 703,
    ["prometheus.json"] = 700,
    ["prometheus.rules.json"] = 701,
    ["prometheus.rules.test.json"] = 702,
    ["proxies.json"] = 704,
    ["publiccode.yml"] = 705,
    ["pubspec.yaml"] = 706,
    ["pyrseas-0.8.json"] = 709,
    pytest = 718,
    ["quilt.mod.json"] = 1092,
    ["rc3 auth"] = 724,
    ["rc3 collection"] = 725,
    ...
    ["release drafter"] = 969,
    ["release-hub.json"] = 3,
    ["release-please-config.json"] = 734,
    ["release-please-manifest.json"] = 735,
    ["release-plz.toml"] = 736,
    ["renv.lock"] = 750,
    ["reposets Configuration"] = 739,
    ["reposets Credentials"] = 740,
    ["revola.json"] = 1,
    ["rivet.json"] = 1116,
    ["rivet.yaml (legacy)"] = 1115,
    rumdl = 755,
    runny = 754,
    rustfmt = 756,
    ryl = 757,
    ...
    samt = 759,
    samtrc = 760,
    ["sarif-1.0.0.json"] = 762,
    ["sarif-2.0.0.json"] = 763,
    ["sarif-2.1.0"] = 773,
    ["sarif-2.1.0-rtm.2"] = 764,
    ["sarif-2.1.0-rtm.3"] = 766,
    ["sarif-2.1.0-rtm.4"] = 768,
    ["sarif-2.1.0-rtm.5"] = 770,
    ["sarif-2.1.0-rtm.6"] = 771,
    ["sarif-external-property-file-2.1.0"] = 774,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 765,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 767,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 769,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 772,
    ["scalingo.json configuration"] = 775,
    ["schema.org - Action"] = 777,
    ["schema.org - ContactPoint"] = 778,
    ["schema.org - Place"] = 779,
    ["schema.org - Thing"] = 780,
    ["secrethub.yml"] = 1094,
    ["semantic-release"] = 787,
    ["servicehub.config.json"] = 946,
    ["servicehub.service.json"] = 945,
    ["settings.job"] = 790,
    ["sfdx-hardis configuration"] = 792,
    ["shard.yml"] = 1132,
    ["size-limit configuration"] = 797,
    ["skaffold.yaml"] = 1016,
    ["skyuxconfig.json"] = 799,
    ["snowflake-config"] = 801,
    ["snowflake-connections"] = 802,
    ["spicepod.yaml"] = 1153,
    ["sqlc configuration"] = 834,
    ["stripe-app-local.json"] = 845,
    ["stripe-app.json"] = 844,
    swcrc = 1001,
    ["task.json"] = 854,
    taskcat = 964,
    ["template.json"] = 859,
    ["templatsources.json"] = 860,
    ["text2confl config"] = 1262,
    ["theme.json"] = 863,
    ["tizen_workspace.json"] = 865,
    tldr = 866,
    ["tm_devices configuration file"] = 1219,
    tmuxinator = 949,
    tox = 868,
    ["transcend.yml"] = 877,
    ["tree-sitter grammar.json"] = 429,
    ["trime.yaml"] = 878,
    ["trunk.yaml"] = 880,
    ["ts-force-config.json"] = 885,
    ["tsconfig.json"] = 881,
    ["tsd.json"] = 882,
    ["tsdoc.json"] = 883,
    ["tsdrc.json"] = 884,
    ...
    v8r = 927,
    vcluster = 1139,
    ["vcpkg configuration file"] = 254,
    ["vcpkg manifest file"] = 253,
    ["vega-lite.json"] = 909,
    ["vega.json"] = 908,
    ["venvironment.yaml"] = 911,
    ["venvplus.yaml"] = 912,
    version = 1201,
    ["version.json"] = 914,
    ["vhwdebugger-binding.yaml"] = 916,
    ["vim-addon-info"] = 917,
    ["vs-2017.3.host.json"] = 919,
    ["vs-nesting.json"] = 920,
    ["vsls.json"] = 918,
    ["vss-extension.json"] = 924,
    vtcfg = 1207,
    ["vtesttree.yaml"] = 925,
    ["vtestunit.yaml"] = 926,
    ["warp-keysets.json"] = 1100,
    ["warp-themes.json"] = 1101,
    ["warp-workflows.json"] = 1102,
    ["webhint.io"] = 1056,
    ["webjobpublishsettings.json"] = 931,
    ["webjobs-list.json"] = 930,
    ["well-known-fursona"] = 1140,
    ["xs-app.json"] = 959,
    ["xunit.runner.json"] = 944,
    yamlfmt = 987,
    yamllint = 988,
    ["zerops.yml"] = 1149,
    zizmor = 1244,
