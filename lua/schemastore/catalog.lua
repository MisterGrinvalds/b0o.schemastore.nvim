...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 954,
    [".nodehawkrc"] = 592,
    [".npmpackagejsonlintrc"] = 596,
    [".omletrc"] = 1134,
    [".phrase.yml"] = 670,
    [".phraseapp.yml"] = 671,
    [".pmbot.yml"] = 656,
    [".postcssrc"] = 665,
    [".powerpages-web-template-manifest"] = 667,
    [".pre-commit-config.yml"] = 668,
    [".pre-commit-hooks.yml"] = 669,
    [".putout.json"] = 704,
    [".rehyperc"] = 729,
    [".remarkrc"] = 733,
    [".sprite files"] = 828,
    ...
    AIConfig = 35,
    ["AMX Muse Program Descriptor"] = 1182,
    ["API Builder"] = 990,
    ["AVA Configuration"] = 1053,
    ...
    Aider = 1211,
    Air = 24,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1232,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1231,
    ["Airlock Microgateway"] = 36,
    ["Alacritty Configuration"] = 1025,
    ["All Contributors configuration file"] = 1079,
    ["Ansible Argument Specs"] = 409,
    ["Ansible Collection Galaxy"] = 416,
    ["Ansible Execution Environment"] = 406,
    ["Ansible Inventory"] = 415,
    ["Ansible Meta"] = 407,
    ["Ansible Meta Runtime"] = 408,
    ["Ansible Navigator Configuration"] = 418,
    ["Ansible Playbook"] = 413,
    ["Ansible Requirements"] = 410,
    ["Ansible Rulebook"] = 414,
    ["Ansible Tasks File"] = 412,
    ["Ansible Vars File"] = 411,
    ["Ansible-lint Configuration"] = 417,
    Any = 1144,
    ...
    ["Application list for a WinUtil"] = 1161,
    ArchitectFX = 1166,
    ["Argo CD"] = 55,
    ["Argo Events"] = 56,
    ["Argo Workflows"] = 57,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1230,
    ["Azure IoT Operations connector metadata"] = 1227,
    ...
    ["Azure Pipelines"] = 115,
    ["Azure Static Web Apps CLI configuration file"] = 832,
    ["Azure Static Web Apps configuration file"] = 831,
    BMML = 1249,
    ["BOSH CPI Config"] = 141,
    ...
    ["Bacon config"] = 6,
    ["Barba-CV"] = 84,
    ["Bashly (bashly.yml)"] = 1083,
    ["Bashly Settings (bashly-settings.yml)"] = 1084,
    Bento = 1248,
    ["Better Code Hub"] = 995,
    ["Better Scripts"] = 163,
    Bigconfig = 134,
    ["Biome Formatter Config"] = 85,
    ["Bitmovin Encoding Template"] = 1175,
    BizTalkServerApplicationSchema = 961,
    Bleep = 164,
    ["Block Protocol Metadata"] = 161,
    ["Bluebricks blueprint config"] = 1254,
    ["Boyka Framework"] = 143,
    ...
    ["Butane Config"] = 1038,
    C4InterFlow = 1190,
    ["CDK Environment Manager, concrete environment configuration"] = 1214,
    ["CDK Environment Manager, concrete environments definition"] = 1213,
    ["CDK Environment Manager, environment definition"] = 1212,
    ["CGS Card Game Specification (cgs.json)"] = 1121,
    ["CICS TS region tagging"] = 1047,
    ["CICS TS resource import"] = 1048,
    ["CICS TS resource model"] = 1049,
    ["CICS TS resource overrides"] = 1050,
    ["CMake Presets"] = 165,
    ["CNC Codes"] = 187,
    ["CRS WAF test file"] = 1151,
    ["CRS WAF test platform overrides file"] = 1152,
    ...
    ["Chamaleon environment"] = 1179,
    ["Chamaleon properties"] = 1180,
    ["Chamaleon template"] = 1178,
    Changepacks = 1241,
    Changesets = 280,
    Changie = 174,
    Charmcraft = 175,
    ...
    ["Clawject config"] = 193,
    ["Cloud Foundry Application Manifest"] = 1133,
    ["Cloud Run Spec v1"] = 1156,
    ...
    Concord = 1150,
    ["Configu .cfgu files"] = 1138,
    ["Configu .configu file"] = 1139,
    Conjure = 186,
    ["Container Structure Test"] = 975,
    Containerlab = 1004,
    ["Contextive Glossary"] = 1206,
    Convex = 185,
    ["Crowdsec collection config"] = 290,
    ["Crowdsec parser config"] = 291,
    ["Crowdsec scenario config"] = 292,
    ["CumulusCI Config"] = 192,
    ["Cursor Agent Environment"] = 1259,
    ["Custom Machinery Machine"] = 1122,
    ["Custom Machinery Recipe"] = 1123,
    ...
    ["DataYoga Job"] = 203,
    ["Datadog Continuous Testing"] = 507,
    ["Datadog Service Definition"] = 508,
    ["Datadog Software Catalog"] = 509,
    ["Datahub Ingestion Recipe"] = 1054,
    ["Debian Upstream Metadata file"] = 210,
    ["Deck config"] = 211,
    ["Declarative Automation Bundles"] = 1100,
    ["DeepMatch deeplinks spec"] = 212,
    ["Dein Config"] = 213,
    ["Deno Config (deno.json)"] = 308,
    ["Dependency cruiser"] = 214,
    ["DeployStack Configuration"] = 215,
    ["Deployah Configuration"] = 1229,
    ["Deployer Recipe"] = 311,
    ["Deta Spacefile"] = 216,
    ...
    ["DonateCaseBetterCasino menu"] = 1183,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 1091,
    ["EAS config"] = 360,
    ["ECA - Editor Code Assistant"] = 343,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1080,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1226,
    ["EasyVCR .NET"] = 362,
    ["Eidolon Resource"] = 1167,
    ["Elgato Stream Deck"] = 345,
    Elm = 1155,
    ["Embrace Config"] = 1066,
    Endurica = 1104,
    ["Enterprise Contract Policy Spec"] = 346,
    ["Envelope Team Definition"] = 1269,
    ["Erda Pipeline"] = 1129,
    ["Erda Runtime"] = 1130,
    ["Espanso config.yml"] = 1252,
    ["Espanso match.yml"] = 1251,
    Esquio = 348,
    ["Estuary Flow Catalog"] = 1044,
    ["Ethereum ERC1155"] = 1263,
    ["Ethereum ERC721"] = 1262,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 353,
    ["EveryVoice TTS Toolkit Data Configuration"] = 354,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 358,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 357,
    ["EveryVoice TTS Toolkit Text Configuration"] = 355,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 356,
    ["Evolving Resolutive Process notation"] = 1228,
    ["Expo SDK"] = 359,
    ["Expoot app config"] = 361,
    ["F-Droid Data metadata"] = 366,
    ["FasterCI Configuration"] = 116,
    ["Fence configuration"] = 117,
    FiQuS = 370,
    Firebase = 368,
    ["Flatpak Builder Manifest"] = 371,
    ["FlexGet Config"] = 372,
    ["Flow.json Configurations"] = 1126,
    ["Fossa configuration file"] = 379,
    ["Fossa's fossa-deps file"] = 380,
    ["Foundry VTT - Base package Manifest"] = 374,
    ["Foundry VTT - Module Manifest"] = 375,
    ["Foundry VTT - System Data Template"] = 378,
    ["Foundry VTT - System Manifest"] = 376,
    ["Foundry VTT - World Manifest"] = 377,
    ["Foxx Manifest"] = 118,
    ["Freifunk.de Community API"] = 121,
    ["Frogbot Config"] = 122,
    ["G2P Mapping Configuration"] = 386,
    ["GCP Blueprint Metadata"] = 389,
    Gaspar = 387,
    ["GatewayCore API Gateway"] = 388,
    ["Gemini CLI settings"] = 390,
    ["GeoJSON.json latest"] = 1042,
    GherKing = 1046,
    ["GitHub Action"] = 395,
    ["GitHub Actions typing"] = 1163,
    ["GitHub Discussion"] = 396,
    ["GitHub Funding"] = 397,
    ["GitHub Issue Template configuration"] = 398,
    ["GitHub Issue Template forms"] = 399,
    ["GitHub Workflow"] = 400,
    ["GitHub Workflow Template Properties"] = 401,
    ["GitHub automatically generated release notes configuration"] = 402,
    ["GitLab Agent for Kubernetes configuration"] = 1118,
    GitVersion = 392,
    ["Gitea Issue Template configuration"] = 393,
    ["Gitea Issue Template forms"] = 394,
    ["Gitpod Automations"] = 404,
    ["Gitpod Configuration"] = 405,
    ["GlazeWM settings"] = 1120,
    ["Global Privacy Control"] = 391,
    Goblet = 1099,
    ["Golangci-lint Configuration"] = 420,
    ["Golangci-lint Custom Plugins Configuration"] = 421,
    ["Google Chrome Related Website Sets"] = 369,
    ["Google Cloud Workflows"] = 267,
    ["Google Digital Assetlinks"] = 1207,
    Goreleaser = 423,
    ["Goreleaser Pro"] = 424,
    Goss = 425,
    ["Gradle Build Cache Node"] = 993,
    ["Gradle Enterprise"] = 992,
    ["Grafana 5.x Dashboard"] = 426,
    ["GraphQL Code Generator"] = 431,
    ["GraphQL Config"] = 430,
    ["GraphQL Mesh"] = 429,
    ["GroovyLint configuration"] = 432,
    ["Grunt JSHint task"] = 436,
    ["Grunt Watch task"] = 437,
    ["Grunt base task"] = 438,
    ["Grunt clean task"] = 434,
    ["Grunt copy task"] = 433,
    ["Grunt cssmin task"] = 435,
    HEMTT = 957,
    Hadolint = 971,
    Hammerkit = 1003,
    ["Hardware Sentry Configuration"] = 1058,
    ["Hashgraph Online Skill Manifest"] = 2,
    ["HashiCorp Vault"] = 439,
    Hatch = 972,
    Hayson = 441,
    ["Haystack Pipeline"] = 442,
    ["Hazelcast 5 Configuration"] = 443,
    ["Hecate Input Schema"] = 1218,
    ["Helm Chart.lock"] = 234,
    ["Helm Chart.yaml"] = 233,
    ["Helm Unittest Test Suite"] = 235,
    ["Home Assistant Integration Manifest"] = 444,
    ["Homer dashboard configuration"] = 445,
    Hugo = 1034,
    ["Hugo Theme"] = 1033,
    ["Hulak Configuration"] = 452,
    ["Hyperfoil benchmark configuration"] = 451,
    ["IBM Zapp document"] = 453,
    ["IBM zCodeFormatSettings"] = 454,
    ["IMG Catapult PSP"] = 459,
    ["IVMS101 by CODE Protocol"] = 1119,
    Infrahub = 461,
    Istanbul = 1062,
    ["JDownloader2 crawler multi-rules"] = 474,
    ["JDownloader2 crawler single-rules"] = 473,
    ["JFrog Applications Config"] = 475,
    ["JFrog File Spec"] = 476,
    ["JFrog Pipelines YML DSL"] = 1068,
    ["JMeter DSL cli config"] = 477,
    JReleaser = 480,
    ["JSON Document Transform"] = 488,
    ["JSON Feed"] = 489,
    ["JSON Resume"] = 741,
    ["JSON Schema Draft 2020-12"] = 939,
    ["JSON Schema Draft 4"] = 936,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1101,
    ["JSON Schema Draft 7"] = 937,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1102,
    ["JSON Schema Draft 8 (2019-09)"] = 938,
    ["JSON-API"] = 487,
    ["JSON-e templates"] = 1000,
    ["JSON-stat 2.0"] = 932,
    JSONPatch = 491,
    ["JSR Package Config (jsr.json)"] = 481,
    Jarl = 1234,
    Jasmine = 468,
    Jekyll = 469,
    ["Jenkins X Pipelines"] = 470,
    ["Jenkins X Requirements"] = 471,
    Jest = 472,
    Jocker = 478,
    ["Jovo Language Models"] = 479,
    ["Jujutsu (jj) VCS config"] = 1220,
    ["KIMMDY config file"] = 502,
    ["KODE/CI build.yaml"] = 1064,
    ["KSP-AVC"] = 933,
    ["KSP-CKAN"] = 934,
    ["KSP-NetKAN"] = 935,
    KSY = 1131,
    KSail = 384,
    ["KYA Manifest"] = 1132,
    ["Karakum configuration file"] = 381,
    Kas = 494,
    ["Kestra flow file"] = 503,
    ["Keycloak REST API"] = 1071,
    ["Knative Functions - func.yaml"] = 382,
    Knip = 383,
    ["Knowledge Unit"] = 511,
    ["Kometa (nightly) config file"] = 505,
    ["Kometa config file"] = 504,
    ["Kong DBLess config"] = 1065,
    KrakenD = 506,
    ["Kubri Configuration"] = 514,
    LOOBin = 529,
    ["Lake configuration file"] = 1223,
    ...
    ["Lando (landofile)"] = 111,
    ["LangGraph Platform configuration"] = 1143,
    ["Language configuration"] = 1142,
    Lefthook = 518,
    ["Liferay client-extension.yaml"] = 525,
    ["LinkML Metamodel"] = 527,
    Liquibase = 1009,
    ["Liquibase Flow File"] = 1010,
    ["Lively Properties"] = 528,
    ["Lobe AI Agent"] = 113,
    Loki = 114,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 571,
    ["MS2Rescore Configuration"] = 575,
    ["Madness (madness.yml)"] = 1082,
    ["Mado configuration"] = 535,
    ["Maestro Flow"] = 536,
    ["Mail Servers Configuration"] = 1255,
    ["MapEHR Mapping"] = 537,
    Markdownlint = 1013,
    ["Mason Registry"] = 1016,
    ["MegaLinter Custom Flavor"] = 540,
    ["MegaLinter configuration"] = 539,
    ["MegaLinter descriptor"] = 541,
    Melange = 1109,
    ["Meltano project definition"] = 542,
    ["Mergify Configuration"] = 576,
    ["Metadata for a Bazel module"] = 543,
    ["Metadata for a Cinnamon spice"] = 1159,
    ["Metatype Configuration"] = 544,
    ["MetricsHub Configuration"] = 545,
    ["MetricsHub Connector Configuration"] = 546,
    ["Micro Editor Syntax"] = 1092,
    ["Microsoft Band Web Tile"] = 547,
    ["Microsoft RulesEngine workflow rules"] = 1147,
    ["Microsoft RulesEngine workflow rules list"] = 1148,
    ["Minecraft Custom Main Menu Mod"] = 1110,
    ["Minecraft Data Pack Advancement"] = 549,
    ["Minecraft Data Pack Biome"] = 550,
    ["Minecraft Data Pack Configured Carver"] = 551,
    ["Minecraft Data Pack Damage Type"] = 552,
    ["Minecraft Data Pack Dimension"] = 554,
    ["Minecraft Data Pack Dimension Type"] = 553,
    ["Minecraft Data Pack Item Modifier"] = 555,
    ["Minecraft Data Pack Loot Table"] = 556,
    ["Minecraft Data Pack Metadata"] = 557,
    ["Minecraft Data Pack Predicate"] = 558,
    ["Minecraft Data Pack Recipe"] = 559,
    ["Minecraft Data Pack Tag"] = 560,
    ["Minecraft Data Pack Template Pool"] = 561,
    ["Minecraft Data Pack Trim Material"] = 566,
    ["Minecraft Data Pack Trim Pattern"] = 567,
    ["Minecraft Resource Pack Lang"] = 562,
    ["Minecraft Resource Pack Particle"] = 563,
    ["Minecraft Resource Pack Texture Mcmeta"] = 565,
    ["Minecraft Resourcepack Sounds"] = 564,
    ModuleAssembler = 569,
    ["Monade CLI Stack Configuration"] = 579,
    ["MongoDB Atlas Search Index Definition"] = 1063,
    ["Monika Configuration"] = 1061,
    ["Monoweave Configuration"] = 574,
    ["Motif config"] = 953,
    MultiQC = 1200,
    ["NOX Framework (Service)"] = 595,
    ["Netin Diagnostic System Template"] = 1020,
    ["Netlify config"] = 582,
    ["Network-as-Code Data Model"] = 583,
    ["Next Gen UI Agent A2A Server Configuration"] = 584,
    ["Next Gen UI Agent Configuration"] = 586,
    ["Next Gen UI Agent MCP Server Configuration"] = 585,
    ["Nightwatch.js"] = 588,
    ["Node.js configuration"] = 958,
    ["NueJS configuration file"] = 600,
    ["Nuitka.yaml"] = 1124,
    ["Nullstone config"] = 602,
    ["ONe's changelog entry"] = 621,
    ["ONe's service descriptor"] = 620,
    ["ORT Server repository environment configuration"] = 631,
    ["OSCAL Assessment Plan (AP)"] = 633,
    ["OSCAL Assessment Results (AR)"] = 634,
    ["OSCAL Catalog"] = 635,
    ["OSCAL Component Definition (CDef)"] = 636,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 637,
    ["OSCAL Profile"] = 638,
    ["OSCAL System Security Plan (SSP)"] = 639,
    ["OSS Review Toolkit configuration"] = 640,
    ["OSS Review Toolkit curation"] = 641,
    ["OSS Review Toolkit package configuration"] = 642,
    ["OSS Review Toolkit repository configuration"] = 643,
    ["OSS Review Toolkit resolutions"] = 644,
    ["October CMS columns"] = 606,
    ["October CMS fields"] = 607,
    ["Oh My Posh"] = 609,
    Okteto = 610,
    ["Ona Automations"] = 612,
    Opctl = 956,
    ["Open Data Contract Standard (ODCS)"] = 625,
    ["Open Data Product Standard (ODPS)"] = 626,
    ["Open Know-How"] = 1205,
    OpenDecree = 1267,
    ["OpenDecree Configuration"] = 1268,
    ["OpenRewrite Resource"] = 623,
    OpenSRM = 627,
    OpenStatus = 1216,
    ["OpenTelemetry Declarative Configuration"] = 624,
    ["OpenUtau character yaml"] = 617,
    ["OpenUtau ustx"] = 618,
    ["OpenWeather Current Weather API"] = 999,
    ["OpenWeather Road Risk API"] = 998,
    ["Ory Hydra configuration"] = 450,
    ["Ory Keto configuration"] = 510,
    ["Ory Kratos configuration"] = 632,
    ["Ory Oathkeeper configuration"] = 604,
    ["Outblocks App configuration"] = 629,
    ["Outblocks database table"] = 630,
    ["Outblocks project configuration"] = 628,
    PDM = 651,
    POPxf = 662,
    ["POPxf Correlations"] = 663,
    Packer = 648,
    PactSpec = 649,
    Pantsbuild = 1078,
    ["Paper paper-plugin.yml"] = 650,
    ["Pipeline component"] = 1011,
    ["Platform.sh application"] = 8,
    ["Platform.sh routes"] = 9,
    ["Platform.sh services"] = 10,
    ["Plex Prerolls"] = 660,
    ["PocketMine plugin.yml"] = 657,
    ["Postman collection"] = 666,
    ["Power Pages Configuration"] = 1217,
    ["Preset list for a WinUtil"] = 1162,
    ["ProActions AI-Kit Configuration"] = 677,
    ["ProActions AI-Kit Configuration for Menus"] = 679,
    ["ProActions AI-Kit Configuration for Sections"] = 681,
    ["ProActions AI-Kit Configuration for Services"] = 678,
    ["ProActions AI-Kit Configuration for Steps"] = 682,
    ["ProActions AI-Kit Configuration for Templates"] = 680,
    ["Problem object RFC9457"] = 1107,
    ["Problem package format"] = 683,
    ["Problem package generators"] = 684,
    ["Problem package submissions"] = 685,
    ["Problem package test group metadata"] = 686,
    Pterodactyl = 1057,
    ["Pull Request Labeler"] = 703,
    Pulumi = 711,
    ["PyGTA Config"] = 707,
    PyProject = 712,
    Pylock = 1208,
    Pyright = 713,
    ["Python script metadata"] = 1202,
    ["QType AI DSL"] = 716,
    Qgoda = 715,
    Qodana = 1030,
    ["Qt Creator workspace file"] = 1140,
    ["Quali Torque Blueprint Spec 2"] = 1055,
    ["QueryFirst config file"] = 1074,
    ["Qwen Code Settings"] = 1264,
    ["RKE Cluster Configuration JSON"] = 1008,
    ["RKE Cluster Configuration YAML"] = 1007,
    RadioHound = 706,
    ["Raid Profile"] = 1265,
    ["Raid Repo Configuration"] = 1266,
    Railpack = 718,
    Railway = 717,
    ["Rancher Fleet"] = 708,
    ["Rattler-build"] = 719,
    Ray = 970,
    ["Read the Docs"] = 710,
    ["Red-DiscordBot Cog"] = 726,
    ["Red-DiscordBot Cog Repo"] = 727,
    ["Red-DiscordBot Trivia"] = 728,
    ["Releasaurus Config"] = 5,
    ReleaseKit = 4,
    ["Render Blueprints"] = 1006,
    RenderCV = 745,
    Renovate = 742,
    ["Renovate global configuration"] = 743,
    ["Renovate inherited configuration"] = 744,
    ["Replit config"] = 734,
    Restate = 1195,
    ["Revel Digital Gadget Definition File"] = 1219,
    RoadRunner = 747,
    ["Robust Station Image"] = 1225,
    Rockcraft = 748,
    ["Roo Coder Custom Modes"] = 749,
    Rubocop = 738,
    ["Rudder techniques"] = 1114,
    Ruff = 739,
    ["Rust Project"] = 740,
    ["Rust toolchain"] = 754,
    ["SDMX data message"] = 781,
    ["SDMX metadata message"] = 780,
    ["SDMX structure message"] = 779,
    ["SIL Kit Participant Configuration"] = 791,
    ["SIL Kit Registry Configuration"] = 792,
    ["SPDX 2.3"] = 829,
    SWADL = 845,
    ["Safebox Config"] = 1069,
    ["Sapphire CLI Config"] = 757,
    ["SauceCTL Configuration"] = 1017,
    Scarb = 777,
    ["Schema Catalog"] = 772,
    ["Scoop manifest"] = 778,
    ["Semantic Data Fabric (SDF) file"] = 782,
    ["Semgrep Rule"] = 784,
    ["Serenity Code Generator (Sergen)"] = 785,
    ["Serverless Framework Configuration"] = 1024,
    ["Serverless Workflow"] = 1026,
    ["Settings for a Cinnamon spice"] = 1158,
    ["Settings.paf"] = 787,
    ["Shopware 6 Configuration"] = 1027,
    ["Shopware CLI Extension Store Configuration"] = 1028,
    ["Shopware CLI Project Store Configuration"] = 1029,
    ["Sigma Detection Rule"] = 789,
    ["Sigrid scope configuration file"] = 790,
    ["SkyPilot Task JSON"] = 1115,
    ["Slack app manifest"] = 794,
    Snapcraft = 796,
    Solidarity = 799,
    ["Solution filters"] = 800,
    ["Source Maps v3"] = 801,
    Sourcery = 802,
    ["Spack bootstrap.yaml"] = 803,
    ["Spack cdash.yaml"] = 804,
    ["Spack ci.yaml"] = 805,
    ["Spack compilers.yaml"] = 806,
    ["Spack concretizer.yaml"] = 807,
    ["Spack config.yaml"] = 808,
    ["Spack definitions.yaml"] = 809,
    ["Spack develop.yaml"] = 810,
    ["Spack env_vars.yaml"] = 811,
    ["Spack environment"] = 817,
    ["Spack include.yaml"] = 812,
    ["Spack mirrors.yaml"] = 813,
    ["Spack modules.yaml"] = 814,
    ["Spack packages.yaml"] = 815,
    ["Spack repos.yaml"] = 816,
    ["Spack toolchains.yaml"] = 818,
    ["Spack upstreams.yaml"] = 819,
    ["Spack view.yaml"] = 820,
    ["Speakeasy Generation Config File"] = 824,
    ["Speakeasy Lint Configuration File"] = 821,
    ["Speakeasy Test Generation Configuration File"] = 822,
    ["Speakeasy Workflow File"] = 823,
    SpecIF = 825,
    ["Specmatic Configuration"] = 826,
    ["Sponge Mixin configuration"] = 827,
    StackBlitz = 833,
    ["StackHawk Scanner Configuration"] = 1023,
    Stale = 834,
    Starfish = 835,
    ["Starlake Data Pipeline"] = 996,
    Starship = 836,
    ["Statamic Blueprint"] = 837,
    ["Stella configuration file"] = 838,
    ["Streamlit configuration file"] = 839,
    ["Stryker Mutator"] = 842,
    ["StyleCop Analyzers Configuration"] = 843,
    ["Stylelint (.stylelintrc)"] = 844,
    ["Stylua Config"] = 1209,
    ["Sublime Syntax"] = 1070,
    ["Subsquid squid manifest"] = 1117,
    ["Swagger API 2.0"] = 846,
    ["Synadia Connect Component"] = 847,
    TSON = 883,
    TSTyche = 884,
    ["TYPO3 Vendor Bundler config"] = 890,
    ["Tab data for a LinUtil"] = 1165,
    ["Tab list for a LinUtil"] = 1164,
    Tach = 848,
    ["Tach Domain"] = 849,
    Talhelper = 851,
    ["Talisman configuration"] = 852,
    Taplo = 1210,
    ["Taskfile config"] = 1001,
    Taurus = 853,
    Tauticord = 854,
    ["Tekton Pipeline"] = 1238,
    ["Tekton PipelineRun"] = 1239,
    ["Tekton Task"] = 1236,
    ["Tekton TaskRun"] = 1237,
    Telefonistka = 1196,
    ["Terrateam config"] = 1222,
    ["TestEnvironment.json"] = 866,
    ["TextMate Grammar"] = 865,
    Threagile = 860,
    ["Tier.run pricing.json"] = 857,
    Tikibase = 858,
    Tombi = 863,
    ["Traefik v2"] = 869,
    ["Traefik v2 File Provider"] = 870,
    ["Traefik v3"] = 871,
    ["Traefik v3 File Provider"] = 872,
    ["Travis CI (.travis.yml)"] = 868,
    Treefmt = 428,
    Trident = 1192,
    ["TrueScript for *.tscript files"] = 875,
    ["Tugboat QA config.yml"] = 1189,
    TunnelHub = 1105,
    Turborepo = 867,
    Tycho = 1154,
    Tye = 1031,
    ["Tyk Gateway - Open Source v5.7+"] = 1201,
    ["UET BuildConfig.json"] = 1075,
    ["UI5 Manifest"] = 896,
    ["UNCORS configuration"] = 900,
    ["UTAM Page Object"] = 899,
    ["Ubuntu Server Autoinstall"] = 894,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1193,
    ["Uniswap Token List"] = 982,
    ["Universal Schedule Format"] = 901,
    ["Unreal Engine Uplugin"] = 1076,
    ["Unreal Engine Uproject"] = 1077,
    ["UpCloud CLI (upctl) configuration"] = 1194,
    ["Updatecli Compose"] = 1039,
    ["Updatecli Policy Manifest"] = 1040,
    ["Updatecli Policy Metadata"] = 1041,
    Uplift = 1073,
    ["Upsun config"] = 7,
    ["User Journey Map"] = 1005,
    V2Ray = 1045,
    ["VSCode Code Snippets"] = 255,
    ["VSIX CLI publishing"] = 919,
    Vector = 903,
    ["Vela Pipeline Configuration"] = 906,
    Vercel = 254,
    ["Version Bumper config"] = 909,
    Vespertide = 1243,
    ["Vespertide Migration"] = 1244,
    ["Vespertide Model"] = 1245,
    ["Viash Component Config"] = 1198,
    ["Viash Package Config"] = 1199,
    Visivo = 1103,
    ["WP-CLI"] = 929,
    Wake = 1191,
    ["Waku Config"] = 1168,
    ["Web App Manifest"] = 925,
    ["Web types"] = 928,
    WebExtensions = 924,
    ["Webman package recipe"] = 1051,
    ["Windows Package Manager Installer Manifest"] = 978,
    ["Windows Package Manager Locale Manifest"] = 979,
    ["Windows Package Manager Singleton Manifest"] = 977,
    Winutil = 980,
    ["WireMock CLI import configuration"] = 1174,
    ["WireMock CLI local service configuration"] = 1173,
    ["WireMock message stub mapping"] = 1172,
    ["WireMock stub mapping"] = 1171,
    ["Woodpecker pipeline config"] = 1019,
    ["Wrangler CLI"] = 930,
    ["XenForo add-on manifest"] = 931,
    ["Xstate Machine"] = 1037,
    ["Yandex Workflow Language"] = 1160,
    ["Yarn Config (.yarnrc.yml)"] = 994,
    ["Yippee-Ki-JSON configuration YML"] = 985,
    ["YouTrack App"] = 1157,
    ["Zarf Package Configuration"] = 1224,
    ["Zerops.io config"] = 1145,
    ["Zerops.io import"] = 1146,
    ["Zola Configuration"] = 1235,
    ["aerleon.yml"] = 20,
    ["amplify.yml"] = 13,
    ["angular.json"] = 37,
    apko = 1108,
    ...
    ["behat.yml"] = 144,
    ["bigquery-table"] = 133,
    ["bioimageio resource description"] = 1125,
    ...
    ["chutzpah.json"] = 263,
    cibuildwheel = 180,
    ["clang-format (.clang-format)"] = 1043,
    ["clang-tidy"] = 241,
    clangd = 240,
    clib = 242,
    ...
    ["crowdin.yml"] = 289,
    ["ctfd-setup configuration file"] = 1181,
    ["custom-elements.json"] = 1095,
    ["cypress.json"] = 293,
    ...
    ["dtool dataset metadata"] = 1176,
    ["dvc.yaml"] = 337,
    ["ecosystem.json"] = 342,
    eksctl = 344,
    ["electron-builder configuration file"] = 351,
    ["epr-manifest.json"] = 350,
    ["estampo.toml"] = 349,
    ["evcc.yaml"] = 352,
    ["ezd task runner"] = 363,
    ["fabric.mod.json"] = 365,
    ["first-timers-bot"] = 373,
    ["flagd flag configuration"] = 119,
    ["fly.io Configuration"] = 120,
    fulibWorkflows = 1018,
    ["function.json"] = 385,
    ["gRPC API Gateway & OpenAPI Config"] = 15,
    ["gematik health care insurance list"] = 1187,
    ["gematik health care patient list"] = 1184,
    ["gematik health care provider institution list"] = 1186,
    ["gematik health care provider list"] = 1185,
    ["gematik tiger test environment configuration"] = 1188,
    ["git-town.toml"] = 1233,
    ["gitlab-ci"] = 403,
    ["global.json"] = 419,
    ["go-feature-flag Flag Configuration"] = 422,
    ["haxelib.json"] = 440,
    helmfile = 973,
    helmwave = 974,
    ["host-meta.json"] = 447,
    ...
    ["ide.host.json"] = 455,
    ["ifstate.yaml"] = 456,
    ["imageoptimizer.json"] = 457,
    ["importmap.json"] = 460,
    instant_python_config = 462,
    instant_python_custom_project = 463,
    ["ioBroker Configuration"] = 464,
    ["ioBroker JSON UI"] = 465,
    ["ioBroker Package manifest"] = 466,
    ["ixpect.conf.yaml"] = 467,
    ["ize.toml"] = 1072,
    ["jsconfig.json"] = 492,
    ["jscpd Configuration"] = 1056,
    jsdoc = 969,
    ["k3d.yaml"] = 493,
    ["k9s aliases.yaml"] = 495,
    ["k9s cluster-config.yaml"] = 497,
    ["k9s config.yaml"] = 496,
    ["k9s hotkeys.yaml"] = 498,
    ["k9s plugins.yaml"] = 499,
    ["k9s skin.yaml"] = 500,
    ["k9s views.yaml"] = 501,
    ["kontinuous-config.yaml"] = 513,
    ["kontinuous-values.yaml"] = 512,
    ["kustomization.yaml"] = 515,
    ["label-commenter-config.yml"] = 516,
    ["latexindent configuration"] = 112,
    ["launchsettings.json"] = 517,
    lazydocker = 1094,
    lazygit = 1093,
    ["lego.json"] = 519,
    ["lerna.json"] = 520,
    ["lgtm.yml"] = 521,
    ["liblab.config.json"] = 522,
    ["libman.json"] = 523,
    ["license-report-config.json"] = 524,
    ["linkinator.config.json"] = 526,
    ["lint-staged (.lintstagedrc)"] = 947,
    ["local.settings.json"] = 531,
    ["localazy.json"] = 532,
    ["lotus.yaml"] = 530,
    ["lsdlschema.json"] = 533,
    ["macro.json"] = 1060,
    ["markdown-link-check"] = 1014,
    maturin = 1015,
    mboats = 1022,
    ["micro-settings.json"] = 1087,
    ["mimetypes.json"] = 548,
    ["mirrord config"] = 949,
    mise = 950,
    ["mkdocs.yml"] = 568,
    ...
    ["monospace.yml"] = 573,
    ["moon.yml"] = 1170,
    ["mprocs Configuration file"] = 1141,
    ["mrdocs.yml"] = 570,
    ["mta.yaml"] = 951,
    ["mtad.yaml"] = 952,
    ["mycode.json"] = 580,
    nFPM = 587,
    ["napari plugin manifest"] = 581,
    neoload = 964,
    ["nest-cli"] = 590,
    ["nexus-rpc-gen"] = 1260,
    ["ninjs (News in JSON)"] = 589,
    ["nitro.json"] = 963,
    ["nixd configuration"] = 1113,
    ["nlu.json"] = 591,
    ["nodemon.json"] = 593,
    ["noodl config"] = 1021,
    ["notebook.mod.json"] = 594,
    now = 959,
    ["npm-badges"] = 597,
    ["nswag.json"] = 601,
    ntangle = 603,
    ["nuclei-template.yaml"] = 598,
    ["nuget-project.json"] = 599,
    ["ocelot.json"] = 605,
    ogen = 608,
    ["omnisharp.json"] = 611,
    openHAB = 1246,
    ...
    oxlint = 1257,
    ["package.json"] = 645,
    ["package.manifest"] = 647,
    ["package.yaml"] = 646,
    ["partial-black.json"] = 145,
    ["partial-fastapi.json"] = 146,
    ["partial-pixi.json"] = 655,
    ["pattern.json"] = 653,
    ["petstore-v1.0"] = 1067,
    pgap_yaml_input_reader = 652,
    pgxgen = 1250,
    pitcms = 1253,
    ["pixi.toml"] = 654,
    ["plagiarize-me.yaml"] = 659,
    ["plagiarize.yaml"] = 658,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1177,
    ["podbard.yaml"] = 661,
    ["portman.json"] = 664,
    ["prefect.toml"] = 672,
    ["prefect.yaml"] = 673,
    ...
    ["prettierrc.json"] = 675,
    ["prisma.yml"] = 676,
    ["project-1.0.0-beta3.json"] = 688,
    ["project-1.0.0-beta4.json"] = 689,
    ["project-1.0.0-beta5.json"] = 690,
    ["project-1.0.0-beta6.json"] = 691,
    ["project-1.0.0-beta8.json"] = 692,
    ["project-1.0.0-rc1.json"] = 693,
    ["project-1.0.0-rc2.json"] = 694,
    ["project.json"] = 687,
    ["project.owasp.yaml"] = 695,
    ["prometheus-alertmanager.json"] = 699,
    ["prometheus.json"] = 696,
    ["prometheus.rules.json"] = 697,
    ["prometheus.rules.test.json"] = 698,
    ["proxies.json"] = 700,
    ["publiccode.yml"] = 701,
    ["pubspec.yaml"] = 702,
    ["pyrseas-0.8.json"] = 705,
    pytest = 714,
    ["quilt.mod.json"] = 1088,
    ["rc3 auth"] = 720,
    ["rc3 collection"] = 721,
    ...
    ["release drafter"] = 965,
    ["release-hub.json"] = 3,
    ["release-please-config.json"] = 730,
    ["release-please-manifest.json"] = 731,
    ["release-plz.toml"] = 732,
    ["renv.lock"] = 746,
    ["reposets Configuration"] = 735,
    ["reposets Credentials"] = 736,
    ["revola.json"] = 1,
    ["rivet.json"] = 1112,
    ["rivet.yaml (legacy)"] = 1111,
    rumdl = 751,
    runny = 750,
    rustfmt = 752,
    ryl = 753,
    ...
    samt = 755,
    samtrc = 756,
    ["sarif-1.0.0.json"] = 758,
    ["sarif-2.0.0.json"] = 759,
    ["sarif-2.1.0"] = 769,
    ["sarif-2.1.0-rtm.2"] = 760,
    ["sarif-2.1.0-rtm.3"] = 762,
    ["sarif-2.1.0-rtm.4"] = 764,
    ["sarif-2.1.0-rtm.5"] = 766,
    ["sarif-2.1.0-rtm.6"] = 767,
    ["sarif-external-property-file-2.1.0"] = 770,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 761,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 763,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 765,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 768,
    ["scalingo.json configuration"] = 771,
    ["schema.org - Action"] = 773,
    ["schema.org - ContactPoint"] = 774,
    ["schema.org - Place"] = 775,
    ["schema.org - Thing"] = 776,
    ["secrethub.yml"] = 1090,
    ["semantic-release"] = 783,
    ["servicehub.config.json"] = 942,
    ["servicehub.service.json"] = 941,
    ["settings.job"] = 786,
    ["sfdx-hardis configuration"] = 788,
    ["shard.yml"] = 1128,
    ["size-limit configuration"] = 793,
    ["skaffold.yaml"] = 1012,
    ["skyuxconfig.json"] = 795,
    ["snowflake-config"] = 797,
    ["snowflake-connections"] = 798,
    ["spicepod.yaml"] = 1149,
    ["sqlc configuration"] = 830,
    ["stripe-app-local.json"] = 841,
    ["stripe-app.json"] = 840,
    swcrc = 997,
    ["task.json"] = 850,
    taskcat = 960,
    ["template.json"] = 855,
    ["templatsources.json"] = 856,
    ["text2confl config"] = 1258,
    ["theme.json"] = 859,
    ["tizen_workspace.json"] = 861,
    tldr = 862,
    ["tm_devices configuration file"] = 1215,
    tmuxinator = 945,
    tox = 864,
    ["transcend.yml"] = 873,
    ["tree-sitter grammar.json"] = 427,
    ["trime.yaml"] = 874,
    ["trunk.yaml"] = 876,
    ["ts-force-config.json"] = 881,
    ["tsconfig.json"] = 877,
    ["tsd.json"] = 878,
    ["tsdoc.json"] = 879,
    ["tsdrc.json"] = 880,
    ...
    ["vega-lite.json"] = 905,
    ["vega.json"] = 904,
    ["venvironment.yaml"] = 907,
    ["venvplus.yaml"] = 908,
    version = 1197,
    ["version.json"] = 910,
    ["vhwdebugger-binding.yaml"] = 912,
    ["vim-addon-info"] = 913,
    ["vs-2017.3.host.json"] = 915,
    ["vs-nesting.json"] = 916,
    ["vsls.json"] = 914,
    ["vss-extension.json"] = 920,
    vtcfg = 1203,
    ["vtesttree.yaml"] = 921,
    ["vtestunit.yaml"] = 922,
    ["warp-keysets.json"] = 1096,
    ["warp-themes.json"] = 1097,
    ["warp-workflows.json"] = 1098,
    ["webhint.io"] = 1052,
    ["webjobpublishsettings.json"] = 927,
    ["webjobs-list.json"] = 926,
    ["well-known-fursona"] = 1136,
    ["xs-app.json"] = 955,
    ["xunit.runner.json"] = 940,
    yamlfmt = 983,
    yamllint = 984,
    zizmor = 1240,
    zuul = 966,
