...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 955,
    [".nodehawkrc"] = 593,
    [".npmpackagejsonlintrc"] = 597,
    [".omletrc"] = 1135,
    [".phrase.yml"] = 671,
    [".phraseapp.yml"] = 672,
    [".pmbot.yml"] = 657,
    [".postcssrc"] = 666,
    [".powerpages-web-template-manifest"] = 668,
    [".pre-commit-config.yml"] = 669,
    [".pre-commit-hooks.yml"] = 670,
    [".putout.json"] = 705,
    [".rehyperc"] = 730,
    [".remarkrc"] = 734,
    [".sprite files"] = 829,
    ...
    AIConfig = 35,
    ["AMX Muse Program Descriptor"] = 1183,
    ["API Builder"] = 991,
    ["AVA Configuration"] = 1054,
    ...
    ["AWS Copilot Manifest"] = 1222,
    ["AWS SAM CLI Samconfig"] = 271,
    Acton = 1271,
    ["Adobe UXP Manifest"] = 1117,
    ["Aerleon Network & Service Definitions"] = 21,
    ["Aerleon Policy"] = 22,
    ["AgentCore CLI"] = 1262,
    Aider = 1212,
    Air = 24,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1233,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1232,
    ["Airlock Microgateway"] = 36,
    ["Alacritty Configuration"] = 1026,
    ["All Contributors configuration file"] = 1080,
    ...
    ["Application list for a WinUtil"] = 1162,
    ArchitectFX = 1167,
    ["Argo CD"] = 55,
    ["Argo Events"] = 56,
    ["Argo Workflows"] = 57,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1231,
    ["Azure IoT Operations connector metadata"] = 1228,
    ...
    ["Azure Pipelines"] = 115,
    ["Azure Static Web Apps CLI configuration file"] = 833,
    ["Azure Static Web Apps configuration file"] = 832,
    BMML = 1250,
    ["BOSH CPI Config"] = 141,
    ...
    ["Bacon config"] = 6,
    ["Barba-CV"] = 84,
    ["Bashly (bashly.yml)"] = 1084,
    ["Bashly Settings (bashly-settings.yml)"] = 1085,
    Bento = 1249,
    ["Better Code Hub"] = 996,
    ["Better Scripts"] = 163,
    Bigconfig = 134,
    ["Biome Formatter Config"] = 85,
    ["Bitmovin Encoding Template"] = 1176,
    BizTalkServerApplicationSchema = 962,
    Bleep = 164,
    ["Block Protocol Metadata"] = 161,
    ["Bluebricks blueprint config"] = 1255,
    ["Boyka Framework"] = 143,
    ...
    ["Butane Config"] = 1039,
    C4InterFlow = 1191,
    ["CDK Environment Manager, concrete environment configuration"] = 1215,
    ["CDK Environment Manager, concrete environments definition"] = 1214,
    ["CDK Environment Manager, environment definition"] = 1213,
    ["CGS Card Game Specification (cgs.json)"] = 1122,
    ["CICS TS region tagging"] = 1048,
    ["CICS TS resource import"] = 1049,
    ["CICS TS resource model"] = 1050,
    ["CICS TS resource overrides"] = 1051,
    ["CMake Presets"] = 165,
    ["CNC Codes"] = 187,
    ["CRS WAF test file"] = 1152,
    ["CRS WAF test platform overrides file"] = 1153,
    ...
    ["Chamaleon environment"] = 1180,
    ["Chamaleon properties"] = 1181,
    ["Chamaleon template"] = 1179,
    Changepacks = 1242,
    Changesets = 280,
    Changie = 174,
    Charmcraft = 175,
    ...
    ["Clawject config"] = 193,
    ["Cloud Foundry Application Manifest"] = 1134,
    ["Cloud Run Spec v1"] = 1157,
    ...
    Concord = 1151,
    ["Configu .cfgu files"] = 1139,
    ["Configu .configu file"] = 1140,
    Conjure = 186,
    ["Container Structure Test"] = 976,
    Containerlab = 1005,
    ["Contextive Glossary"] = 1207,
    Convex = 185,
    ["Crowdsec collection config"] = 290,
    ["Crowdsec parser config"] = 291,
    ["Crowdsec scenario config"] = 292,
    ["CumulusCI Config"] = 192,
    ["Cursor Agent Environment"] = 1260,
    ["Custom Machinery Machine"] = 1123,
    ["Custom Machinery Recipe"] = 1124,
    ...
    ["DonateCaseBetterCasino menu"] = 1184,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 1092,
    ["EAS config"] = 361,
    ["ECA - Editor Code Assistant"] = 343,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1081,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1227,
    ["EasyVCR .NET"] = 363,
    ["Eidolon Resource"] = 1168,
    ["Elgato Stream Deck"] = 345,
    Elm = 1156,
    ["Embrace Config"] = 1067,
    Endurica = 1105,
    ["Enterprise Contract Policy Spec"] = 346,
    ["Envelope Team Definition"] = 1270,
    ["Envilder Map File"] = 347,
    ["Erda Pipeline"] = 1130,
    ["Erda Runtime"] = 1131,
    ["Espanso config.yml"] = 1253,
    ["Espanso match.yml"] = 1252,
    Esquio = 349,
    ["Estuary Flow Catalog"] = 1045,
    ["Ethereum ERC1155"] = 1264,
    ["Ethereum ERC721"] = 1263,
    ...
    ["Evolving Resolutive Process notation"] = 1229,
    ["Expo SDK"] = 360,
    ...
    ["GeoJSON.json latest"] = 1043,
    GherKing = 1047,
    ["GitHub Action"] = 396,
    ["GitHub Actions typing"] = 1164,
    ...
    ["Google Digital Assetlinks"] = 1208,
    Goreleaser = 424,
    ["Goreleaser Pro"] = 425,
    Goss = 426,
    ["Gradle Build Cache Node"] = 994,
    ["Gradle Enterprise"] = 993,
    ...
    Hadolint = 972,
    Hammerkit = 1004,
    ["Hardware Sentry Configuration"] = 1059,
    ...
    ["JFrog File Spec"] = 477,
    ["JFrog Pipelines YML DSL"] = 1069,
    ["JMeter DSL cli config"] = 478,
    JReleaser = 481,
    ["JSON Document Transform"] = 489,
    ["JSON Feed"] = 490,
    ["JSON Resume"] = 742,
    ["JSON Schema Draft 2020-12"] = 940,
    ["JSON Schema Draft 4"] = 937,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1102,
    ["JSON Schema Draft 7"] = 938,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1103,
    ["JSON Schema Draft 8 (2019-09)"] = 939,
    ["JSON-API"] = 488,
    ["JSON-e templates"] = 1001,
    ["JSON-stat 2.0"] = 933,
    JSONPatch = 492,
    ...
    ["Jujutsu (jj) VCS config"] = 1221,
    ["KIMMDY config file"] = 503,
    ["KODE/CI build.yaml"] = 1065,
    ["KSP-AVC"] = 934,
    ["KSP-CKAN"] = 935,
    ["KSP-NetKAN"] = 936,
    KSY = 1132,
    ...
    ["Lando (landofile)"] = 111,
    ["LangGraph Platform configuration"] = 1144,
    ["Language configuration"] = 1143,
    Lefthook = 519,
    ["Liferay client-extension.yaml"] = 526,
    ["LinkML Metamodel"] = 528,
    Liquibase = 1010,
    ["Liquibase Flow File"] = 1011,
    ["Lively Properties"] = 529,
    ["Lobe AI Agent"] = 113,
    Loki = 114,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 572,
    ["MS2Rescore Configuration"] = 576,
    ["Madness (madness.yml)"] = 1083,
    ["Mado configuration"] = 536,
    ["Maestro Flow"] = 537,
    ["Mail Servers Configuration"] = 1256,
    ["MapEHR Mapping"] = 538,
    Markdownlint = 1014,
    ["Mason Registry"] = 1017,
    ...
    ["Mergify Configuration"] = 577,
    ["Metadata for a Bazel module"] = 544,
    ["Metadata for a Cinnamon spice"] = 1160,
    ["Metatype Configuration"] = 545,
    ["MetricsHub Configuration"] = 546,
    ["MetricsHub Connector Configuration"] = 547,
    ["Micro Editor Syntax"] = 1093,
    ["Microsoft Band Web Tile"] = 548,
    ["Microsoft RulesEngine workflow rules"] = 1148,
    ["Microsoft RulesEngine workflow rules list"] = 1149,
    ["Minecraft Custom Main Menu Mod"] = 1111,
    ...
    ModuleAssembler = 570,
    ["Monade CLI Stack Configuration"] = 580,
    ["MongoDB Atlas Search Index Definition"] = 1064,
    ["Monika Configuration"] = 1062,
    ["Monoweave Configuration"] = 575,
    ["Motif config"] = 954,
    MultiQC = 1201,
    ["NOX Framework (Service)"] = 596,
    ["Netin Diagnostic System Template"] = 1021,
    ["Netlify config"] = 583,
    ["Network-as-Code Data Model"] = 584,
    ["Next Gen UI Agent A2A Server Configuration"] = 585,
    ["Next Gen UI Agent Configuration"] = 587,
    ["Next Gen UI Agent MCP Server Configuration"] = 586,
    ["Nightwatch.js"] = 589,
    ["Node.js configuration"] = 959,
    ["NueJS configuration file"] = 601,
    ["Nuitka.yaml"] = 1125,
    ["Nullstone config"] = 603,
    ["ONe's changelog entry"] = 622,
    ["ONe's service descriptor"] = 621,
    ["ORT Server repository environment configuration"] = 632,
    ["OSCAL Assessment Plan (AP)"] = 634,
    ["OSCAL Assessment Results (AR)"] = 635,
    ["OSCAL Catalog"] = 636,
    ["OSCAL Component Definition (CDef)"] = 637,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 638,
    ["OSCAL Profile"] = 639,
    ["OSCAL System Security Plan (SSP)"] = 640,
    ["OSS Review Toolkit configuration"] = 641,
    ["OSS Review Toolkit curation"] = 642,
    ["OSS Review Toolkit package configuration"] = 643,
    ["OSS Review Toolkit repository configuration"] = 644,
    ["OSS Review Toolkit resolutions"] = 645,
    ["October CMS columns"] = 607,
    ["October CMS fields"] = 608,
    ["Oh My Posh"] = 610,
    Okteto = 611,
    ["Ona Automations"] = 613,
    Opctl = 957,
    ["Open Data Contract Standard (ODCS)"] = 626,
    ["Open Data Product Standard (ODPS)"] = 627,
    ["Open Know-How"] = 1206,
    OpenDecree = 1268,
    ["OpenDecree Configuration"] = 1269,
    ["OpenRewrite Resource"] = 624,
    OpenSRM = 628,
    OpenStatus = 1217,
    ["OpenTelemetry Declarative Configuration"] = 625,
    ["OpenUtau character yaml"] = 618,
    ["OpenUtau ustx"] = 619,
    ["OpenWeather Current Weather API"] = 1000,
    ["OpenWeather Road Risk API"] = 999,
    ["Ory Hydra configuration"] = 451,
    ["Ory Keto configuration"] = 511,
    ["Ory Kratos configuration"] = 633,
    ["Ory Oathkeeper configuration"] = 605,
    ["Outblocks App configuration"] = 630,
    ["Outblocks database table"] = 631,
    ["Outblocks project configuration"] = 629,
    PDM = 652,
    POPxf = 663,
    ["POPxf Correlations"] = 664,
    Packer = 649,
    PactSpec = 650,
    Pantsbuild = 1079,
    ["Paper paper-plugin.yml"] = 651,
    ["Pipeline component"] = 1012,
    ["Platform.sh application"] = 8,
    ["Platform.sh routes"] = 9,
    ["Platform.sh services"] = 10,
    ["Plex Prerolls"] = 661,
    ["PocketMine plugin.yml"] = 658,
    ["Postman collection"] = 667,
    ["Power Pages Configuration"] = 1218,
    ["Preset list for a WinUtil"] = 1163,
    ["ProActions AI-Kit Configuration"] = 678,
    ["ProActions AI-Kit Configuration for Menus"] = 680,
    ["ProActions AI-Kit Configuration for Sections"] = 682,
    ["ProActions AI-Kit Configuration for Services"] = 679,
    ["ProActions AI-Kit Configuration for Steps"] = 683,
    ["ProActions AI-Kit Configuration for Templates"] = 681,
    ["Problem object RFC9457"] = 1108,
    ["Problem package format"] = 684,
    ["Problem package generators"] = 685,
    ["Problem package submissions"] = 686,
    ["Problem package test group metadata"] = 687,
    Pterodactyl = 1058,
    ["Pull Request Labeler"] = 704,
    Pulumi = 712,
    ["PyGTA Config"] = 708,
    PyProject = 713,
    Pylock = 1209,
    Pyright = 714,
    ["Python script metadata"] = 1203,
    ["QType AI DSL"] = 717,
    Qgoda = 716,
    Qodana = 1031,
    ["Qt Creator workspace file"] = 1141,
    ["Quali Torque Blueprint Spec 2"] = 1056,
    ["QueryFirst config file"] = 1075,
    ["Qwen Code Settings"] = 1265,
    ["RKE Cluster Configuration JSON"] = 1009,
    ["RKE Cluster Configuration YAML"] = 1008,
    RadioHound = 707,
    ["Raid Profile"] = 1266,
    ["Raid Repo Configuration"] = 1267,
    Railpack = 719,
    Railway = 718,
    ["Rancher Fleet"] = 709,
    ["Rattler-build"] = 720,
    Ray = 971,
    ["Read the Docs"] = 711,
    ["Red-DiscordBot Cog"] = 727,
    ["Red-DiscordBot Cog Repo"] = 728,
    ["Red-DiscordBot Trivia"] = 729,
    ["Releasaurus Config"] = 5,
    ReleaseKit = 4,
    ["Render Blueprints"] = 1007,
    RenderCV = 746,
    Renovate = 743,
    ["Renovate global configuration"] = 744,
    ["Renovate inherited configuration"] = 745,
    ["Replit config"] = 735,
    Restate = 1196,
    ["Revel Digital Gadget Definition File"] = 1220,
    RoadRunner = 748,
    ["Robust Station Image"] = 1226,
    Rockcraft = 749,
    ["Roo Coder Custom Modes"] = 750,
    Rubocop = 739,
    ["Rudder techniques"] = 1115,
    Ruff = 740,
    ["Rust Project"] = 741,
    ["Rust toolchain"] = 755,
    ["SDMX data message"] = 782,
    ["SDMX metadata message"] = 781,
    ["SDMX structure message"] = 780,
    ["SIL Kit Participant Configuration"] = 792,
    ["SIL Kit Registry Configuration"] = 793,
    ["SPDX 2.3"] = 830,
    SWADL = 846,
    ["Safebox Config"] = 1070,
    ["Sapphire CLI Config"] = 758,
    ["SauceCTL Configuration"] = 1018,
    Scarb = 778,
    ["Schema Catalog"] = 773,
    ["Scoop manifest"] = 779,
    ["Semantic Data Fabric (SDF) file"] = 783,
    ["Semgrep Rule"] = 785,
    ["Serenity Code Generator (Sergen)"] = 786,
    ["Serverless Framework Configuration"] = 1025,
    ["Serverless Workflow"] = 1027,
    ["Settings for a Cinnamon spice"] = 1159,
    ["Settings.paf"] = 788,
    ["Shopware 6 Configuration"] = 1028,
    ["Shopware CLI Extension Store Configuration"] = 1029,
    ["Shopware CLI Project Store Configuration"] = 1030,
    ["Sigma Detection Rule"] = 790,
    ["Sigrid scope configuration file"] = 791,
    ["SkyPilot Task JSON"] = 1116,
    ["Slack app manifest"] = 795,
    Snapcraft = 797,
    Solidarity = 800,
    ["Solution filters"] = 801,
    ["Source Maps v3"] = 802,
    Sourcery = 803,
    ["Spack bootstrap.yaml"] = 804,
    ["Spack cdash.yaml"] = 805,
    ["Spack ci.yaml"] = 806,
    ["Spack compilers.yaml"] = 807,
    ["Spack concretizer.yaml"] = 808,
    ["Spack config.yaml"] = 809,
    ["Spack definitions.yaml"] = 810,
    ["Spack develop.yaml"] = 811,
    ["Spack env_vars.yaml"] = 812,
    ["Spack environment"] = 818,
    ["Spack include.yaml"] = 813,
    ["Spack mirrors.yaml"] = 814,
    ["Spack modules.yaml"] = 815,
    ["Spack packages.yaml"] = 816,
    ["Spack repos.yaml"] = 817,
    ["Spack toolchains.yaml"] = 819,
    ["Spack upstreams.yaml"] = 820,
    ["Spack view.yaml"] = 821,
    ["Speakeasy Generation Config File"] = 825,
    ["Speakeasy Lint Configuration File"] = 822,
    ["Speakeasy Test Generation Configuration File"] = 823,
    ["Speakeasy Workflow File"] = 824,
    SpecIF = 826,
    ["Specmatic Configuration"] = 827,
    ["Sponge Mixin configuration"] = 828,
    StackBlitz = 834,
    ["StackHawk Scanner Configuration"] = 1024,
    Stale = 835,
    Starfish = 836,
    ["Starlake Data Pipeline"] = 997,
    Starship = 837,
    ["Statamic Blueprint"] = 838,
    ["Stella configuration file"] = 839,
    ["Streamlit configuration file"] = 840,
    ["Stryker Mutator"] = 843,
    ["StyleCop Analyzers Configuration"] = 844,
    ["Stylelint (.stylelintrc)"] = 845,
    ["Stylua Config"] = 1210,
    ["Sublime Syntax"] = 1071,
    ["Subsquid squid manifest"] = 1118,
    ["Swagger API 2.0"] = 847,
    ["Synadia Connect Component"] = 848,
    TSON = 884,
    TSTyche = 885,
    ["TYPO3 Vendor Bundler config"] = 891,
    ["Tab data for a LinUtil"] = 1166,
    ["Tab list for a LinUtil"] = 1165,
    Tach = 849,
    ["Tach Domain"] = 850,
    Talhelper = 852,
    ["Talisman configuration"] = 853,
    Taplo = 1211,
    ["Taskfile config"] = 1002,
    Taurus = 854,
    Tauticord = 855,
    ["Tekton Pipeline"] = 1239,
    ["Tekton PipelineRun"] = 1240,
    ["Tekton Task"] = 1237,
    ["Tekton TaskRun"] = 1238,
    Telefonistka = 1197,
    ["Terrateam config"] = 1223,
    ["TestEnvironment.json"] = 867,
    ["TextMate Grammar"] = 866,
    Threagile = 861,
    ["Tier.run pricing.json"] = 858,
    Tikibase = 859,
    Tombi = 864,
    ["Traefik v2"] = 870,
    ["Traefik v2 File Provider"] = 871,
    ["Traefik v3"] = 872,
    ["Traefik v3 File Provider"] = 873,
    ["Travis CI (.travis.yml)"] = 869,
    Treefmt = 429,
    Trident = 1193,
    ["TrueScript for *.tscript files"] = 876,
    ["Tugboat QA config.yml"] = 1190,
    TunnelHub = 1106,
    Turborepo = 868,
    Tycho = 1155,
    Tye = 1032,
    ["Tyk Gateway - Open Source v5.7+"] = 1202,
    ["UET BuildConfig.json"] = 1076,
    ["UI5 Manifest"] = 897,
    ["UNCORS configuration"] = 901,
    ["UTAM Page Object"] = 900,
    ["Ubuntu Server Autoinstall"] = 895,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1194,
    ["Uniswap Token List"] = 983,
    ["Universal Schedule Format"] = 902,
    ["Unreal Engine Uplugin"] = 1077,
    ["Unreal Engine Uproject"] = 1078,
    ["UpCloud CLI (upctl) configuration"] = 1195,
    ["Updatecli Compose"] = 1040,
    ["Updatecli Policy Manifest"] = 1041,
    ["Updatecli Policy Metadata"] = 1042,
    Uplift = 1074,
    ["Upsun config"] = 7,
    ["User Journey Map"] = 1006,
    V2Ray = 1046,
    ["VSCode Code Snippets"] = 255,
    ["VSIX CLI publishing"] = 920,
    Vector = 904,
    ["Vela Pipeline Configuration"] = 907,
    Vercel = 254,
    ["Version Bumper config"] = 910,
    Vespertide = 1244,
    ["Vespertide Migration"] = 1245,
    ["Vespertide Model"] = 1246,
    ["Viash Component Config"] = 1199,
    ["Viash Package Config"] = 1200,
    Visivo = 1104,
    ["WP-CLI"] = 930,
    Wake = 1192,
    ["Waku Config"] = 1169,
    ["Web App Manifest"] = 926,
    ["Web types"] = 929,
    WebExtensions = 925,
    ["Webman package recipe"] = 1052,
    ["Windows Package Manager Installer Manifest"] = 979,
    ["Windows Package Manager Locale Manifest"] = 980,
    ["Windows Package Manager Singleton Manifest"] = 978,
    Winutil = 981,
    ["WireMock CLI import configuration"] = 1175,
    ["WireMock CLI local service configuration"] = 1174,
    ["WireMock message stub mapping"] = 1173,
    ["WireMock stub mapping"] = 1172,
    ["Woodpecker pipeline config"] = 1020,
    ["Wrangler CLI"] = 931,
    ["XenForo add-on manifest"] = 932,
    ["Xstate Machine"] = 1038,
    ["Yandex Workflow Language"] = 1161,
    ["Yarn Config (.yarnrc.yml)"] = 995,
    ["Yippee-Ki-JSON configuration YML"] = 986,
    ["YouTrack App"] = 1158,
    ["Zarf Package Configuration"] = 1225,
    ["Zerops.io config"] = 1146,
    ["Zerops.io import"] = 1147,
    ["Zola Configuration"] = 1236,
    ["aerleon.yml"] = 20,
    ["amplify.yml"] = 13,
    ["angular.json"] = 37,
    apko = 1109,
    ...
    ["behat.yml"] = 144,
    ["bigquery-table"] = 133,
    ["bioimageio resource description"] = 1126,
    ...
    ["chutzpah.json"] = 263,
    cibuildwheel = 180,
    ["clang-format (.clang-format)"] = 1044,
    ["clang-tidy"] = 241,
    clangd = 240,
    clib = 242,
    ...
    ["crowdin.yml"] = 289,
    ["ctfd-setup configuration file"] = 1182,
    ["custom-elements.json"] = 1096,
    ["cypress.json"] = 293,
    ...
    ["gematik health care insurance list"] = 1188,
    ["gematik health care patient list"] = 1185,
    ["gematik health care provider institution list"] = 1187,
    ["gematik health care provider list"] = 1186,
    ["gematik tiger test environment configuration"] = 1189,
    ["git-town.toml"] = 1234,
    ["gitlab-ci"] = 404,
    ["global.json"] = 420,
    ...
    ["lint-staged (.lintstagedrc)"] = 948,
    ["local.settings.json"] = 532,
    ["localazy.json"] = 533,
    ["lotus.yaml"] = 531,
    ["lsdlschema.json"] = 534,
    ["macro.json"] = 1061,
    ["markdown-link-check"] = 1015,
    maturin = 1016,
    mboats = 1023,
    ["micro-settings.json"] = 1088,
    ["mimetypes.json"] = 549,
    ["mirrord config"] = 950,
    mise = 951,
    ["mkdocs.yml"] = 569,
    ...
    ["monospace.yml"] = 574,
    ["moon.yml"] = 1171,
    ["mprocs Configuration file"] = 1142,
    ["mrdocs.yml"] = 571,
    ["mta.yaml"] = 952,
    ["mtad.yaml"] = 953,
    ["mycode.json"] = 581,
    nFPM = 588,
    ["napari plugin manifest"] = 582,
    neoload = 965,
    ["nest-cli"] = 591,
    ["nexus-rpc-gen"] = 1261,
    ["ninjs (News in JSON)"] = 590,
    ["nitro.json"] = 964,
    ["nixd configuration"] = 1114,
    ["nlu.json"] = 592,
    ["nodemon.json"] = 594,
    ["noodl config"] = 1022,
    ["notebook.mod.json"] = 595,
    now = 960,
    ["npm-badges"] = 598,
    ["nswag.json"] = 602,
    ntangle = 604,
    ["nuclei-template.yaml"] = 599,
    ["nuget-project.json"] = 600,
    ["ocelot.json"] = 606,
    ogen = 609,
    ["omnisharp.json"] = 612,
    openHAB = 1247,
    ...
    oxlint = 1258,
    ["package.json"] = 646,
    ["package.manifest"] = 648,
    ["package.yaml"] = 647,
    ["partial-black.json"] = 145,
    ["partial-fastapi.json"] = 146,
    ["partial-pixi.json"] = 656,
    ["pattern.json"] = 654,
    ["petstore-v1.0"] = 1068,
    pgap_yaml_input_reader = 653,
    pgxgen = 1251,
    pitcms = 1254,
    ["pixi.toml"] = 655,
    ["plagiarize-me.yaml"] = 660,
    ["plagiarize.yaml"] = 659,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1178,
    ["podbard.yaml"] = 662,
    ["portman.json"] = 665,
    ["prefect.toml"] = 673,
    ["prefect.yaml"] = 674,
    ...
    ["prettierrc.json"] = 676,
    ["prisma.yml"] = 677,
    ["project-1.0.0-beta3.json"] = 689,
    ["project-1.0.0-beta4.json"] = 690,
    ["project-1.0.0-beta5.json"] = 691,
    ["project-1.0.0-beta6.json"] = 692,
    ["project-1.0.0-beta8.json"] = 693,
    ["project-1.0.0-rc1.json"] = 694,
    ["project-1.0.0-rc2.json"] = 695,
    ["project.json"] = 688,
    ["project.owasp.yaml"] = 696,
    ["prometheus-alertmanager.json"] = 700,
    ["prometheus.json"] = 697,
    ["prometheus.rules.json"] = 698,
    ["prometheus.rules.test.json"] = 699,
    ["proxies.json"] = 701,
    ["publiccode.yml"] = 702,
    ["pubspec.yaml"] = 703,
    ["pyrseas-0.8.json"] = 706,
    pytest = 715,
    ["quilt.mod.json"] = 1089,
    ["rc3 auth"] = 721,
    ["rc3 collection"] = 722,
    ...
    ["release drafter"] = 966,
    ["release-hub.json"] = 3,
    ["release-please-config.json"] = 731,
    ["release-please-manifest.json"] = 732,
    ["release-plz.toml"] = 733,
    ["renv.lock"] = 747,
    ["reposets Configuration"] = 736,
    ["reposets Credentials"] = 737,
    ["revola.json"] = 1,
    ["rivet.json"] = 1113,
    ["rivet.yaml (legacy)"] = 1112,
    rumdl = 752,
    runny = 751,
    rustfmt = 753,
    ryl = 754,
    ...
    samt = 756,
    samtrc = 757,
    ["sarif-1.0.0.json"] = 759,
    ["sarif-2.0.0.json"] = 760,
    ["sarif-2.1.0"] = 770,
    ["sarif-2.1.0-rtm.2"] = 761,
    ["sarif-2.1.0-rtm.3"] = 763,
    ["sarif-2.1.0-rtm.4"] = 765,
    ["sarif-2.1.0-rtm.5"] = 767,
    ["sarif-2.1.0-rtm.6"] = 768,
    ["sarif-external-property-file-2.1.0"] = 771,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 762,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 764,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 766,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 769,
    ["scalingo.json configuration"] = 772,
    ["schema.org - Action"] = 774,
    ["schema.org - ContactPoint"] = 775,
    ["schema.org - Place"] = 776,
    ["schema.org - Thing"] = 777,
    ["secrethub.yml"] = 1091,
    ["semantic-release"] = 784,
    ["servicehub.config.json"] = 943,
    ["servicehub.service.json"] = 942,
    ["settings.job"] = 787,
    ["sfdx-hardis configuration"] = 789,
    ["shard.yml"] = 1129,
    ["size-limit configuration"] = 794,
    ["skaffold.yaml"] = 1013,
    ["skyuxconfig.json"] = 796,
    ["snowflake-config"] = 798,
    ["snowflake-connections"] = 799,
    ["spicepod.yaml"] = 1150,
    ["sqlc configuration"] = 831,
    ["stripe-app-local.json"] = 842,
    ["stripe-app.json"] = 841,
    swcrc = 998,
    ["task.json"] = 851,
    taskcat = 961,
    ["template.json"] = 856,
    ["templatsources.json"] = 857,
    ["text2confl config"] = 1259,
    ["theme.json"] = 860,
    ["tizen_workspace.json"] = 862,
    tldr = 863,
    ["tm_devices configuration file"] = 1216,
    tmuxinator = 946,
    tox = 865,
    ["transcend.yml"] = 874,
    ...
    ["vega-lite.json"] = 906,
    ["vega.json"] = 905,
    ["venvironment.yaml"] = 908,
    ["venvplus.yaml"] = 909,
    version = 1198,
    ["version.json"] = 911,
    ["vhwdebugger-binding.yaml"] = 913,
    ["vim-addon-info"] = 914,
    ["vs-2017.3.host.json"] = 916,
    ["vs-nesting.json"] = 917,
    ["vsls.json"] = 915,
    ["vss-extension.json"] = 921,
    vtcfg = 1204,
    ["vtesttree.yaml"] = 922,
    ["vtestunit.yaml"] = 923,
    ["warp-keysets.json"] = 1097,
    ["warp-themes.json"] = 1098,
    ["warp-workflows.json"] = 1099,
    ["webhint.io"] = 1053,
    ["webjobpublishsettings.json"] = 928,
    ["webjobs-list.json"] = 927,
    ["well-known-fursona"] = 1137,
    ["xs-app.json"] = 956,
    ["xunit.runner.json"] = 941,
    yamlfmt = 984,
    yamllint = 985,
    zizmor = 1241,
    zuul = 967,
